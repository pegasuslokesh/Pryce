<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="Ac_PartyStatement.aspx.cs" Inherits="SuppliersPayable_Ac_PartyStatement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Party Statement%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Party Statement%>"></asp:Label></li>
    </ol>
</asp:Content>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        ...
                                        <asp:TextBox ID="txtSupplierName" runat="server" CssClass="form-control" BackColor="#eeeeee" AutoPostBack="true" OnTextChanged="txtSupplierName_TextChanged" />
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:Attendance,Currency %>"></asp:Label>
                                        <a style="color: Red">*</a>
                                ...
                                <div class="col-md-12" style="text-align: center">
                                    ...
                                    <asp:Button ID="btnShowReport" Visible="false" runat="server" Text="<%$ Resources:Attendance,Print %>"
                                        ...
                                        <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GVSStatement" Width="100%" runat="server" ShowFooter="true" AutoGenerateColumns="false">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance, Debit %>" SortExpression="Debit_Amount">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblgvDebitTotal" runat="server" CssClass="labelComman" />
                                                    </FooterTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance, Credit %>" SortExpression="Credit_Amount">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblgvCreditTotal" runat="server" CssClass="labelComman" />
                                                    </FooterTemplate>
                                                    <FooterStyle BorderStyle="None" HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance, Balance %>">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblgvBalanceTotal" runat="server" CssClass="labelComman" />
                                                    </FooterTemplate>
                                                    <FooterStyle BorderStyle="None" HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance, Balance %>">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblgvFreignBalanceTotal" runat="server" CssClass="labelComman" />
                                                    </FooterTemplate>
                                                    <FooterStyle BorderStyle="None" HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:TextBox ID="txtClosingCredit" runat="server" CssClass="form-control" ReadOnly="true" />
                                    <br />
                                </div>
                                <div class="col-md-6">
                                    <asp:Label ID="lblForeignCreditClosing" runat="server" Text="<%$ Resources:Attendance,Foreign Closing %>" />
                                    <asp:TextBox ID="txtForeignCreditClosing" runat="server" CssClass="form-control" ReadOnly="true" />
                                    <br />
                                </div>
                                <div id="panelRunningBill" runat="server" visible="false" class="row">
                                    <div class="col-md-12">
                                        <div class="box box-primary">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">
                                                    <asp:Label ID="lblProjectedBalance" runat="server" Text="Projected Balance"></asp:Label></h3>
                                            ...
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:Attendance,Opening Balance %>" />
                                                        <asp:TextBox ID="txtProjectedOpeningBalance" runat="server" CssClass="form-control"
                                                            ReadOnly="true" />
                                                        <br />
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div style="overflow: auto; max-height: 500px;">
                                                            <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="gvProjectedBalance" Width="100%" runat="server" ShowFooter="true" AutoGenerateColumns="false">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance, Debit %>" SortExpression="Debit_Amount">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblgvDebitAmount" runat="server" Text='<%# Common.GetAmountDecimal(Eval("Debit_Amount").ToString(),Session["DBConnection"].ToString(),Session["LocCurrencyId"].ToString()) %>' />
                                                                        </ItemTemplate>
                                                                        <FooterTemplate>
                                                                            <asp:Label ID="lblgvDebitTotal" runat="server" CssClass="labelComman" />
                                                                        </FooterTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance, Credit %>" SortExpression="Credit_Amount">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblgvCreditAmount" runat="server" Text='<%#Common.GetAmountDecimal(Eval("Credit_Amount").ToString(),Session["DBConnection"].ToString(),Session["LocCurrencyId"].ToString()) %>' />
                                                                        </ItemTemplate>
                                                                        <FooterTemplate>
                                                                            <asp:Label ID="lblgvCreditTotal" runat="server" CssClass="labelComman" />
                                                                        </FooterTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance, Created %>">
                                                                        ...
                                                                        <FooterTemplate>
                                                                            <asp:Label ID="lblgvactualBalancelbl" runat="server" CssClass="labelComman" Text="Actual Balance" Font-Bold="true" />
                                                                        </FooterTemplate>
                                                                        <ItemStyle HorizontalAlign="Center" />
                                                                    ...
                                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance, Modified %>">
                                                                        ...
                                                                        <FooterTemplate>
                                                                            <asp:Label ID="lblgvactualBalanceValue" Font-Bold="true" runat="server" CssClass="labelComman" Text="Actual Balance" />
                                                                        </FooterTemplate>
                                                                        <ItemStyle HorizontalAlign="Center" />
                                                                        <FooterStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
