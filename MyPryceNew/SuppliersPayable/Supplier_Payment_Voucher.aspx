<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" EnableEventValidation="true" AutoEventWireup="true" CodeFile="Supplier_Payment_Voucher.aspx.cs" Inherits="SuppliersPayable_Supplier_Payment_Voucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Supplier Payment%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Supplier Payment Voucher%>"></asp:Label></li>
    </ol>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs pull-right bg-blue-gradient">
                    ...
                    <li id="Li_Edit_Ageing"><a href="#Edit_Ageing" onclick="Li_Tab_Edit_Ageing()" data-toggle="tab">
                        <i class="fa fa-list"></i>&nbsp;&nbsp;<asp:Label ID="Label3" runat="server" Text="<%$ Resources:Attendance,Ageing %>"></asp:Label></a></li>
                ...
                <div class="tab-content">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="col-lg-2">
                                                    <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="form-control">
                                                        ...
                                                        <asp:ListItem Text="<%$ Resources:Attendance, Supplier Name %>" Value="Name"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-lg-2">
                                                                ...
                                                                <ItemTemplate>
                                                                    <div class="dropdown" style="position: absolute;">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            ...
                                                                            <li <%= hdnCanPrint.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                                <asp:LinkButton ID="IbtnPrint" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Trans_Id") %>'
                                                                                    OnCommand="btn_PrintClick" ToolTip="<%$ Resources:Attendance,Print %>"
                                                                                    Visible="true"><i class="fa fa-print"></i>Payment Report</asp:LinkButton>
                                                                            </li>
                                                                            <li <%= hdnCanPrint.Value=="true"?"style='display:block'":"style='display:none'" %>>
                    ...
                    <div class="tab-pane" id="New">
                        <asp:UpdatePanel ID="Update_New" runat="server">
                            <%--<Triggers>
                                <asp:PostBackTrigger ControlID="btnVoucherSave" />
                            </Triggers>--%>
                            <ContentTemplate>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <asp:Label ID="lblCustomer" runat="server" Text="<%$ Resources:Attendance,Supplier %>" />
                                                        <a style="color: Red">*</a>
                                                    ...
                                                    <div class="col-md-12" style="overflow: auto; max-height: 500px;">
                                                        ...
                                                        <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvPendingInvoice" runat="server" AutoGenerateColumns="False" Width="100%"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Invoice No/Date">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Supplier Invoice No/Date">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="PO Number">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblPoDetail" runat="server" Text='<%# Eval("po_detail")==null?"":Eval("po_detail") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <FooterStyle BorderStyle="None" />
                                                                    <ItemStyle />
                                                                </asp:TemplateField>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div style="overflow: auto">
                                                            <asp:GridView ID="gvBankDetails" CssClass="table-striped table-bordered table table-hover" runat="server" AutoGenerateColumns="false">

                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Actions">
                                                                        <ItemTemplate>
                                                                            <asp:CheckBox ID="chkGvBank" OnCheckedChanged="chkGvBank_CheckedChanged" AutoPostBack="true" runat="server" />
                                                                            <asp:HiddenField ID="hdnSupplierAccountId" runat="server" Value='<%# Eval("Trans_Id") %>' />
                                                                            <asp:HiddenField ID="hdnGvBankCurrencyId" runat="server" Value='<%# Eval("Currency") %>' />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                    ...
                                                    <div class="col-md-6">
                                                        <br />
                                                        <asp:CheckBox ID="chkAdvancePayment" CssClass="form-control" OnCheckedChanged="chkAdvancePayment_CheckedChanged" AutoPostBack="true" runat="server" Text="<%$ Resources:Attendance,Advance Payment %>" />
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator4" ValidationGroup="Save" Display="Dynamic"
                                                            SetFocusOnError="true" ControlToValidate="ddlForeginCurrency" InitialValue="--Select--" ErrorMessage="<%$ Resources:Attendance,Select Foreign Currency %>" />
                                                    ...
                                                    <div class="row" id="divPoInfo" runat="server" visible="false">
                                                        <div class="col-md-6">
                                                            <asp:Label ID="Label11" runat="server" Text="Purchase Order" />
                                                            <asp:TextBox ID="txtPoNumber" runat="server" CssClass="form-control" BackColor="#eeeeee"
                                                                AutoPostBack="True" OnTextChanged="txtPoNumber_TextChanged" />
                                                            <cc1:AutoCompleteExtender ID="AutoCompleteExtender3" runat="server"
                                                                CompletionInterval="100" DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1"
                                                                ServiceMethod="GetCompletionListPO" ServicePath="" TargetControlID="txtPoNumber"
                                                                UseContextKey="True" CompletionListCssClass="autoCompleteList" CompletionListItemCssClass="autoCompleteListItem" CompletionListHighlightedItemCssClass="autoCompleteSelectedListItem" OnClientShown="resetPosition">
                                                            </cc1:AutoCompleteExtender>
                                                            <br />
                                                        </div>
                                                        <div class="col-md-6">
                                                            <asp:Label ID="Label12" runat="server" Text="PO Info" />
                                                            <asp:TextBox ID="txtPoInfo" runat="server" CssClass="form-control" BackColor="#eeeeee"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtBankCharges" runat="server" CssClass="form-control"
                                                                AutoPostBack="true" OnTextChanged="txtBankCharges_textChnaged"></asp:TextBox>
                                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True"
                                                                TargetControlID="txtBankCharges" ValidChars="1,2,3,4,5,6,7,8,9,0,.">
                                                            </cc1:FilteredTextBoxExtender>
                                                            <div class="input-group-btn">
                                                                <asp:TextBox ID="txtAcbankCharges" runat="server" Style="width: 200px;" CssClass="form-control" BackColor="#eeeeee"
                                                                    AutoPostBack="true" OnTextChanged="txtAcbankCharges_textChnaged"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:TextBox ID="txtPaidForeignamount" runat="server" OnTextChanged="txtPaidForeignamount_TextChanged" AutoPostBack="True" CssClass="form-control"></asp:TextBox>
                                                        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" Enabled="True"
                                                            TargetControlID="txtPaidForeignamount" ValidChars="1,2,3,4,5,6,7,8,9,0,.">
                                                        </cc1:FilteredTextBoxExtender>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:Label ID="lblNetAmountLocal" runat="server" Text="<%$ Resources:Attendance,Paid Local Amount %>" />
                                                        <asp:TextBox ID="txtPaidLocalAmount" runat="server" AutoPostBack="True" OnTextChanged="txtPaidLocalAmount_TextChanged"
                                                            CssClass="form-control" />
                                                        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" Enabled="True"
                                                            TargetControlID="txtPaidLocalAmount" ValidChars="1,2,3,4,5,6,7,8,9,0,.">
                                                        </cc1:FilteredTextBoxExtender>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" Enabled="True"
                                                            TargetControlID="txtNetAmount" ValidChars="1,2,3,4,5,6,7,8,9,0,.">
                                                        </cc1:FilteredTextBoxExtender>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label ID="lblPurposeTransfer" runat="server" Text="Purpose of Transfer"></asp:Label>
                                                        <asp:TextBox ID="txtPurposeOfTransfer" runat="server" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12" style="text-align: center">
                                                        ...
                                                        <asp:HiddenField ID="hdnPageType" runat="server" Value="Supplier" />
    ...
    <asp:UpdatePanel ID="Update_Not_Use" runat="server">
        <ContentTemplate>
