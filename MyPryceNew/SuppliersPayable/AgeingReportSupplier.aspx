<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="AgeingReportSupplier.aspx.cs" Inherits="SuppliersPayable_AgeingReportSupplier" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Supplier Ageing Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>
            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:Attendance,Finance Setup%>"></asp:Label></a></li>
        <li><a href="#"><i class="fa fa-dashboard"></i>
            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:Attendance,Suppliers Payable %>"></asp:Label></a></li>
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Supplier Ageing Report%>"></asp:Label></li>
    </ol>
</asp:Content>
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <br />
                                    <asp:CheckBox ID="chkAllInvoices" CssClass="form-control" AutoPostBack="False" Text="All Invoices"
                                ...
                                <div class="col-md-12" runat="server" id="scrollArea" onscroll="SetDivPosition()" style="overflow: auto; max-height: 500px;">
                                        ...
                                        <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GVAgeingReport" runat="server" AutoGenerateColumns="False" Width="100%"
                                            ShowFooter="true">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Refrence Order/Invoice Number">
                                                    <ItemTemplate>
                                                ...
                                                <%--<asp:TemplateField HeaderText="Supplier Invoice No.">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSupInvoiceNo" Width="80px" runat="server" Text='<%#Eval("SupInvoiceNo").ToString() %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle />
                                                </asp:TemplateField>--%>
                                                <asp:TemplateField HeaderText="Supplier Invoice Date">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSupInvoiceDate" Width="80px" runat="server" Text='<%# GetDateFormat(Eval("SupInvoiceDate").ToString()) %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Invoice Amount">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblInvoiceAmt" runat="server" Text='<%# Eval("actual_Invoice_amt") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Balance Remaining">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDueAmt" runat="server" Text='<%# Eval("actual_balance_amt") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
