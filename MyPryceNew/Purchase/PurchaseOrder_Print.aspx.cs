...
public partial class Purchase_PurchaseOrder_Print : System.Web.UI.Page
{
    PoDetailByPoNumber objReport = null;
    PoDetailByPoNumber_Internal objReport_Internal = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        objReport_Internal = new PoDetailByPoNumber_Internal(Session["DBConnection"].ToString());
    ...
    void GetReport()
    {
        ...
        adp.Fill(objPurchasedataset.sp_Inv_PurchaseOrderDetail_SelectRow_Report, Convert.ToInt32(Session["CompId"].ToString()), Convert.ToInt32(Session["BrandId"].ToString()), Convert.ToInt32(Session["LocId"].ToString()), Convert.ToInt32(Request.QueryString["Id"].ToString()));
        DataTable Dt = objPurchasedataset.sp_Inv_PurchaseOrderDetail_SelectRow_Report;
        ...
        if (Dt != null && Dt.Rows.Count > 0)
        {
            ...
            if (objInvParam.GetParameterValue_By_ParameterName(Session["CompId"].ToString(), Session["BrandId"].ToString(), Session["LocId"].ToString(), "PurchaseOrderReportHeaderLevel").Rows[0]["ParameterValue"].ToString() == "External")
            {
            ...
            else
            {
                ...
                objReport_Internal.DataMember = "sp_Inv_PurchaseOrderDetail_SelectRow_Report";
            ...
            // objReport.ExportToPdf(Server.MapPath("~/Temp/Purchase Order-" + Dt.Rows[0]["PoNo"].ToString() + ".pdf"));
            //ViewState["Path"] = "Purchase Order-" + Dt.Rows[0]["PoNo"].ToString() + ".pdf";
            ...
            StringSubject = esmailsub.GetEmailSubjectAll(Session["CompId"].ToString(), true, "12", "45", SupplierCode.ToString(), Dt.Rows[0]["PoNo"].ToString(), HttpContext.Current.Session["EmpId"].ToString());
            if (StringSubject == "")
            {
                StringSubject = "Purchase Order -" + Dt.Rows[0]["PoNo"].ToString();
                try
                {
    ...
    {
        Response.Redirect("../EmailSystem/ContactMailReference.aspx?Page=PO&&Url=" + ViewState["Path"].ToString() + "&&Id=" + ViewState["Id"].ToString() + "&&ConId=" + ViewState["SupId"].ToString() + "&&ProductId=" + ViewState["ProductId"].ToString() + "&&PageRefType=PO&&PageRefId=" +Request.QueryString["Id"].ToString());
