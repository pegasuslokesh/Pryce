...
{
    PReturn objReport = null;
    PReturnByReturnNo objReportByReturnNo = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        objReport = new PReturn(Session["DBConnection"].ToString());
        objReportByReturnNo = new PReturnByReturnNo(Session["DBConnection"].ToString());
    ...
    void GetReport()
    {
        ...
        if (Session["ReportType"].ToString() == "0")
        {
            ...
            objReport.DataMember = "sp_Inv_PurchaseReturn_SelectRow_Report";
        ...
        if (Session["ReportType"].ToString() == "1")
        {
            ...
            objReportByReturnNo.setcompanyAddress(CompanyAddress);
            objReportByReturnNo.setcompanyname(CompanyName);
            objReportByReturnNo.setBrandName(BrandName);
            objReportByReturnNo.setLocationName(LocationName);
            objReportByReturnNo.settitle(Session["ReportHeader"].ToString());
            objReportByReturnNo.SetImage(Imageurl);
            objReportByReturnNo.setArabic();
            if (Session["Parameter"] != null)
            {
                objReportByReturnNo.SetDateCriteria(Session["Parameter"].ToString());
            }
            else
            {
                objReportByReturnNo.SetDateCriteria("");
            }
            objReportByReturnNo.setUserName(Session["UserId"].ToString());


            objReportByReturnNo.DataSource = Dt;
            objReportByReturnNo.DataMember = "sp_Inv_PurchaseReturn_SelectRow_Report";
            rptViewer.Report = objReportByReturnNo;
            objReportByReturnNo.ExportToPdf(Server.MapPath("~/Temp/" + Session["ReportHeader"].ToString() + ".pdf"));
