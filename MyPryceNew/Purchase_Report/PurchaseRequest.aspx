<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="PurchaseRequest.aspx.cs" Inherits="Purchase_Report_PurchaseRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Purchase Request Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Purchase Request Report%>"></asp:Label></li>
    </ol>
</asp:Content>
                    ...
                    <div class="row">
                        ...
                        <div id="trProduct">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:CheckBox ID="chkdepartment" runat="server" Text="<%$ Resources:Attendance,Department %>" />

                                <asp:CheckBox ID="ChkRequestNo" runat="server" Text="<%$ Resources:Attendance,Request No %>" />

                                <asp:CheckBox ID="ChkProduct" runat="server" Text="<%$ Resources:Attendance,Product Name%>" />
                                <br />
                            </div>
                        </div>
                    </div>
