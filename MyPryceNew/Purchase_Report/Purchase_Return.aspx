<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="Purchase_Return.aspx.cs" Inherits="Purchase_Report_Purchase_Return" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Purchase Return Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Purchase Return Report%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Attendance,Return No.%>"></asp:Label>
                            <asp:TextBox ID="txtReturnNo" runat="server" CssClass="form-control" BackColor="#eeeeee"
                                AutoPostBack="True" OnTextChanged="txtReturnNo_TextChanged" />
                            <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionInterval="100"
                                DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1" ServiceMethod="GetCompletionList_ReturnNo"
                                ServicePath="" TargetControlID="txtReturnNo" UseContextKey="True"  CompletionListCssClass="autoCompleteList" CompletionListItemCssClass="autoCompleteListItem" CompletionListHighlightedItemCssClass="autoCompleteSelectedListItem" OnClientShown="resetPosition">
                            </cc1:AutoCompleteExtender>
                            <asp:HiddenField ID="hdnReturnId" runat="server" Value="0" />
                            <br />
                        </div>
                        <div class="col-md-6">
                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Attendance,Invoice No %>"></asp:Label>
                        ...
                        <div class="col-md-12">
                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:Attendance,Supplier Name %>"></asp:Label>
                        ...
                        <div class="col-md-6">
                            <asp:CheckBox ID="chkReturnNo" CssClass="form-control" runat="server" Text="<%$ Resources:Attendance,Return No.%>" />
                            <br />
                        </div>
                    </div>
                </div>
