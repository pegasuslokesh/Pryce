<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="PurchaseInquiry.aspx.cs" Inherits="Purchase_Report_PurchaseInquiry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Purchase Inquiry Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Purchase Inquiry Report%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label7" runat="server" Text="<%$ Resources:Attendance,Purchase Inquiry No. %>"></asp:Label>
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Attendance,Request No %>"></asp:Label>
                            <asp:TextBox ID="txtRequestNo" BackColor="#eeeeee" runat="server" CssClass="form-control"></asp:TextBox>
                        ...
                        <div id="trProduct">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:CheckBox ID="chkSupplier" runat="server" Text="<%$ Resources:Attendance,Supplier %>" />
                                <asp:CheckBox ID="ChkInquiryNo" runat="server" Text="<%$ Resources:Attendance,Purchase Inquiry No. %>" />
                                <br />
                            </div>
                        </div>
                    </div>
