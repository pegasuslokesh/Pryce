<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="Purchase_Order.aspx.cs" Inherits="Purchase_Report_Purchase_Order" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Purchase Order Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Purchase Order Report%>"></asp:Label></li>
    </ol>
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align: center">
                            <asp:RadioButton Checked="true" AutoPostBack="true" ID="rbtnheader"
                                runat="server" Style="padding: 10px 0px 0px 10px" GroupName="a" Text="<%$ Resources:Attendance,Header Report %>"
                                OnCheckedChanged="rbtnheader_CheckedChanged" />

                            <asp:RadioButton Style="padding: 10px 0px 0px 10px" GroupName="a" AutoPostBack="true" ID="RbtnDetail"
                                runat="server" Text="<%$ Resources:Attendance,Detail Report %>" OnCheckedChanged="RbtnDetail_CheckedChanged" />

                            <asp:RadioButton GroupName="a" Style="padding: 10px 0px 0px 10px" AutoPostBack="true"  ID="rbtnShipping" 
                                                            runat="server" Text="Shipping Report" 
                                                            oncheckedchanged="rbtnShipping_CheckedChanged" />
                                                            
                                                               <asp:RadioButton GroupName="a" Style="padding: 10px 0px 0px 10px" AutoPostBack="true"  ID="rbtnOrderStatus" 
                                                            runat="server" Text="<%$ Resources:Attendance,Status Report %>" Visible="false"
                                                            oncheckedchanged="rbtnOrderStatus_CheckedChanged" />
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label7" runat="server"  Text="<%$ Resources:Attendance,Order No. %>"></asp:Label>
                            <asp:TextBox ID="txtOrderNo" BackColor="#eeeeee" runat="server" 
                                                                        CssClass="form-control" AutoPostBack="True" ontextchanged="txtOrderNo_TextChanged" 
                                                                        ></asp:TextBox>
                                                            ...
                                                            MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtOrderNo"
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label8" runat="server" Text="<%$ Resources:Attendance,Supplier Name %>"></asp:Label>
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Attendance,Quotation No.%>"></asp:Label>
                            <asp:TextBox ID="txtQuotationNo" BackColor="#eeeeee" runat="server" 
                                                                        CssClass="form-control" AutoPostBack="True" ontextchanged="txtQuotationNo_TextChanged" 
                                                                       ></asp:TextBox>
                        ...
                        <div id="trProduct">
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:CheckBox ID="chkSupplier" Style="padding: 0px 15px 0px 15px" GroupName="ab" runat="server" Text="<%$ Resources:Attendance,Supplier Name %>"  />
                                                            <asp:CheckBox ID="chkOrderNo" GroupName="ab" Style="padding: 0px 15px 0px 15px" runat="server" Text="<%$ Resources:Attendance,Order No. %>"  /> 
                                <br />
                            </div>
                        </div>
                    </div>
