...
public partial class Purchase_Report_PurchaseOrderShippingReport : System.Web.UI.Page
{
    EmployeeMaster objEmployee = null;
    POShippingPrint objDailyProductionPrint = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        objDailyProductionPrint = new POShippingPrint(Session["DBConnection"].ToString());
    ...
    public void GetReport()
    {
        ...
        if (dtemployee.Rows.Count > 0)
        {
            ...
            objDailyProductionPrint.DataMember = "DtOrderShipping";
            ...
            objDailyProductionPrint.setDateCriteria("");
            objDailyProductionPrint.SetImage(Imageurl);
            objDailyProductionPrint.setReportTitle("Order Shipping Report");
