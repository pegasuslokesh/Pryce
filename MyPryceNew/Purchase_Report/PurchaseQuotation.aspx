<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="PurchaseQuotation.aspx.cs" Inherits="Purchase_Report_PurchaseQuotation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Purchase Quotation Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Purchase Quotation Report%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label7" runat="server" Text="<%$ Resources:Attendance,Quotation No. %>"></asp:Label>
                            <asp:TextBox ID="txtQuotationNo" BackColor="#eeeeee" runat="server"
                                CssClass="form-control" AutoPostBack="True" OnTextChanged="txtQuotationNo_TextChanged"></asp:TextBox>
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Attendance,Purchase Inquiry No. %>"></asp:Label>
                            <asp:TextBox ID="txtInquiryNo" BackColor="#eeeeee" runat="server"
                                CssClass="form-control" AutoPostBack="True"
                                OnTextChanged="txtInquiryNo_TextChanged"></asp:TextBox>
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Attendance,Status %>"></asp:Label>
                        ...
                        <div id="trProduct">
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:RadioButton ID="rbtnInquiryNo" Style="padding: 0px 15px 0px 15px" GroupName="ab" runat="server" Text="<%$ Resources:Attendance,Inquiry No. %>" />
                                <asp:RadioButton ID="rbtnQuotationNo" Style="padding: 0px 15px 0px 15px" GroupName="ab" runat="server" Text="<%$ Resources:Attendance,Quotation No. %>" />
                                <asp:RadioButton ID="rbtnQuotationdate" Style="padding: 0px 15px 0px 15px" GroupName="ab" runat="server" Text="<%$ Resources:Attendance,Quotation Date %>" />
                                <asp:RadioButton ID="rbtnSupplier" Style="padding: 0px 15px 0px 15px" GroupName="ab" runat="server" Text="<%$ Resources:Attendance,Supplier %>" />
                                <br />
                            </div>
                        </div>
                    </div>
