...
{
    PobySupplier objReport = null;
    PobyOrderDate objReportByDate = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        objReport = new PobySupplier(Session["DBConnection"].ToString());
        objReportByDate = new PobyOrderDate(Session["DBConnection"].ToString());
    ...
    void GetReport()
    {
        ...
        if (Session["ReportType"].ToString() == "0")
        {
            ...
            objReport.DataMember = "PurchaseOrder";
        ...
        else
        {
            ...
            objReportByDate.DataMember = "PurchaseOrder";
