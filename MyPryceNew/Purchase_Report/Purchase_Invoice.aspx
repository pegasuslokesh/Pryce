<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="Purchase_Invoice.aspx.cs" Inherits="Purchase_Report_Purchase_Invoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Purchase Invoice Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Purchase Invoice Report%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label9" runat="server"  Text="<%$ Resources:Attendance,Invoice Type%>"></asp:Label>
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label11" runat="server"  Text="<%$ Resources:Attendance,Invoice No %>"></asp:Label>
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label12" runat="server"  Text="<%$ Resources:Attendance,Supplier Invoice No %>"></asp:Label>
                        ...
                        <div id="trProduct">
                            ...
                            <div class="col-md-12">
                                <asp:Label ID="Label4" runat="server" Style="padding: 15px 15px 0px 0px" Text="<%$ Resources:Attendance,Group By%>"></asp:Label>:                                
                                                               <asp:CheckBox ID="chkSupplier" GroupName="ab" runat="server" Style="padding: 0px 15px 0px 15px" Text="<%$ Resources:Attendance,Supplier Name %>"
                                                         />&nbsp;
                                                    <asp:CheckBox ID="ChkInvoiceno" GroupName="ab" Style="padding: 0px 15px 0px 15px" runat="server" Text="<%$ Resources:Attendance,Invoice No %>"
                                                         />
                                <br />
                            </div>
                        </div>
