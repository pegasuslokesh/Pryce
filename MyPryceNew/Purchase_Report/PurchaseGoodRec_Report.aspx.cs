...
{
    PGoodsRec objReport = new PGoodsRec();
    PGoodsRecByInvoiceNo objReportByInvoiceNo = new PGoodsRecByInvoiceNo();
    PGoodsRecByOrderNo objReportByOrderNo = new PGoodsRecByOrderNo();
    ...
    void GetReport()
    {
        ...
        Title="Purchase Goods Receive Report";
        if (Session["ReportType"].ToString() == "0")
        {
            ...
            objReport.DataMember = "Inv_PurchaseInvoiceDetail";
        ...
        if (Session["ReportType"].ToString() == "1")
        {
            ...
            objReportByInvoiceNo.DataMember = "Inv_PurchaseInvoiceDetail";
        ...
        if (Session["ReportType"].ToString() == "2")
        {
            ...
            objReportByOrderNo.DataMember = "Inv_PurchaseInvoiceDetail";
