<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="ProjectHistoryReport.aspx.cs" Inherits="ProjectManagement_Report_ProjectHistoryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Project History Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Project History Report%>"></asp:Label></li>
    </ol>
</asp:Content>
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-md-6">
                                    <asp:Label ID="lblProjectType" runat="server" Text="<%$ Resources:Attendance,Project Type %>"
                                        ></asp:Label>
                                ...
                                <div class="col-md-12">
                                    <asp:Label ID="Label13" runat="server" Text="<%$ Resources:Attendance,Project Name %>"
                                        ></asp:Label>
                                    <dx:ASPxComboBox ID="ddlprojectname" runat="server" CssClass="form-control" DropDownWidth="550" OnSelectedIndexChanged="ddlprojectname_SelectedIndexChanged"
                                        DropDownStyle="DropDownList" ValueField="Project_Id"
                                        ValueType="System.String" TextFormatString="{0}" EnableCallbackMode="true" IncrementalFilteringMode="Contains" AutoPostBack="true"
                                        CallbackPageSize="30">
                                        <Columns>
