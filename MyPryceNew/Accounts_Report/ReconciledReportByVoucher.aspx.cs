...
public partial class Accounts_Report_ReconciledReportByVoucher : System.Web.UI.Page
{
    EmployeeMaster objEmployee = null;
    ReconciledReportByVoucher objTrialBalanceprint = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        objTrialBalanceprint = new ReconciledReportByVoucher(Session["DBConnection"].ToString());
    ...
    public void GetReport()
    {
        ...
        objTrialBalanceprint.setReportTitle("RECONCILED REPORT BY VOUCHER DETAIL");
        lblHeader.Text = "RECONCILED REPORT BY VOUCHER DETAIL";
