<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Financial_Year_Summary.aspx.cs" Inherits="Accounts_Report_Financial_Year_Summary" %>
...
<head id="Head1" runat="server">
    <title>Finance Closing Detail</title>
            ...
            <table width="70%" cellpadding="0" cellspacing="0">
                <tr style="background-color: #90BDE9">
                    ...
                    <td style="padding-left: 5px" align="left">
                        <asp:Label ID="lblHeader" runat="server" Text="Finance Closing Detail"
                ...
                <tr style="background-color: #fff">
                    ...
                    <td colspan="2">
                      ...
                      <asp:DropDownList ID="ddlFinanceYear" runat="server" CssClass="textComman"></asp:DropDownList>

                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <asp:Button ID="btnGo" runat="server" Text="Go" CssClass="buttonCommman" OnClick="btnGo_OnClick"/>
