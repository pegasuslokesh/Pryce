<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllSupplierDetail.aspx.cs"
    Inherits="Accounts_Report_AllSupplierDetail" %>
...
<head runat="server">
    <title>All Supplier Statement</title>
            ...
            <table width="70%" cellpadding="0" cellspacing="0">
                <tr style="background-color: #90BDE9">
                    ...
                    <td style="padding-left: 5px" align="left">
                        <asp:Label ID="lblHeader" runat="server" Text="All Supplier Statement" CssClass="LableHeaderTitle"></asp:Label>
                    </td>
