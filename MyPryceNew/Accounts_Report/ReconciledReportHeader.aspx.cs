...
public partial class Accounts_Report_ReconciledReportHeader : System.Web.UI.Page
{
    EmployeeMaster objEmployee = null;
    ReconciledReportHeader objTrialBalanceprint = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        objTrialBalanceprint = new ReconciledReportHeader(Session["DBConnection"].ToString());
    ...
    public void GetReport()
    {
        ...
        AccountsDatasetTableAdapters.sp_Ac_Reconcile_Header_ReportTableAdapter adp = new AccountsDatasetTableAdapters.sp_Ac_Reconcile_Header_ReportTableAdapter();
        adp.Connection.ConnectionString = Session["DBConnection"].ToString();
        adp.Fill(ObjAccountDataset.sp_Ac_Reconcile_Header_Report, Convert.ToInt32(strCompId), Convert.ToInt32(strBrandId), Convert.ToInt32(strLocationId), DateTime.Parse(objArr[4].ToString().Trim()), DateTime.Parse(objArr[5].ToString().Trim()), 1);



        DataTable dt = ObjAccountDataset.sp_Ac_Reconcile_Header_Report;
        ...
        objTrialBalanceprint.DataMember = "sp_Ac_Reconcile_Header_Report";
        ReportViewer1.Report = objTrialBalanceprint;
        ReportToolbar1.ReportViewer = ReportViewer1;
        objTrialBalanceprint.setcompanyname(CompanyName);
        objTrialBalanceprint.setReportTitle("RECONCILED HEADER REPORT");
        lblHeader.Text = "RECONCILED HEADER REPORT";
