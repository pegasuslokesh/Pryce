...
public partial class Accounts_Report_AllCustomerwithSalesPerson : System.Web.UI.Page
{
    Ac_ParameterMaster objAcParameter = null;
    EmployeeMaster objEmployee = null;
    AllCustomerRecordWithSalesPerson objTrialBalanceprint = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        objTrialBalanceprint = new AllCustomerRecordWithSalesPerson(Session["DBConnection"].ToString());
    ...
    public void GetReport()
    {
        ...
        AccountsDatasetTableAdapters.sp_Ac_AllCustomer_Balance_BySalesPersonTableAdapter adp = new AccountsDatasetTableAdapters.sp_Ac_AllCustomer_Balance_BySalesPersonTableAdapter();
        adp.Connection.ConnectionString = Session["DBConnection"].ToString();
        adp.Fill(ObjAccountDataset.sp_Ac_AllCustomer_Balance_BySalesPerson, Convert.ToInt32(strCompId), Convert.ToInt32(strBrandId), strReceiveVoucherAcc, Convert.ToInt32(strReceiveVoucherAcc), strLocationId, dtFromDate, dtToDate, Convert.ToInt32(strCurrencyType), Convert.ToInt32(Session["FinanceYearId"].ToString()), 1);

        DataTable dt = ObjAccountDataset.sp_Ac_AllCustomer_Balance_BySalesPerson;
        ...
        if (dt.Rows.Count > 0)
        {
            dt = new DataView(dt, "Name not is null and SalesPersonName not is null", "", DataViewRowState.CurrentRows).ToTable();
        ...
        objTrialBalanceprint.DataMember = "sp_Ac_AllCustomer_Balance_BySalesPerson";
