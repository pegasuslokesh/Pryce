<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplierPaymentVoucherReport.aspx.cs"
    Inherits="Accounts_Report_SupplierPaymentVoucherReport" %>
...
<head runat="server">
    <title>Supplier Payment Voucher Print</title>
            ...
            <table width="70%" cellpadding="0" cellspacing="0">
                <tr style="background-color: #90BDE9">
                    ...
                    <td style="padding-left: 5px" align="left">
                        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Supplier Payment %>"
