<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailyCashFlowPrint.aspx.cs"
    Inherits="Accounts_Report_DailyCashFlowPrint" %>
            ...
            <table width="70%" cellpadding="0" cellspacing="0">
                <tr style="background-color: #90BDE9">
                    ...
                    <td style="padding-left: 5px" align="left">
                        <asp:Label ID="lblHeader" runat="server" Text="Daily Cash Flow" CssClass="LableHeaderTitle"></asp:Label>
                    </td>
