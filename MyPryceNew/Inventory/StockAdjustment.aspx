<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="StockAdjustment.aspx.cs" Inherits="Inventory_StockAdjustment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        <i class="fas fa-cubes"></i>&nbsp;&nbsp;
                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Stock Adjustment%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Stock Adjustment%>"></asp:Label></li>
    </ol>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
				 ...
				 <asp:Label ID="lblTotalRecords" Font-Bold="true" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                            ...
                                            <div class="box-body">
                                                <div class="col-lg-2">
                                                    <asp:DropDownList ID="ddlPosted" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlPosted_SelectedIndexChanged">
                                                        ...
                                                        <asp:ListItem Text="<%$ Resources:Attendance,UnPosted %>" Value="UnPosted"></asp:ListItem>
                                                ...
                                                <div class="col-lg-4">
                                                    <asp:Panel ID="Panel1" runat="server" DefaultButton="btnbind">
                                                        ...
                                                        <asp:TextBox ID="txtValueDate" runat="server" placeholder="Search From Date" CssClass="form-control" Visible="false"></asp:TextBox>
                                                                    ...
                                                                    <div class="dropdown" style="position: absolute;">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            <li style="display:none">
                                                                                <asp:LinkButton ID="btnPrint" OnClientClick="openReport()" runat="server" CommandArgument='<%# Eval("TransId") %>' CausesValidation="False" OnCommand="btnPrint_Command"><i class="fa fa-print"></i>Print</asp:LinkButton>
                                                                            </li>
                                                                            <li <%= hdnCanPrint.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                                <a style="cursor: pointer" onclick="getReportData('<%# Eval("TransId") %>')"><i class="fa fa-print"></i>Report System</a>
                                                                            </li>
                    ...
                    <div class="tab-pane" id="New">
                        <asp:UpdatePanel ID="Update_New" runat="server">
                            <ContentTemplate>
                                <div id="PnlNewContant" runat="server" class="row">
                                    <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:Button ID="btnAddNewProduct" runat="server" Text="<%$ Resources:Attendance,Add Product %>"
                                                            Visible="false" CssClass="btn btn-info" OnClick="btnAddNewProduct_Click" />
                                                        <br />
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div id="divProduct" runat="server" class="box box-primary">
                                                                    <div class="box-header with-border">
                                                                        <h3 class="box-title">
                                                                    ...
                                                                    <div class="box-body">
                                                                        <div class="form-group">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <a style="color: Red">*</a>
                                                                                <asp:RequiredFieldValidator EnableClientScript="false" Style="float: right;" runat="server" ID="RequiredFieldValidator2" ValidationGroup="Add"
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <a style="color: Red">*</a>
                                                                                <asp:RequiredFieldValidator EnableClientScript="false" Style="float: right;" runat="server" ID="RequiredFieldValidator4" ValidationGroup="Add"
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <a style="color: Red">*</a>
                                                                                <asp:RequiredFieldValidator EnableClientScript="false" Style="float: right;" runat="server" ID="RequiredFieldValidator5" ValidationGroup="Add" Display="Dynamic"
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <a style="color: Red">*</a>
                                                                                <asp:RequiredFieldValidator EnableClientScript="false" Style="float: right;" runat="server" ID="RequiredFieldValidator6" ValidationGroup="Add"
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <a style="color: Red">*</a>
                                                                                <asp:RequiredFieldValidator EnableClientScript="false" Style="float: right;" runat="server" ID="RequiredFieldValidator7" ValidationGroup="Add" Display="Dynamic"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div id="divReplacement" runat="server" class="box box-info collapsed-box">
                                                                    <div class="box-header with-border">
                                                                        <h3 class="box-title">
                                                                            <asp:Label ID="Label3" runat="server" Font-Size="14px" Font-Bold="true"
                                                                                Text="Sales Replacement"></asp:Label></h3>
                                                                        <div class="box-tools pull-right">
                                                                            <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                                                    ...
                                                                    <div class="box-body">
                                                                        <div class="form-group">
                                                                            <div class="col-md-6">
                                                                                <asp:Label ID="Label4" runat="server" Text="Sales Invoice No" />
                                                                                <asp:TextBox ID="txtSinvNo" runat="server" CssClass="form-control" AutoPostBack="True"
                                                                                    OnTextChanged="txtSinvNo_TextChanged" BackColor="#eeeeee" />
                                                                                <%--<cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionInterval="100"
                                                                                    DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1" ServiceMethod="GetCompletionListSinvNo"
                                                                                    ServicePath="" TargetControlID="txtSinvNo" UseContextKey="True" CompletionListCssClass="autoCompleteList" CompletionListItemCssClass="autoCompleteListItem" CompletionListHighlightedItemCssClass="autoCompleteSelectedListItem" OnClientShown="resetPosition">
                                                                                </cc1:AutoCompleteExtender>--%>
                                                                                <asp:HiddenField ID="hdnSinvId" Value="0" runat="server" />
                                                                                <br />
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <asp:Label ID="Label7" runat="server" Text="Ref Order Id"></asp:Label>
                                                                                <asp:TextBox ID="txtSinvRefOrderId" runat="server" CssClass="form-control"></asp:TextBox>
                                                                                <br />
                                                                            </div>

                                                                            <div class="col-md-6">
                                                                                <asp:Label ID="Label8" runat="server" Text="Ref Invoice No"></asp:Label>
                                                                                <asp:TextBox ID="txtSinvRefInvoiceNo" runat="server" CssClass="form-control"></asp:TextBox>
                                                                                <br />
                                                                            </div>

                                                                            <div class="col-md-6">
                                                                                <asp:Label ID="Label16" runat="server" Text="Product"></asp:Label>
                                                                                <asp:DropDownList ID="ddlSinvProduct" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlSinvProduct_SelectedIndexChanged"></asp:DropDownList>
                                                                                <br />
                                                                            </div>

                                                                            <div class="col-md-6">
                                                                                <asp:Label ID="Label18" runat="server" Text="Quantity"></asp:Label>
                                                                                <asp:TextBox ID="txtSinvQty" runat="server" CssClass="form-control"></asp:TextBox>
                                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" Enabled="True"
                                                                                    TargetControlID="txtSinvQty" ValidChars="1,2,3,4,5,6,7,8,9,0">
                                                                                </cc1:FilteredTextBoxExtender>
                                                                                <br />
                                                                            </div>

                                                                            <div class="col-md-12" style="text-align: center">
                                                                                <asp:Button ID="btnReplacement" runat="server" Text="<%$ Resources:Attendance,Add Product %>"
                                                                                    CssClass="btn btn-primary" OnClick="btnReplacement_Click" />
                                                                                <br />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance, Quantity %>">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtQuantity" runat="server" Width="60px"
                                                                            Text='<%# GetAmountDecimal(Eval("Quantity").ToString()) %>' AutoPostBack="true" OnTextChanged="txtGVQuantity_OnTextChanged"></asp:TextBox>
                                                                        <asp:LinkButton ID="lnkAddSerial" AutoPostBack="True" runat="server" Text="<%$ Resources:Attendance,Add %>"
                                                                            OnCommand="lnkAddSerial_Command" ForeColor="Blue" Font-Underline="true" CommandArgument='<%# Eval("ProductId") %>'
                                                                            CommandName='<%# Eval("InOut") %>'></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                                    ...
                                                    <div id="PnlOperationButton" runat="server" class="col-md-12" style="text-align: center">
                                                        ...
                                                        <cc1:ConfirmButtonExtender ID="confirm1" runat="server" ConfirmText="<%$ Resources:Attendance,Are you sure to post the record ?%>"
                                                            TargetControlID="btnPostSave">
    ...
    <div class="modal fade" id="Report" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
