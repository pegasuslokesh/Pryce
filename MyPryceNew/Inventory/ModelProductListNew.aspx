<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModelProductListNew.aspx.cs"
    Inherits="Inventory_ModelProductListNew" %>
...
<head runat="server">
    ...
    <%--<script src="../Bootstrap_Files/plugins/inputmask/jquery.inputmask.date.extensions.js"></script>--%>
    <script src="../Bootstrap_Files/plugins/inputmask/jquery.inputmask.extensions.js"></script>
    <!-- date-range-picker -->
    <%--<script src="Bootstrap_Files/Additional/moment.min.js" type="text/javascript"></script>--%>

    <%--<script src="../Bootstrap_Files/plugins/daterangepicker/daterangepicker.js"></script>--%>
    ...
    <%--<script src="../Bootstrap_Files/plugins/fullcalendar/fullcalendar.min.js"></script>--%>
                                                                    ...
                                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="gvProduct" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Color" SortExpression="Color">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblgvColor" runat="server" Text='<%# Eval("Color") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle />
                                                                            </asp:TemplateField>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance, Stock %>">
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton ID="lnkStockQuantity" runat="server" Text='<%# Eval("StockQty") %>' Font-Underline="true" ForeColor="Blue" ToolTip="View Detail" OnCommand="lnkStockInfo_Command"
                                                                                        OnClientClick="$('#Product_StockAnalysis').modal('show');" CommandArgument='<%# Eval("ProductId") %>'></asp:LinkButton>
                                                                                </ItemTemplate>
