...
public partial class Inventory_ModelProductListNew : System.Web.UI.Page
{
    ...
    protected void btnbind_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ddlOption.SelectedIndex != 0)
        {
            ...
            if (ddlFieldName.SelectedIndex == 5)
            {
