<%@ Page Language="C#" MasterPageFile="~/ERPMaster_Old.master" AutoEventWireup="true"
    CodeFile="FileTypeMaster.aspx.cs" Inherits="New_ArcWing_FileTypeMaster" Title="Untitled Page" %>
            ...
            <table width="100%">
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="PnlList" runat="server">
                                        ...
                                        <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="gvFileMaster" PageSize="<%# PageControlCommon.GetPageSize() %>" runat="server"
              ...
              --%>
                                    ...
                                    <asp:Panel ID="PnlBin" runat="server">
                                        ...
                                        <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="gvFileMasterBin" PageSize="<%# PageControlCommon.GetPageSize() %>"
