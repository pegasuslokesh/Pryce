<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="VehicleStatement.aspx.cs" Inherits="Transport_VehicleStatement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="Vehicle Statement"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>
            <asp:Label ID="Label6" runat="server" Text="Transport"></asp:Label></a></li>
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="Vehicle Statement"></asp:Label></li>
    </ol>
</asp:Content>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator2" ValidationGroup="Save"
                                        Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtContractor" ErrorMessage="Enter Contractor"></asp:RequiredFieldValidator>
                                    <asp:TextBox ID="txtContractor" runat="server" CssClass="form-control" BackColor="#eeeeee" OnTextChanged="txtContractor_TextChanged" AutoPostBack="true"></asp:TextBox>
                                    <cc1:AutoCompleteExtender ID="txtContractor_AutoCompleteExtender" runat="server"
                                        CompletionInterval="100" DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1"
                                        ServiceMethod="GetCompletionListCustomer" ServicePath="" TargetControlID="txtContractor"
                                        UseContextKey="True" CompletionListCssClass="autoCompleteList" CompletionListItemCssClass="autoCompleteListItem" CompletionListHighlightedItemCssClass="autoCompleteSelectedListItem" OnClientShown="resetPosition">
                                    </cc1:AutoCompleteExtender>
                                </div>
                                <div class="col-md-6">
                                    <asp:Label ID="lblVehicleName" runat="server" Text="<%$ Resources:Attendance,Vehicle Name %>" />
                                    <asp:DropDownList ID="ddlVehicleList" runat="server" CssClass="form-control" />
                                    <br />
                                </div>
                                <div class="col-md-6">
                    ...
                    <asp:UpdatePanel ID="Update_Voucher_Detail_Button" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Button ID="Button2" runat="server" CausesValidation="False" CssClass="btn btn-primary" Visible="false"
                                OnClick="btnCancelPopLeave_Click" Text="<%$ Resources:Attendance,Cancel %>" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
