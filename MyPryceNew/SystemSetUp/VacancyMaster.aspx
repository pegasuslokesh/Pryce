<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="VacancyMaster.aspx.cs" Inherits="SystemSetUp_VacancyMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Vacancy Setup%>"></asp:Label>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Vacancy Setup%>"></asp:Label></li>
    </ol>
</asp:Content>
                    ...
                    <div class="tab-pane active" id="List">
                        <asp:UpdatePanel ID="Update_List" runat="server">
                            <ContentTemplate>
                                            ...
                                            <div class="box-body">
                                                <div class="col-lg-3">
                                                    ...
                                                    <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="form-control">
                                                        <asp:ListItem Selected="True" Text="<%$ Resources:Attendance,Vacancy Id %>" Value="Vacancy_Id"></asp:ListItem>
                                                        <asp:ListItem Text="<%$ Resources:Attendance,Vacancy Name%>" Value="Vacancy"></asp:ListItem>
                                                        <asp:ListItem Text="<%$ Resources:Attendance,Vacancy Name(Local)%>" Value="Vacancy_L"></asp:ListItem>
                                ...
                                <div class="box box-warning box-solid" <%= gvVacancyMaster.Rows.Count>0?"style='display:block'":"style='display:none'"%>>
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <br />
                                                <div class="flow">
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="gvVacancyMaster" PageSize='<%# int.Parse(Session["GridSize"].ToString()) %>' runat="server"
                                                        AutoGenerateColumns="False" Width="100%" AllowPaging="True" AllowSorting="True"
                                                        OnPageIndexChanging="gvVacancyMaster_PageIndexChanging" OnSorting="gvVacancyMaster_OnSorting">
                                                        <Columns>
                                                                    ...
                                                                    <div class="dropdown" style="position: absolute;">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            ...
                                                                            <li <%= hdnCanEdit.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                                 <asp:LinkButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Vacancy_Id") %>'
                                                                         ...
                                                                         ToolTip="<%$ Resources:Attendance,Edit %>" ><i class="fa fa-pencil"></i>Edit </asp:LinkButton>
                                                                            ...
                                                                            <li <%= hdnCanDelete.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                                <asp:LinkButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Vacancy_Id") %>'
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Vacancy Id%>" SortExpression="Vacancy_Id">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblvacancyId" runat="server" Text='<%# Eval("Vacancy_Id") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Vacancy Name%>" SortExpression="Vacancy">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblVacancyName" runat="server" Text='<%# Eval("Vacancy") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Vacancy Name(Local) %>" SortExpression="Vacancy_L">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblVacancyL" runat="server" Text='<%# Eval("Vacancy_L") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                            <asp:Label ID="lblVacancyName" runat="server" Text="<%$ Resources:Attendance,Vacancy Name%>"></asp:Label>

                                                            <a style="color: Red">*</a>
                                                            <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator3" ValidationGroup="Save"
                                                                Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtVacancyName" ErrorMessage="<%$ Resources:Attendance,Enter Vacancy Name %>"></asp:RequiredFieldValidator>

                                                            <asp:TextBox ID="txtVacancyName" runat="server" AutoPostBack="true" OnTextChanged="txtVacancyName_OnTextChanged" BackColor="#eeeeee" CssClass="form-control" />
                                                            <cc1:AutoCompleteExtender ID="txtCompCode_AutoCompleteExtender" runat="server" DelimiterCharacters=""
                                                                Enabled="True" ServiceMethod="GetCompletionListVacancyName" ServicePath="" CompletionInterval="100"
                                                                MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtVacancyName"
                                                        ...
                                                        <div class="col-md-6">
                                                            <asp:Label ID="lblVacancyL" runat="server" Text="<%$ Resources:Attendance,Vacancy Name(Local)%>"></asp:Label>
                                                            <asp:TextBox ID="txtVacancyL" runat="server" CssClass="form-control"></asp:TextBox>
                                                            <br />
                                                        </div>
                                                    </div>
			...
			<div id="Div2" runat="server" class="box box-info collapsed-box">
				...
				<div class="box-body">
                      <div class="col-lg-3">
                                ...
                                <div class="box box-warning box-solid"  <%= gvVacancyMasterBin.Rows.Count>0?"style='display:block'":"style='display:none'"%> >
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <br />
                                                <div class="flow">
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="gvVacancyMasterBin" PageSize='<%# int.Parse(Session["GridSize"].ToString()) %>'
                                                        runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True" OnPageIndexChanging="gvVacancyMasterBin_PageIndexChanging"
                                                        OnSorting="gvVacancyMasterBin_OnSorting" DataKeyNames="Vacancy_Id" AllowSorting="True">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkgvSelect" runat="server" />
                                                                    <asp:Label ID="lblFileId" runat="server" Visible="false" Text='<%# Eval("Vacancy_Id") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Vacancy Name%>" SortExpression="Vacancy">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblBinVacancy" runat="server" Text='<%# Eval("Vacancy") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Vacancy Name(Local) %>" SortExpression="Vacancy_L">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblBinVacancyL" runat="server" Text='<%# Eval("Vacancy_L") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Created By %>" SortExpression="Created_User">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblBinCreated_User" runat="server" Text='<%# Eval("Created_User") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Modified By %>" SortExpression="Modified_User">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblBinModified_User" runat="server" Text='<%# Eval("Modified_User") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                        </Columns>
