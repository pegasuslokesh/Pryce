<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="TaxMaster.aspx.cs" Inherits="SystemSetUp_TaxMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Tax Setup%>"></asp:Label>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Tax Setup%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                            <asp:Label ID="lblTaxName" runat="server" Text="<%$ Resources:Attendance,Tax Name%>"></asp:Label>
                                                            <a style="color: Red">*</a>
                                                            ...
                                                            <asp:TextBox ID="txtTaxName" runat="server" AutoPostBack="true" OnTextChanged="txtTaxName_TextChanged" BackColor="#eeeeee" CssClass="form-control" />
                                                        ...
                                                        <div class="col-md-6">
                                                            <asp:Label ID="lblTaxNameL" runat="server" Text="<%$ Resources:Attendance,Tax Name(Local)%>"></asp:Label>
                                                            <asp:TextBox ID="txtTaxName_L" runat="server" CssClass="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                            <asp:Label ID="lblTaxCategory" runat="server" Text="Tax Category"></asp:Label>
                                                            <asp:DropDownList ID="ddlTaxCategory" runat="server" CssClass="form-control">
                                                            </asp:DropDownList>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <br />
                                                            <asp:Panel ID="pnlTransactionType" runat="server" Style="max-height: 500px;" Width="100%" BorderStyle="Solid"
                                                                BorderWidth="1px" BorderColor="#eeeeee" BackColor="White" ScrollBars="Auto">
                                                                <asp:Label ID="lblTransactionType" runat="server" Text="Transaction Type" />
                                                                <br />
                                                                <asp:CheckBoxList ID="chklist" runat="server" RepeatColumns="5" CellPadding="10"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                            <asp:Label ID="lblAccountNo" runat="server" Text="Account Type" />
                                                            <a style="color: Red">*</a>
					...
					<asp:Label ID="lblTotalRecords" Font-Bold="true" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                            ...
                                            <div class="box-body">
                                                <div class="col-lg-3">
                                                    <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="form-control">
                                                        <asp:ListItem Text="<%$ Resources:Attendance,Tax Name %>" Value="Tax_Name" />
                                                        <asp:ListItem Text="<%$ Resources:Attendance,Tax Id %>" Value="Trans_Id" />

                                                        <asp:ListItem Text="<%$ Resources:Attendance, Tax Name(Local) %>" Value="TaxName_L" />
                                ...
                                <div class="box box-warning box-solid" <%= GvTaxMaster.Rows.Count>0?"style='display:block'":"style='display:none'"%>>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="flow">
                                                    ...
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvTaxMaster" PageSize='<%# int.Parse(Session["GridSize"].ToString()) %>' runat="server"
                                                        AutoGenerateColumns="False" Width="100%" AllowPaging="True" OnPageIndexChanging="GvTaxMaster_PageIndexChanging"
                                                        AllowSorting="True" OnSorting="GvTaxMaster_Sorting">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Tax Id %>" SortExpression="Trans_Id">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDesigId1" runat="server" Text='<%# Eval("Trans_Id") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:BoundField DataField="Tax_Name" HeaderText="<%$ Resources:Attendance,Tax Name %>"
                                                                SortExpression="Tax_Name" />
                                                            <asp:BoundField DataField="TaxName_L" HeaderText="<%$ Resources:Attendance,Tax Name(Local) %>"
                                                                SortExpression="TaxName_L" />
                    ...
                    <div class="tab-pane" id="Bin">
					  ...
					  <asp:Label ID="lblTotalRecordsBin" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                ...
                                <div class="box box-warning box-solid"  <%= GvTaxMasterBin.Rows.Count>0?"style='display:block'":"style='display:none'"%> >
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <br />
                                                <div class="flow">
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvTaxMasterBin" PageSize='<%# int.Parse(Session["GridSize"].ToString()) %>'
                                                        runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True" OnPageIndexChanging="GvTaxMasterBin_PageIndexChanging"
                                                        OnSorting="GvTaxMasterBin_OnSorting" DataKeyNames="Trans_Id" AllowSorting="true">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Tax Name %>" SortExpression="Tax_Name">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvTaxName" runat="server" Text='<%# Eval("Tax_Name") %>'></asp:Label>
                                                                    <asp:Label ID="lblTaxiId" Visible="false" runat="server" Text='<%# Eval("Trans_Id") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Tax Name(Local) %>" SortExpression="TaxName_L">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvTaxNameL" runat="server" Text='<%# Eval("TaxName_L") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
