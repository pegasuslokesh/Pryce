<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="AreaMaster.aspx.cs" Inherits="SystemSetUp_AreaMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Area Master%>"></asp:Label>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Area Master%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="List">
                        ...
                        <asp:UpdatePanel ID="Update_List" runat="server">
					       ...
					       <asp:Label ID="lblTotalRecords" Font-Bold="true" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="col-lg-3">
                                                    <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="form-control">
                                                        <asp:ListItem Selected="True" Text="<%$ Resources:Attendance,Area Name %>" Value="Area_Name"></asp:ListItem>
                                                        <asp:ListItem Text="<%$ Resources:Attendance,Area Name(Local) %>" Value="Area_Name_L"></asp:ListItem>
                                ...
                                <div class="box box-warning box-solid" <%= gvAreaMaster.Rows.Count>0?"style='display:block'":"style='display:none'"%>>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="flow">
                                                    ...
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="gvAreaMaster" PageSize='<%# int.Parse(Session["GridSize"].ToString()) %>'
                                                        runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True" AllowSorting="True"
                                                        OnPageIndexChanging="gvAreaMaster_PageIndexChanging" OnSorting="gvAreaMaster_OnSorting">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Area Name%>" SortExpression="Area_Name">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbCountryName" runat="server" Text='<%# Eval("Area_Name") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Area Name(Local) %>" SortExpression="Area_Name_L">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCountryNameL" runat="server" Text='<%# Eval("Area_Name_L") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Parent Area  %>" SortExpression="ParentAreaName">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCountrycode" runat="server" Text='<%# Eval("ParentAreaName") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:Label ID="lblCountryName" runat="server" Text="<%$ Resources:Attendance,Area Name%>"></asp:Label>
                                                        <a style="color: Red">*</a>
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" Display="Dynamic" runat="server" ID="RequiredFieldValidator6" ValidationGroup="Save" SetFocusOnError="true" ControlToValidate="txtAreaName" ErrorMessage="<%$ Resources:Attendance,Enter Area Name%>" />

                                                        <asp:TextBox ID="txtAreaName" runat="server" AutoPostBack="true" OnTextChanged="txtAreaName_TextChanged" BackColor="#eeeeee" CssClass="form-control" />
                                                        ...
                                                        <br />
                                                        <asp:Label ID="lblCountryNameL" runat="server" Text="<%$ Resources:Attendance,Area Name(Local) %>"></asp:Label>
                                                        <asp:TextBox ID="txtAreanameL" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <br />
                                                        <asp:Label ID="LblParentArea" runat="server" Text="<%$ Resources:Attendance,Parent Area%>"></asp:Label>
                                                        <asp:TextBox ID="txtParentArea" runat="server" BackColor="#eeeeee" AutoPostBack="true" OnTextChanged="txtParentArea_TextChanged" CssClass="form-control"></asp:TextBox>
                                                        <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" DelimiterCharacters=""
                                                            Enabled="True" ServiceMethod="GetCompletionListAreaName" ServicePath="" CompletionInterval="100"
                                                            MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtParentArea"
                                                            UseContextKey="True" CompletionListCssClass="autoCompleteList" CompletionListItemCssClass="autoCompleteListItem" CompletionListHighlightedItemCssClass="autoCompleteSelectedListItem" OnClientShown="resetPosition">
                                                        </cc1:AutoCompleteExtender>
					...
					<asp:Label ID="lblbinTotalRecords" Font-Bold="true" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                ...
                                <div class="box box-warning box-solid" <%= gvAreaMasterBin.Rows.Count>0?"style='display:block'":"style='display:none'"%> >
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div style="overflow-y: auto;">
                                                    ...
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="gvAreaMasterBin" PageSize='<%# int.Parse(Session["GridSize"].ToString()) %>'
                                                        runat="server" AutoGenerateColumns="False" DataKeyNames="Trans_Id" Width="100%"
                                                        AllowPaging="True" OnPageIndexChanging="gvAreaMasterBin_PageIndexChanging"
                                                        OnSorting="gvAreaMasterBin_OnSorting" AllowSorting="true">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
