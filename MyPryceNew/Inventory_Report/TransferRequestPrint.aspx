<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferRequestPrint.aspx.cs" Inherits="Inventory_Report_TransferRequestPrint" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Transfer Request%>"></asp:Label>
                </span>
            </a>
