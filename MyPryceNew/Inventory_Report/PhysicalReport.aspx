<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="PhysicalReport.aspx.cs" Inherits="Inventory_Report_PhysicalReport" %>
        ...
        <ContentTemplate>
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12" style="text-align:center">
                            <asp:CheckBox ID="chkAccess" runat="server"  Text="Access"  />
                         <asp:CheckBox ID="chkShort" runat="server"  Text="Short" style="margin-left:30px;"/>
                         <asp:CheckBox ID="chkZero" runat="server"  Text="Zero Difference" style="margin-left:30px;"/>
                        </div>
                        <div class="col-md-12">
                            <br />
                        </div>
                ...
                <div class="box-footer">
                    <div class="col-md-12" style="text-align:center">
                        <asp:Button ID="btnGo" runat="server" Text="Go" CssClass="btn btn-primary" OnClick="btnGo_OnClick"/>
					</div>
                </div>
            </div>
        </ContentTemplate>
