<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="Contact_Report.aspx.cs" Inherits="Inventory_Report_Contact_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Contact Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Contact Report%>"></asp:Label></li>
    </ol>
</asp:Content>
        ...
        <ContentTemplate>
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <asp:Label ID="lblAddressName" runat="server" Text="<%$ Resources:Attendance,Contact Type %>" />
