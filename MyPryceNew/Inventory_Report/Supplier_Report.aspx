<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="Supplier_Report.aspx.cs" Inherits="Inventory_Report_Supplier_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Supplier Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Supplier Report%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div id="Tr1" runat="server" class="row">
                        <div class="col-md-12">
                            <asp:Label ID="Label27" runat="server" Text="<%$ Resources:Attendance,Supplier Name %>"></asp:Label>
