...
public partial class Inventory_Report_LabelBuilderReport : System.Web.UI.Page
{
    LabelPartNoReport objReport = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        objReport = new LabelPartNoReport(Session["DBConnection"].ToString());
    ...
    void GetReport()
    {
        ...
        dtFilter = (DataTable)Session["DTPartNoReport"];
        ...
        if (Session["Lang"].ToString() == "1")
            ...
            Title = Resources.Attendance.User_Part_No__Report;
        ...
        objReport.setCurrencyName();
        string modelImageurl = "";
        try
        {
            modelImageurl = "~/CompanyResource/" + Session["CompId"].ToString() + "/Model/" + ObjInvModelMaster.GetModelMaster(Session["Compid"].ToString().ToString(), Session["BrandId"].ToString(), Request.QueryString["ModelId"].ToString(), "True").Rows[0]["Field2"].ToString();
        }
        catch
        {

        }
        objReport.setModelImageUrl(modelImageurl);
        objReport.setModelNo(ObjInvModelMaster.GetModelMaster(Session["Compid"].ToString().ToString(), Session["BrandId"].ToString(), Request.QueryString["ModelId"].ToString(), "True").Rows[0]["Model_No"].ToString());
        objReport.setModelName(ObjInvModelMaster.GetModelMaster(Session["Compid"].ToString().ToString(), Session["BrandId"].ToString(), Request.QueryString["ModelId"].ToString(), "True").Rows[0]["Model_Name"].ToString());

        objReport.setUserName(Session["UserId"].ToString());
        objReport.DataSource = dtFilter;
        objReport.DataMember = "DtLabelBuilder";
