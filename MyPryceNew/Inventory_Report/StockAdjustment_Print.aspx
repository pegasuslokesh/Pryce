<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockAdjustment_Print.aspx.cs" Inherits="Inventory_Report_StockAdjustment_Print" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Stock Adjustment Report %>"></asp:Label>
                </span>
            </a>
