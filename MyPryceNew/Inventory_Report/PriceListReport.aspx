<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="PriceListReport.aspx.cs" Inherits="Inventory_Report_PriceListReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Price List%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Price List%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Attendance,Currency%>" />
                ...
                <div class="box-footer">
                    <div class="col-md-12" style="text-align: center">
                        <asp:Panel ID="pnlshow" runat="server" DefaultButton="btnshow">
                            <asp:Button ID="btnshow" ValidationGroup="a" runat="server" Text="Show" CssClass="btn btn-primary"
                                Visible="true" OnClick="btnshow_Click" />
                        </asp:Panel>
                    </div>
                </div>
            </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div style="overflow: auto">
                                <dx:ReportViewer ID="rptViewer" runat="server" Width="100%" AutoSize="true" Height="500px">
                                </dx:ReportViewer>
                            </div>
                        </div>
                    </div>
