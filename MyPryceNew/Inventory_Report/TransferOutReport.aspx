<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferOutReport.aspx.cs" Inherits="Inventory_Report_TransferOutReport" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Transfer%>"></asp:Label>
                </span>
            </a>
            ...
            <section class="content">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <asp:Button ID="btnSend" runat="server" Visible="false" Text="Send"  CssClass="buttonCommman" OnClick="btnSend_Click" />
