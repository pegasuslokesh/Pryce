...
public partial class Inventory_Report_StockMovement_Print : System.Web.UI.Page
{
    StockMovementPrint objReport = null;
    CompanyMaster Objcompany = null;
    protected void Page_Load(object sender, EventArgs e)
    {
        objReport = new StockMovementPrint(Session["DBConnection"].ToString());
    ...
    public void GetReport()
    {
        ...
        objReport.DataMember = "sp_Inv_StockMovement_SelectRow_Report";
