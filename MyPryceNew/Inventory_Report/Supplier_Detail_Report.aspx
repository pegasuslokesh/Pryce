<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Supplier_Detail_Report.aspx.cs" Inherits="Inventory_Report_Supplier_Detail_Report" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Supplier Report %>"></asp:Label>
                </span>
            </a>
