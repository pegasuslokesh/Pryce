<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer_Detail_Report_BySalesPerson.aspx.cs" Inherits="Inventory_Report_Customer_Detail_Report_BySalesPerson" %>
...
<body class="skin-blue" style="background-color: #ECF0F5">
    <form runat="server">
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    <img style="width: 25px; margin-top: -5px;" src="../Images/product_icon.ico" alt="" />
