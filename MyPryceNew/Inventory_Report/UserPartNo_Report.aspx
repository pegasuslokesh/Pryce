<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserPartNo_Report.aspx.cs" Inherits="Inventory_Report_UserPartNo_Report" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,User Part No. Report %>"></asp:Label>
                </span>
            </a>
