...
public partial class Inventory_Report_AdjustHeaderReport : System.Web.UI.Page
{
    ...
    void GetReport()
    {
        ...
        if (Session["dtFilter_Adj_H_Report"] != null)
        {
            Dt = (DataTable)Session["dtFilter_Adj_H_Report"];
        }
