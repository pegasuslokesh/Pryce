...
public partial class Inventory_Report_Customer_Detail_Report : System.Web.UI.Page
{
    ...
    void GetReport()
    {
        ...
        if (Session["dtFilter_Cus_Dt_Report"] != null)
        {
            Dt = (DataTable)Session["dtFilter_Cus_Dt_Report"];
        }
