<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductLedgerPrint.aspx.cs" Inherits="Inventory_Report_ProductLedgerPrint" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Product Ledger %>"></asp:Label>
                </span>
            </a>
