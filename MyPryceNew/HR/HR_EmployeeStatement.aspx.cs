...
public partial class HR_Pay_EmployeeStatement : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Chk_Page_.CheckPagePermission(Session["UserId"].ToString(), "364", HttpContext.Current.Session["CompId"].ToString(), HttpContext.Current.Session["Application_Id"].ToString()).ToString() == "False")
            {
                Session.Abandon();
                Response.Redirect("~/ERPLogin.aspx");
            }
            ...
            if (Request.QueryString["Id"] != null)
            {
                ...
                {
                    txtEmployeeName.Text = dtSupName.Rows[0]["Name"].ToString() + "/" + dtSupName.Rows[0]["Trans_Id"].ToString();
                }
    ...
    public void AllPageCode()
    {
        ...
        DataTable dtModule = objObjectEntry.GetModuleIdAndName("364", (DataTable)Session["ModuleName"]);
        ...
        DataTable dtAllPageCode = ObjComman.GetAllPagePermission(Session["UserId"].ToString(), strModuleId, "364",Session["CompId"].ToString());
    ...
    protected void txtEmployeeName_TextChanged(object sender, EventArgs e)
    {
        if (txtEmployeeName.Text != "")
        {
            ...
            //else
            //{
            //    string strSupplierId = txtEmployeeName.Text.Split('/')[1].ToString();
            ...
            //        {
            //            Session["SupplierCurrency"] = dtSup.Rows[0]["Field3"].ToString();
            //            string strSupplierCurrency = Session["SupplierCurrency"].ToString();
            //            if (strSupplierCurrency == "" || strSupplierCurrency == "0")
            //            {
            //                DisplayMessage("Need to Set Supplier Currency in Supplier Setup");
            //                txtEmployeeName.Text = "";
            //                return;
            //            }

            //            Session["SupplierAccountId"] = dtSup.Rows[0]["Account_No"].ToString();
            //            string strSupplierAccount = Session["SupplierAccountId"].ToString();
            //            if (strSupplierAccount == "" || strSupplierAccount == "0")
            //            {
            //                DisplayMessage("Need to Set Supplier Account in Supplier Setup");
            //                txtEmployeeName.Text = "";
            //                return;
            //            }
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        txt181to365.Text = "";
        txtAbove365.Text = "";
        lblOpeningDebit.Text = Resources.Attendance.Opening_Balance;
        lblClosingCredit.Text = Resources.Attendance.Closing_Balance;
        txtOpeningDebit.Text = "0";
        txtClosingCredit.Text = "0";
        FillLocation();
        SetColorCode();
    }
    protected void btnGetReport_Click(object sender, EventArgs e)
    {
        ...
        // txtEmployeeName_TextChanged(sender, e);
        ...
        if (chkLoanStatement.Checked)
        {
            strAccount = "Employee Loan Account";
        }
        ...
        if (txtFromDate.Text != "")
        {
            ...
            strLocationId = hdnEmpLocation.Value.ToString();
            ...
            DataTable dtOpeningBalance = objDA.return_DataTable("select (dbo.Ac_GetBalance('" + Session["CompId"].ToString() + "', '" + Session["BrandId"].ToString() + "','" + strLocationId + "', '" + dtFromdate + "', '0','" + strPaymentVoucherAcc + "','" + hdnEmpId.Value + "','" + strCurrencyType + "', '" + fyear_id + "')) OpeningBalance");
            string strForeignOpening = objDA.get_SingleValue("select (dbo.Ac_GetBalance('" + Session["CompId"].ToString() + "', '" + Session["BrandId"].ToString() + "','" + strLocationId + "', '" + dtFromdate + "', '0','" + strPaymentVoucherAcc + "','" + hdnEmpId.Value + "',3, '" + fyear_id + "')) OpeningBalance");
        ...
        DataTable dtStatement = objVoucherDetail.GetAllStatementData(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, strPaymentVoucherAcc, hdnEmpId.Value, txtFromDate.Text, txtToDate.Text, strCurrencyType);
            ...
            foreach (GridViewRow gvr in GVSStatement.Rows)
            {
                ...
                if (strStatus == "False")
                {
                    if (txtOpeningDebit.Text != "")
                    {
                        ...
                        {
                            if (!txtOpeningDebit.Text.Contains("-"))
                            {
                            ...
                            if (!txtForeignCreditOpening.Text.Contains("-"))
                            {
        ...
        //this code added by jitendra upadhyay on 13-03-2018 for show opening type credit/debit
        ...
        if (Convert.ToDouble(txtOpeningDebit.Text) >= 0)
        {
            lblOpeningDebit.Text = Resources.Attendance.Opening_Balance + "(CR)";


        }
        else
        {
            lblOpeningDebit.Text = Resources.Attendance.Opening_Balance + "(DR)";
        }


        if (Convert.ToDouble(txtClosingCredit.Text) >= 0)
        {
            lblClosingCredit.Text = Resources.Attendance.Closing_Balance + "(CR)";
        }
        else
        {
            lblClosingCredit.Text = Resources.Attendance.Closing_Balance + "(DR)";
        }
    }
    protected void chkAgeingAnalysis_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (chkAgeingAnalysis.Checked == true)
        {
            ...
            if (txtEmployeeName.Text != "")
            {
                ...
                {
                    dtAgeingDetail = new DataView(dtAgeingDetail, "other_account_no='" + hdnEmpId.Value + "' and AgeingType='PV'", "", DataViewRowState.CurrentRows).ToTable();
                }

                //For 0-30 Days
                try
                {
                    DataTable dt30Days = ObjAgeingDetail.GetAgeingDetailforStatements(StrCompId, StrBrandId, strLocationId, hdnEmpId.Value, "PV", "4", strCurrencyType);
                ...
                try
                {
                    DataTable dt60Days = ObjAgeingDetail.GetAgeingDetailforStatements(StrCompId, StrBrandId, strLocationId, hdnEmpId.Value, "PV", "5", strCurrencyType);
                ...
                try
                {
                    DataTable dt90Days = ObjAgeingDetail.GetAgeingDetailforStatements(StrCompId, StrBrandId, strLocationId, hdnEmpId.Value, "PV", "6", strCurrencyType);
                ...
                try
                {
                    DataTable dt180Days = ObjAgeingDetail.GetAgeingDetailforStatements(StrCompId, StrBrandId, strLocationId, hdnEmpId.Value, "PV", "7", strCurrencyType);
                ...
                try
                {
                    DataTable dt365Days = ObjAgeingDetail.GetAgeingDetailforStatements(StrCompId, StrBrandId, strLocationId, hdnEmpId.Value, "PV", "8", strCurrencyType);
                ...
                try
                {
                    DataTable dt365DaysAbove = ObjAgeingDetail.GetAgeingDetailforStatements(StrCompId, StrBrandId, strLocationId, hdnEmpId.Value, "PV", "9", strCurrencyType);
    ...
    public static string[] GetCompletionListEmployeeName(string prefixText, int count, string contextKey)
    {
        DataTable dt = new EmployeeMaster(HttpContext.Current.Session["DBConnection"].ToString()).GetEmployeeMasterDtlsByCompanyBrandLocationName(HttpContext.Current.Session["CompId"].ToString(), HttpContext.Current.Session["BrandId"].ToString(), "0", prefixText);
            // Common.GetEmployee(prefixText, "0");
    ...
    protected void btnShowReport_Click(object sender, EventArgs e)
    {
        ...
        string strPaymentVoucherAcc = string.Empty;
        DateTime dtToDate = new DateTime();
        string strAccount_Print = "Employee Account";
        if (chkLoanStatement.Checked)
        {
            strAccount_Print = "Employee Loan Account";
        }

        DataTable dtAcParameter = objAcParameter.GetParameterMasterAllTrue(StrCompId);
        DataTable dtPaymentVoucher = new DataView(dtAcParameter, "Param_Name='" + strAccount_Print + "'", "", DataViewRowState.CurrentRows).ToTable();
        if (dtPaymentVoucher.Rows.Count > 0)
        {
            strPaymentVoucherAcc = dtPaymentVoucher.Rows[0]["Param_Value"].ToString();
        }
        ...
        DataTable dtEmp = objEmployee.GetEmployeeMasterById(Session["CompId"].ToString(), hdnEmpId.Value);
        ...
        //objArr.Add(txtEmployeeName.Text.Split('/')[1].ToString());
        //objArr.Add(txtFromDate.Text);
        //objArr.Add(txtToDate.Text);
        //objArr.Add(strLocationId);
        //objArr.Add(txtOpeningDebit.Text);
    ...
    protected void txtEmployeeName_TextChanged1(object sender, EventArgs e)
    {
        ...
        if (((TextBox)sender).Text != "")
        {
            ...
            DataTable dtEmp =  objEmployee.GetEmployeeMasterByEmpCode(Session["CompId"].ToString(),empid);
            //string Emp_ID = HR_EmployeeDetail.GetEmployeeId(empid);
            string Emp_ID = dtEmp.Rows[0]["Emp_Id"].ToString();
            ...
            else
            {
                ...
                hdnEmpLocation.Value = dtEmp.Rows[0]["Location_Id"].ToString();
            }
        }
        AllPageCode();
    }
