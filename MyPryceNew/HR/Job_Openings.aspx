<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="Job_Openings.aspx.cs" Inherits="HR_Job_Openings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Job Opening %>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>
            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:Attendance,Job Opening%>"></asp:Label></a></li>
        <li><a href="#"><i class="fa fa-dashboard"></i>
            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:Attendance,Job Opening%>"></asp:Label></a></li>
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Job Opening%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
					...
					<asp:Label ID="Lbl_TotalRecords" Font-Bold="true" Text="<%$ Resources:Attendance,Total Records: 0 %>" runat="server"></asp:Label>
                                ...
                                <div class="box box-warning box-solid" <%= Gv_Job_Open_List.Rows.Count>0?"style='display:block'":"style='display:none'"%>>
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="flow">
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="Gv_Job_Open_List" PageSize='<%# int.Parse(Session["GridSize"].ToString()) %>' runat="server" DataKeyNames="Trans_ID"
                                                        AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" Width="100%" OnPageIndexChanging="Gv_Job_Open_List_PageIndexChanging" OnSorting="Gv_Job_Open_List_Sorting">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Location%>" ItemStyle-Width="20%" ItemStyle-Wrap="true" SortExpression="Job_Location">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Lbl_Job_Location_List" runat="server" Text='<%# Eval("Job_Location")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Opening From Date%>" ItemStyle-Width="100%" ItemStyle-Wrap="true" SortExpression="Opening_From_Date">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Lbl_Opening_From_Date_List" runat="server" Text='<%# Eval("Opening_From_Date")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Opening To Date%>" ItemStyle-Width="120px" SortExpression="Opening_To_Date">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Lbl_Opening_To_Date_List" runat="server" Text='<%# Eval("Opening_To_Date")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                        </Columns>
                        ...
                        <asp:UpdatePanel ID="Update_New" runat="server">
                            <ContentTemplate>
                                <div>
                                    ...
                                    <asp:HiddenField ID="Hdn_Category_ID" Value="0" runat="server" />
                                    <asp:HiddenField ID="Hdn_Profile_ID" Value="0" runat="server" />
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group" style="width: 100%">
                                                            <asp:TextBox ID="Txt_Profile" OnTextChanged="Txt_Profile_TextChanged" onkeyup="SetContextKey()" AutoPostBack="true" runat="server" MaxLength="200" CssClass="form-control" BackColor="#eeeeee"></asp:TextBox>
                                                            ...
                                                            <div class="input-group-btn">
                                                                <asp:Button ID="Btn_Add_Profile" CssClass="form-control" runat="server" Text="Add" OnClick="Btn_Add_Profile_Click" />
                                                            </div>
                                                        </div>
                                                        <br />
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Lbl_Opening_From_Date" runat="server" Text="<%$ Resources:Attendance, Opening From Date%>"></asp:Label>
                                                        <a style="color: Red">*</a>
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator2" ValidationGroup="Save"
                                                            Display="Dynamic" SetFocusOnError="true" ControlToValidate="Txt_Opening_From_Date" ErrorMessage="<%$ Resources:Attendance,Enter Opening From Date%>"></asp:RequiredFieldValidator>
                                                        <asp:TextBox ID="Txt_Opening_From_Date" runat="server" OnTextChanged="Txt_Opening_From_Date_TextChanged" AutoPostBack="true" CssClass="form-control"></asp:TextBox>
                                                        <asp:RegularExpressionValidator runat="server" ControlToValidate="Txt_Opening_From_Date" ValidationExpression="^(([0-9])|([0-2][0-9])|([3][0-1]))\-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\-\d{4}$" ErrorMessage="Please Enter a valid date in the format (dd-MMM-yyyy)." ValidationGroup="Save" />
                                                        <cc1:CalendarExtender OnClientShown="showCalendar" ID="CalendarExtender2" runat="server" Enabled="True" TargetControlID="Txt_Opening_From_Date">
                                                        </cc1:CalendarExtender>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Lbl_Opening_To_Date" runat="server" Text="<%$ Resources:Attendance, Opening To Date%>"></asp:Label>
                                                        <a style="color: Red">*</a>
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator4" ValidationGroup="Save"
                                                            Display="Dynamic" SetFocusOnError="true" ControlToValidate="Txt_Opening_To_Date" ErrorMessage="<%$ Resources:Attendance,Enter Opening To Date%>"></asp:RequiredFieldValidator>
                                                        <asp:TextBox ID="Txt_Opening_To_Date" runat="server" OnTextChanged="Txt_Opening_From_Date_TextChanged" AutoPostBack="true" CssClass="form-control"></asp:TextBox>
                                                        <asp:RegularExpressionValidator runat="server" ControlToValidate="Txt_Opening_To_Date" ValidationExpression="^(([0-9])|([0-2][0-9])|([3][0-1]))\-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\-\d{4}$" ErrorMessage="Please Enter a valid date in the format (dd-MMM-yyyy)." ValidationGroup="Save" />
                                                        <cc1:CalendarExtender OnClientShown="showCalendar" ID="CalendarExtender1" runat="server" Enabled="True" TargetControlID="Txt_Opening_To_Date">
                                                        </cc1:CalendarExtender>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Lbl_Job_Location" runat="server" Text="<%$ Resources:Attendance, Job Location%>"></asp:Label>
                                                        <a style="color: Red">*</a>
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator5" ValidationGroup="Save"
                                                            Display="Dynamic" SetFocusOnError="true" ControlToValidate="Txt_Job_Location" ErrorMessage="<%$ Resources:Attendance,Enter Job Location%>"></asp:RequiredFieldValidator>
                                                        <asp:TextBox ID="Txt_Job_Location" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Lbl_No_Of_Opening" runat="server" Text="<%$ Resources:Attendance, No Of Opening%>"></asp:Label>
                                                        <a style="color: Red">*</a>
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator6" ValidationGroup="Save"
                                                            Display="Dynamic" SetFocusOnError="true" ControlToValidate="Txt_No_Of_Opening" ErrorMessage="<%$ Resources:Attendance,Enter No Of Opening%>"></asp:RequiredFieldValidator>
                                                        <asp:TextBox ID="Txt_No_Of_Opening" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender18" runat="server" Enabled="True"
                                                            TargetControlID="Txt_No_Of_Opening" ValidChars="1,2,3,4,5,6,7,8,9,0">
                                                    ...
                                                    <div class="col-md-12">
                                                        <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Attendance, Notification To Employee%>"></asp:Label>
                                                        <asp:TextBox ID="Txt_Emp_Notification" runat="server" CssClass="form-control" BackColor="#eeeeee"></asp:TextBox>
                                                        <cc1:AutoCompleteExtender ID="AutoCompleteExtender4" runat="server" DelimiterCharacters="," ShowOnlyCurrentWordInCompletionListItem="true"
                                                            ...
                                                            MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="Txt_Emp_Notification" UseContextKey="True"
                                                            CompletionListCssClass="autoCompleteList" CompletionListItemCssClass="autoCompleteListItem" CompletionListHighlightedItemCssClass="autoCompleteSelectedListItem" OnClientShown="resetPosition">
                                                        </cc1:AutoCompleteExtender>
                                                        <br />
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:TextBox ID="Txt_Experience" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Lbl_Relevant_Experience" runat="server" Text="<%$ Resources:Attendance, Relevant Experience%>"></asp:Label>
                                                        <asp:TextBox ID="Txt_Relevant_Experience" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:TextBox ID="Txt_Salary_Range" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Lbl_Incentive_Commission" runat="server" Text="<%$ Resources:Attendance, Incentive & Commission%>"></asp:Label>
                                                        <asp:TextBox ID="Txt_Incentive_Commission" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Lbl_Job_Type" runat="server" Text="<%$ Resources:Attendance, Job Type%>"></asp:Label>
                                                        <a style="color: Red">*</a>
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator12" ValidationGroup="Save" Display="Dynamic"
                                                            SetFocusOnError="true" ControlToValidate="DDL_Job_Type" InitialValue="--Select--" ErrorMessage="<%$ Resources:Attendance,Select Job Type %>" />
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator13" ValidationGroup="Save"
                                                            Display="Dynamic" SetFocusOnError="true" ControlToValidate="Txt_Language" ErrorMessage="<%$ Resources:Attendance,Enter Language Skill Required%>"></asp:RequiredFieldValidator>
                                                        <asp:TextBox ID="Txt_Language" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-12">
					...
					<asp:Label ID="Lbl_TotalRecords_Bin" Font-Bold="true" Text="<%$ Resources:Attendance,Total Records: 0 %>" runat="server"></asp:Label>
                                ...
                                <div class="box box-warning box-solid" <%= Gv_Job_Open_Bin.Rows.Count>0?"style='display:block'":"style='display:none'"%> >
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="flow">
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="Gv_Job_Open_Bin" PageSize='<%# int.Parse(Session["GridSize"].ToString()) %>' runat="server" DataKeyNames="Trans_Id" OnPageIndexChanging="Gv_Job_Open_Bin_PageIndexChanging" OnSorting="Gv_Job_Open_Bin_Sorting"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Location%>" ItemStyle-Width="20%" ItemStyle-Wrap="true" SortExpression="Job_Location">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Lbl_Job_Location_Bin" runat="server" Text='<%# Eval("Job_Location")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Opening From Date%>" ItemStyle-Width="100%" ItemStyle-Wrap="true" SortExpression="Opening_From_Date">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Lbl_Opening_From_Date_Bin" runat="server" Text='<%# Eval("Opening_From_Date")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Opening To Date%>" ItemStyle-Width="120px" SortExpression="Opening_To_Date">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Lbl_Opening_To_Date_Bin" runat="server" Text='<%# Eval("Opening_To_Date")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                        </Columns>
...
<asp:Content ID="Content5" ContentPlaceHolderID="AfterLoadScriptContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SetContextKey() {
            $find('<%=AutoCompleteExtender1.ClientID%>').set_contextKey($get("<%=Hdn_Category_ID.ClientID %>").value);
        }
