<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="PayEmployeePenalty.aspx.cs" Inherits="HR_PayEmployeePenalty" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Penalty%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Employee Penalty%>"></asp:Label></li>
    </ol>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel ID="Update_Button" runat="server">
        <ContentTemplate>
            ...
            <asp:Button ID="Btn_New" Style="display: none;" runat="server" OnClick="btnPenalty_Click" Text="New" />
        </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <div id="myTab" class="nav-tabs-custom">
        <ul class="nav nav-tabs pull-right bg-blue-gradient">
            <li id="Li_Penalty"><a href="#Penalty" onclick="Li_Tab_New()" data-toggle="tab">
                <asp:UpdatePanel ID="Update_Li" runat="server">
                    <ContentTemplate>
                        <i class="fa fa-file"></i>&nbsp;&nbsp;
                        <asp:Label ID="Lbl_New_tab" runat="server" Text="<%$ Resources:Attendance,Penalty%>"></asp:Label>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </a></li>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <span class="input-group-btn">
                                                    <asp:LinkButton ID="ImgbtnAllRefresh" runat="server"
                                                        CausesValidation="False" OnClick="btnAllRefresh_Click"
                                                ...
                                                <div class="col-md-12">
                                                    <div id="Div2" runat="server" class="box box-info collapsed-box">
                                                        <div class="box-header with-border">
                                                            ...
                                                            &nbsp;&nbsp;|&nbsp;&nbsp;
					<asp:Label ID="lblTotalRecordsPenalty" Font-Bold="true" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                                        ...
                                                        <div class="box-body">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <asp:Panel ID="Panel1" runat="server" DefaultButton="imgBtnPenaltyBind">
                                                                    <asp:TextBox ID="txtValue1" runat="server" class="form-control"></asp:TextBox>
                                                                </asp:Panel>
                                                            </div>
                                                            <div class="col-lg-2" style="text-align: center;">
                                                                <asp:LinkButton ID="imgBtnPenaltyBind" runat="server"
                                                                    CausesValidation="False" OnClick="btnPenaltybind_Click"
                                                                    ToolTip="<%$ Resources:Attendance,Search %>"><span class="fa fa-search"  style="font-size:25px;"></span></asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                                            <asp:LinkButton ID="btnRefresh" runat="server" CausesValidation="False"
                                                                OnClick="btnPenaltyRefresh_Click" ToolTip="<%$ Resources:Attendance,Refresh %>"><span class="fa fa-repeat"  style="font-size:25px;"></span></asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                                            <asp:LinkButton ID="ImageButton6" runat="server" OnClick="ImgbtnSelectAll_ClickPenalty"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="flow">
                                                                ...
                                                                <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="gvEmpPenalty" runat="server" AllowPaging="True" AllowSorting="true"
                                                                    AutoGenerateColumns="False" OnPageIndexChanging="gvEmpPenalty_PageIndexChanging"
                                                                    OnSorting="GridViewEmpPenalty_Sorting" Width="100%" DataKeyNames="Emp_Id"
                                                                ...
                                                                <asp:HiddenField ID="hdFSortgvEmpPenalty" runat="server" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body">
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                                <asp:Label ID="lblAllowDeductionType" runat="server" Text="<%$ Resources:Attendance,Penalty Name%>"></asp:Label>
                                                <a style="color: Red">*</a>
                                                <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server"
                                                    ...
                                                    ControlToValidate="TxtPenaltyName" ErrorMessage="<%$ Resources:Attendance,Enter Penalty Name %>"></asp:RequiredFieldValidator>
                                                <asp:TextBox ID="TxtPenaltyName" runat="server" CssClass="form-control" BackColor="#eeeeee"></asp:TextBox>
                                                <cc1:AutoCompleteExtender ID="AutoCompleteExtender5" runat="server" DelimiterCharacters=""
                                                    ...
                                                    MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="TxtPenaltyName"
                                                    UseContextKey="True"
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                                <asp:Label ID="lblPenaltyDiscription" runat="server" Text="<%$ Resources:Attendance,Penalty Description %>"></asp:Label>
                                                <asp:TextBox ID="TxtPenaltyDiscription" runat="server" Height="100px" TextMode="MultiLine"
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                ...
                                                <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server"
                                                    ...
                                                    ControlToValidate="DdlValueType" InitialValue="0" ErrorMessage="<%$ Resources:Attendance,Select Value Type %>" />
                                        ...
                                        <div style="text-align: center;" class="col-md-12">
                                            <asp:Button ID="btnSave" runat="server" CssClass="btn btn-success" Visible="false"
                                                Text="<%$ Resources:Attendance,Save %>" ValidationGroup="Save" OnClick="btnSavePenalty_Click" />
                                            ...
                                            <asp:Label ID="lblWrongSequence" Visible="false" runat="server" Font-Bold="true"
                                                ForeColor="Red"></asp:Label><br />
                                            <asp:Label ID="lblDojIssue" Visible="false" runat="server" Font-Bold="true" ForeColor="Red"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="tab-pane active" id="List">
                <asp:UpdatePanel ID="Update_List" runat="server">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                ...
                                                <asp:DropDownList ID="DdlMonthList" runat="server" CssClass="form-control">
                                                    <asp:ListItem Text="<%$ Resources:Attendance, --Select-- %>" Value="0" />
                                                    <asp:ListItem Text="<%$ Resources:Attendance, January %>" Value="1" />
                                                    <asp:ListItem Text="<%$ Resources:Attendance, February %>" Value="2" />
                                                    <asp:ListItem Text="<%$ Resources:Attendance, March %>" Value="3" />
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <span class="input-group-btn">
                                                        <asp:LinkButton ID="BtnBindList" runat="server"
                                                            CausesValidation="False" ToolTip="<%$ Resources:Attendance,Search %>"
                                                            OnClick="BtnBindList_Click"><span class="fa fa-search"  style="font-size:25px; margin-left:10px;"></span></asp:LinkButton>
                                                        <asp:LinkButton ID="BtnRefreshList" runat="server"
                                                            CausesValidation="False" ToolTip="<%$ Resources:Attendance,Refresh %>"
					...
					<asp:Label ID="lblTotalRecordSearchPanel" Font-Bold="true" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-lg-2" style="text-align: center;">
                                            <asp:LinkButton ID="btnbindBin" runat="server"
                                                CausesValidation="False" OnClick="btnPenaltybindSearchPanel_Click"
                                                ToolTip="<%$ Resources:Attendance,Search %>"><span class="fa fa-search"  style="font-size:25px;"></span></asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                            <asp:LinkButton ID="btnRefreshBin_" runat="server" CausesValidation="False"
                                                OnClick="btnPenaltyRefreshSearchPanel_Click"
                        ...
                        <div class="box box-warning box-solid" <%= GridViewPenaltyList.Rows.Count>0?"style='display:block'":"style='display:none'"%>>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="flow">
                                            ...
                                            <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GridViewPenaltyList" runat="server" AllowPaging="True" AllowSorting="true"
                                                AutoGenerateColumns="False" Width="100%" DataKeyNames="Emp_Id"
                                                PageSize='<%# int.Parse(Session["GridSize"].ToString()) %>' OnPageIndexChanging="GridViewPenaltyList_PageIndexChanging"
                                                OnSorting="GridViewPenaltyList_Sorting">
                                                <Columns>
                                                            ...
                                                            <div class="dropdown" style="position: absolute;">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li <%= hdnCanEdit.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                        <asp:LinkButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Penalty_Id") %>'
                                                                    ...
                                                                    <li <%= hdnCanDelete.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                        <asp:LinkButton ID="IbtnDelete" runat="server" CausesValidation="False"
                                                                            CommandArgument='<%# Eval("Penalty_Id") %>' OnCommand="IbtnDelete_command"
                                                    ...
                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance,Employee Id %>" SortExpression="Emp_Id">
                                                        <ItemTemplate>
                                                    ...
                                                    <%--  <asp:TemplateField HeaderText="<%$ Resources:Attendance,Employee Name Local%>" SortExpression="Emp_Name_L">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblEmpnameListL" runat="server" Text='<%# Eval("Emp_Name_L") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle  />
                                                    </asp:TemplateField>--%>
                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance,Date of Joining %>" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance,Penalty name %>" SortExpression="Penalty_Name">
                                                        <ItemTemplate>
                        ...
                        <div runat="server" visible="false" id="Edit_Penalty" class="row">
                            <div class="col-md-12">
                                <div class="box box-warning">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Details</h3>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <asp:TextBox ID="txtEmployeeName" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="col-md-12">
                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:Attendance,Penalty Name%>"></asp:Label>
                                            <a style="color: Red">*</a>
                                            <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server"
                                                ID="RequiredFieldValidator1" ValidationGroup="E_Save" Display="Dynamic" SetFocusOnError="true"
                                                ControlToValidate="TxtPenaltyNameList" ErrorMessage="<%$ Resources:Attendance,Enter Penalty Name %>"></asp:RequiredFieldValidator>
                                            <asp:TextBox ID="TxtPenaltyNameList" runat="server" CssClass="form-control"></asp:TextBox>
                                            <br />
                                        </div>
                                        <div class="col-md-12">
                                            <asp:Label ID="Label7" runat="server" Text="<%$ Resources:Attendance,Penalty Description %>"></asp:Label>
                                            <asp:TextBox ID="TxtPenaltyDiscList" runat="server" Height="100px" TextMode="MultiLine"
                                                CssClass="form-control"></asp:TextBox>
                                            <br />
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <a style="color: Red">*</a>
                                            <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server"
                                                ID="RequiredFieldValidator8" ValidationGroup="E_Save" Display="Dynamic" SetFocusOnError="true"
                                                ControlToValidate="DdlvalueTypelist" InitialValue="0" ErrorMessage="<%$ Resources:Attendance,Select Value Type %>" />
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" Enabled="True"
                                                TargetControlID="Txtvaluelist" ValidChars="1,2,3,4,5,6,7,8,9,0,.">
                                            </cc1:FilteredTextBoxExtender>
                                            <br />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a style="color: Red">*</a>
                                            <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server"
                                                ID="RequiredFieldValidator9" ValidationGroup="E_Save" Display="Dynamic" SetFocusOnError="true"
                                                ControlToValidate="DdlMonthListPanel" InitialValue="0" ErrorMessage="<%$ Resources:Attendance,Select Month %>" />
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a style="color: Red">*</a>
                                            <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server"
                                                ID="RequiredFieldValidator10" ValidationGroup="E_Save" Display="Dynamic" SetFocusOnError="true"
                                                ControlToValidate="TxtpanelYearList" ErrorMessage="<%$ Resources:Attendance,Enter Year %>"></asp:RequiredFieldValidator>
                                        ...
                                        <div style="text-align: center;" class="col-md-12">
                                            <asp:RadioButton ID="RbtnApproved" runat="server" Text="<%$ Resources:Attendance,Approved %>"
                                                GroupName="Loan" />
                                            <asp:RadioButton ID="RbtnCancelled" runat="server" Text="<%$ Resources:Attendance,Cancelled %>"
                                                GroupName="Loan" />
                                            ...
                                            <asp:Button ID="BtnResetPenalty" runat="server" CausesValidation="False" CssClass="btn btn-primary"
                                                Text="<%$ Resources:Attendance,Cancel %>" OnClick="BtnResetPenalty_Click" />
    ...
    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="Update_Penalty">
        <ProgressTemplate>
            <div class="modal_Progress">
                <div class="center_Progress">
                    <img alt="" src="../Images/ajax-loader2.gif" style="vertical-align: middle; background-color: White; border-radius: 10px;" />
    ...
    <asp:Panel ID="PnlEmployeePenalty" runat="server" Visible="false">
    </asp:Panel>
    <asp:Panel ID="PanelSearchList" runat="server" Visible="false">
    </asp:Panel>
    <asp:Panel ID="pnlPenalty" runat="server" Visible="false">
    </asp:Panel>
    <asp:Panel ID="PanelList" runat="server" Visible="false">
    </asp:Panel>
    <asp:Panel ID="PanelUpdatePenalty" runat="server" Visible="false">
    </asp:Panel>
</asp:Content>
