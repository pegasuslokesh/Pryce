<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HR_EmployeePayment_Print.aspx.cs" Inherits="HR_HR_EmployeePayment_Print" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Employee Payment Challan %>"></asp:Label>
                </span>
            </a>
            ...
            <section class="content">
                <div class="box box-primary" style="text-align: center">
                    <div class="box-header with-border">
                        <h3 class="box-title">Employee Payment Challan</h3>
