<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="HR_EmployeeRehiring.aspx.cs" Inherits="HR_HR_EmployeeRehiring" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="Employee Rehiring"></asp:Label>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="Employee Rehiring"></asp:Label></li>
    </ol>
</asp:Content>
                                                ...
                                                <div class="flow">
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvsalaryPlan" runat="server" AutoGenerateColumns="False" Width="100%"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Rehiring date" SortExpression="Rehiring_date">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbltrnDate" runat="server" Text='<%#GetDate(Eval("Rehiring_date").ToString())%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle Width="10%" />
                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="Previous hiring date" SortExpression="Previous_Rehiring_date">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbltrnDate1" runat="server" Text='<%#GetDate(Eval("Previous_Rehiring_date").ToString())%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle Width="20%" />
                                                            </asp:TemplateField>
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                            <asp:Label ID="Label4" runat="server" Text="Rehiring Date"></asp:Label>
                                                            <a style="color: Red">*</a>
                                                            <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server"
                                                                ...
                                                                ControlToValidate="txttrnDate" ErrorMessage="Enter Hiring date"></asp:RequiredFieldValidator>
