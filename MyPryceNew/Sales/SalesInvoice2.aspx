<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="SalesInvoice2.aspx.cs" Inherits="Sales_SalesInvoice2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>
            <asp:Label ID="Label25" runat="server" Text="<%$ Resources:Attendance,Inventory%>"></asp:Label></a></li>
        <li><a href="#"><i class="fa fa-dashboard"></i>
            <asp:Label ID="Label26" runat="server" Text="<%$ Resources:Attendance,Sales%>"></asp:Label></a></li>
        <li class="active">
            <asp:Label ID="Label27" runat="server" Text="<%$ Resources:Attendance,Sales Invoice%>"></asp:Label></li>
    </ol>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel ID="Update_Button" runat="server">
        <ContentTemplate>
            ...
            <asp:HiddenField runat="server" ID="hdnCanCancel" />
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs pull-right bg-blue-gradient">
                     <li id="Li_Import"><a href="#import_invoice" onclick="Li_Tab_Import()" data-toggle="tab">
                        <i class="fa fa-upload"></i>&nbsp;&nbsp;<asp:Label ID="Label33" runat="server" Text="<%$ Resources:Attendance,Import %>"></asp:Label></a></li>
                    ...
                    <li id="Li_List" class="active"><a href="#List"  onclick="LI_List_Active()" data-toggle="tab">
                   ...
                   <div class="tab-pane active" id="List">
                                    ...
                                    <div class="col-md-12">
                                        <div id="Div1" runat="server" class="box box-info collapsed-box">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">
                                                    <asp:Label ID="Label223" runat="server" Text="Advance Search"></asp:Label></h3>
                                                &nbsp;&nbsp;|&nbsp;&nbsp;
					<asp:Label ID="lblTotalRecords" Font-Bold="true" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="col-lg-2">
                                                    <asp:LinkButton ID="btnbind" runat="server" CausesValidation="False"  OnClientClick="fillTblInvoice();return false;" ToolTip="<%$ Resources:Attendance,Search %>"><span class="fa fa-search"  style="font-size:25px;"></span></asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">                                             
                                                ...
                                                <div class="flow">
                                                   <table id="GvSalesInvoice" class="table-striped table-bordered table table-hover">
                                                        <thead>
                                                            <th>Action</th>
                                                            <th>Invoice No.</th>
                                                            <th>Invoice Date</th>
                                            ...
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:TextBox ID="txtSInvDate" onkeydown='return (event.keyCode!=13);' runat="server" CssClass="form-control" Enabled="false" />
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:TextBox ID="txtInvoiecRefno" TabIndex="1" onkeydown='return (event.keyCode!=13);' runat="server" CssClass="form-control"></asp:TextBox>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label ID="lblOrderId" runat="server" Text="Customer Order Id" />
                                                        <asp:TextBox ID="txtOrderId" TabIndex="2" onkeydown='return (event.keyCode!=13);' runat="server" CssClass="form-control"></asp:TextBox>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Label16" runat="server" Text="Invoice Merchant" />
                                                        <asp:DropDownList ID="ddlMerchant" TabIndex="3" runat="server" CssClass="form-control">
                                                        </asp:DropDownList>
                                                        <br />
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:TextBox ID="txtPOSNo" TabIndex="4" onkeydown='return (event.keyCode!=13);' runat="server" CssClass="form-control" />
                                                        <br />
                                                    </div>
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            <asp:TextBox onkeydown='return (event.keyCode!=13);' TabIndex="5" ID="txtCustomer" runat="server" CssClass="form-control" onchange="txtCustomer_TextChanged(this)" ClientIDMode="Static"
                                                                BackColor="#eeeeee" />
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <asp:TextBox ID="txtContactPerson" TabIndex="6" runat="server" CssClass="form-control" BackColor="#eeeeee" onchange="txtContactPerson_TextChanged(this)" />
                                                    ...
                                                    <div class="col-md-2">
                                                       <br />
                                                        <asp:LinkButton ID="LinkButton1" runat="server" ToolTip="Add New Contact" OnClick="lnkAddNewContact_Click" AlternateText="<%$ Resources:Attendance,Add %>" CausesValidation="False"><i class="fa fa-plus-square" style="font-size:35px;padding:5px;margin-top: -5px;"></i></asp:LinkButton>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:TextBox onkeydown='return (event.keyCode!=13);' TabIndex="7" ID="txtSalesPerson" runat="server" CssClass="form-control" BackColor="#eeeeee"
                                                    ...
                                                    <div class="col-md-6" id="Trans_Div" runat="server">
                                                        ...
                                                        <asp:DropDownList ID="ddlTransType" TabIndex="8" runat="server" CssClass="form-control"></asp:DropDownList>
                                                        <br />
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <small><label id="InvoiceAddress" runat="server" ></label></small>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:TextBox onkeydown='return (event.keyCode!=13);' TabIndex="9" ID="txtShipCustomerName" runat="server" CssClass="form-control" BackColor="#eeeeee"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <asp:TextBox onkeydown='return (event.keyCode!=13);' TabIndex="10" ID="txtShipingAddress" runat="server" CssClass="form-control" BackColor="#eeeeee"
                                                            onchange="validateAddress(this)" />
                                                        <small><label id="ShippingAddress" runat="server" ></label> </small>
                                                     ...
                                                     <div class="col-md-2">
                                                        <br />
                                                         ...
                                                         &nbsp;                                                         
                                                        <button id="btnGetLocation" type="button"  class="btn btn-defult" onclick="GetGeoLocation(); return false;"><i class="fa fa-map-marker" style="color:green"></i></button>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-4">
                                                        <br />
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <asp:DropDownList ID="ddlProductSerach" runat="server" CssClass="form-control" onchange="ddlProductSerach_SelectedIndexChanged(this)">
                                                                        <asp:ListItem Text="<%$ Resources:Attendance,Product Id %>" Selected="True" Value="ProductCode" ></asp:ListItem>
                                                                        <asp:ListItem Text="<%$ Resources:Attendance,Product Name %>"  Value="ProductName"
                                                                            ></asp:ListItem>
                                                                     </asp:DropDownList>
                                                                </div>
                                                                <div class="col-lg-9"  id="divProductCode">
                                                                ...
                                                                <div class="col-lg-9" style="display: none;" id="divProductName">
                                                                            ...
                                                                            <table id="tblProduct" class="table table-striped table-border">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th>Total</th>
                                                                                        <th style="display:none">Customer Product Code</th>
                                                                                        <th style="display:none">Location Out</th>
                                                                                        <th>Stock</th>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th>Delete</th>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <asp:TextBox onkeydown='return (event.keyCode!=13);' TabIndex="11" ID="txtDiscountP" runat="server" CssClass="form-control"
					 ...
					 <asp:Label ID="lblTotalRecordsBin" Font-Bold="true" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <asp:LinkButton ID="imgBtnRestore" CausesValidation="False" Visible="true" runat="server" OnClick="imgBtnRestore_Click" ToolTip="<%$ Resources:Attendance, Active %>"><span class="far fa-lightbulb"  style="font-size:25px;"></span></asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="Div4" runat="server" class="box box-info">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">
                                                    <asp:Label ID="Label32" runat="server" Text="Import Invoice Using Excel"></asp:Label></h3>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
...
<asp:Content ID="Content5" ContentPlaceHolderID="AfterLoadScriptContent" runat="Server"><script src="../Script/common.js"></script>
    ...
    <script type="text/javascript">
        ...
        function LI_List_Active() {
            ...
            $("#Li_Pending_Order").removeClass("active");
            $("#Pending_Order").removeClass("active");
        ...
        $(document).ready(function () {
            ...
            setTimeout(function () { jQuery('#<%=txtInvoiecRefno.ClientID%>').focus() }, 500);
});
        ...
        function LoctionList() {
            ...
            var location = [];
            $.ajax({
                url: 'SalesInvoice2.aspx/GetLocationList',
                method: 'post',
                async: false,
            ...
            try {
                ...
                PageMethods.GetCreditInfo(id, currency, function (data) {
                    if (data == null) {
                        ...
                        // $('#Label17').text(data.split(',')[0]);
                        // $('#Label19').text(data.split(',')[1]);
                        // $('#Label23').text(data.split(',')[2]);
                        // // $('#creditTermsNConditions').modal('show')
                        //// $('trCreditInfo').display(true);
                        // //$("#trCreditInfo").css("visibility","visible");
        ...
        function ShipingAddressDetail() {
            ...
            if ($('#<%= txtShipingAddress.ClientID %>').val() == "") {
                if ($('#<%=txtInvoiceTo.ClientID%>').val() != "") {
                    $('#<%= txtShipingAddress.ClientID %>').val($('#<%=txtInvoiceTo.ClientID%>').val());
                    ShipingAddressDetail();
                }
        ...
        function GetInvoiceAddress() {
            ...
            if ($('#<%= txtInvoiceTo.ClientID %>').val() == "") {
                if ($('#<%=txtShipingAddress.ClientID%>').val() != "") {
                    $('#<%= txtInvoiceTo.ClientID %>').val($('#<%=txtShipingAddress.ClientID%>').val());
                }
                GetInvoiceAddress();
                $('#<%= InvoiceAddress.ClientID %>').text('');
            }
            else {
                $.ajax({
                    url: 'SalesOrderJScript.aspx/GetShippingAddressByName',
        ...
        function GetPendingSalesOrder() {
            ...
            try {
                ...
                $.ajax({
                    url: 'SalesInvoice2.aspx/getSalesOrders',
                    method: 'post',
                    async: false,
                    contentType: "application/json; charset=utf-8",
                    ...
                    success: function (data) {
                        ...
                        if (salesOrder == "" || salesOrder == null) {
                            alert("Not found any approved sales order");
                        }
                        debugger;
                        $('#tblOrders').dataTable({
                            destroy: true,
                            ...
                            columns: [
                                {
                                    data: "salesOrderId", render: function (data, display, row, end) {
                                        var so = 'so';
                                        var dad = "<input type='checkbox' id='chkAddToInvoice' onclick='InsertOrderInTable(" + JSON.stringify(row) + "," + end.row + ",this,)' /> <input type='hidden' id='tblHdnisDeliveryVoucher' value='" + row.isDeliveryVoucher + "'>";
                                        return dad;
                                    }, className: "text-left"
                                },
        ...
        //This function if Order is checked then show in Product Table if not then not show
        function InsertOrderInTable(row, index, tblRow, type) {
            debugger;
            if (tblRow.checked) {
                fillTblProduct(row, index, tblRow, type);
            }
            else {
                var columnIndex = $("#tblProduct th:contains('Sales Order')").index();
                $("#tblProduct tbody tr").each(function () {
                    var Currentrow = $(this);
                    var cellValue = $(this).find("td").eq(columnIndex).text();
                    debugger;
                    if (cellValue.trim() === row.salesOrderNo) {
                        Currentrow.remove();
                        return false; // Break out of the loop if the value is found
                    }
                });
            }
        }
        function fillTblProduct(row, index, tblRow, type) {
            ...
            if (type == 'so' || type == undefined) {
                ...
                /// htmlRow = htmlRow + "<td style='font-size:10px'>" + row.productName + " <input type='hidden' id='tblHdnProductDescription' value='" + row.productDescription + "'><input id='txtDescription" + row + "' value='" +  row.productDescription + "' type='hidden'><button type='button' id='ModelHover'  onClick='ProModelopen(" + row + ");'  class='btn btn-primary'><i class='fa fa-search'></i></button></td>";
                htmlRow = htmlRow + "<td style='font-size:15px'>" + row.productName + " <input type='hidden' id='tblHdnProductDescription' value='" + row.productDescription + "'><button type='button' id='ModelHover'  onClick='ProModelopen(\"" + row.productName.replace(/\n/g, ' ') + "\");'  class='btn btn-primary'><i class='fa fa-search'></i></button></td>";
                ...
                htmlRow = htmlRow + "<td><input style='width:70px;'  onkeydown='return (event.keyCode!=13);' type='number' id='tblTxtUnitPrice' name='tblTxtUnitPrice' value='" + GetAmountWithDecimal(row.unitPrice, <%=Session["LoginLocDecimalCount"].ToString() %>) + "' onchange='GetUnitPrice(" + sNo + ");'> </td>";
                ...
                if (discount == "true") {
                    ...
                    htmlRow = htmlRow + "<td style='display:none'><input style='width:70px;'    onkeydown='return (event.keyCode!=13);' type='number' id='tblTxtDiscountPer' value='" + row.discountPer + "' onchange='reCalulateLineTotal(" + sNo + ")'></td>";
                ...
                htmlRow = htmlRow + "<td style='display:none'><input name='txtCustomerCoopCode' type='text' id='txtCustomerCoopCode' style='width: 50px; '></br>   <input type='submit' style='display:none' name='btnUpdateCustomerCode' value='Update Customer Code' id='btnUpdateCustomerCode'/></td>";
                htmlRow = htmlRow + "<td style='display:none'> <select name='Location_Out' id='Location_Out'>";
            ...
            if (type == 'wso') {
                ...
                htmlRow = htmlRow + "<td>" + sNo + "</td>"; //serial number
                htmlRow = htmlRow + "<td><label id='tblLblProdutCode'>" + row.productCode + "</label></br><input type='hidden' id='tblHdnProductId' name='tblHdnProductId' value='" + row.productId + "' readonly></td>";
                htmlRow = htmlRow + "<td ><label style='font-size:15px' id='tblLblProdutName'>" + row.productName + "</label><input type='hidden' id='tblHdnProductDescription' value='" + row.productDescription + "'><button type='button' id='ModelHover' onClick='ProModelopen(" + row.productDescription + ");' class='btn btn-primary'><i class='fa fa-search'></i></button></td>";
                //htmlRow = htmlRow + "<td>" + row.unitName + " <input type='hidden' id='tblHdnUnitId' value='" + row.unitId + "'> </td>";
                htmlRow = htmlRow + "<td><select name='tblHdnUnitId' id='tblHdnUnitId'><option value = '" + row.unitId + "'>" + row.unitName + "</option></select></td>";
                htmlRow = htmlRow + "<td><input style='width:70px;'  onkeydown='return (event.keyCode!=13);' type='number' id='tblTxtUnitPrice' value='" + row.unitPrice + "' onchange='GetUnitPrice(" + sNo + ")'> </td>";
                ...
                htmlRow = htmlRow + "<td>" + 0 + "</td>";
                if (row.inventoryType == "SNO") {
                    htmlRow = htmlRow + "<td><input style='width:70px;'   onkeydown='return (event.keyCode!=13);' type='number' id='tblTxtSalesQty' value='" + row.salesQty + "' onchange='reCalulateLineTotal(" + sNo + ")'><a onclick='showProductSerialNo(this," + sNo + ")' style='cursor:pointer'>Add</a> </td>";
                }
                else {
                    htmlRow = htmlRow + "<td><input style='width:70px;'   onkeydown='return (event.keyCode!=13);' type='number' id='tblTxtSalesQty' value='" + row.salesQty + "' onchange='reCalulateLineTotal(" + sNo + ")'></td>";
                }
                ...
                if ('<%= hdnIsDiscountEnable.Value %>' == "true") {
                    ...
                    htmlRow = htmlRow + "<td><input style='width:30px;'   onkeydown='return (event.keyCode!=13);' type='number' id='tblTxtDiscountValue' value='" + row.discountValue + "'></td>";
                } else {
                    htmlRow = htmlRow + "<td style='display:none'><input style='width:30px;'  onkeydown='return (event.keyCode!=13);' type='number' id='tblTxtDiscountPer' value='" + row.discountPer + "' onchange='reCalulateLineTotal(" + sNo + ")'></td>";
                    htmlRow = htmlRow + "<td style='display:none'>" + row.discountValue + "></td>";
                }
                ...
                htmlRow = htmlRow + "<td style='display:none'><input name='txtCustomerCoopCode' type='text' id='txtCustomerCoopCode' style='width: 50px; '></br>   <input type='submit'  name='btnUpdateCustomerCode' value='Update Customer Code' id='btnUpdateCustomerCode'/></td>";
                ...
                if (row.LocationOut != "0") {
                    ...
                    htmlRow = htmlRow + '<option selected="selected" value=' + row.LocationOut + '>' + row.Location_Out + '</option>';
                }
                for (i = 0; i < LocationOut.d.length; i++) {
                    htmlRow = htmlRow + '<option value="' + LocationOut.d[i] + '">' + LocationOut.d[i] + '</option>';
                }
            ...
            if (type == "so" || type == undefined) {
                ...
                if (row.taxValue > 0) {
                    $.ajax({
                        url: 'SalesInvoice2.aspx/getSalesOrdersTax',
                        method: 'post',
                        async: false,
                        contentType: "application/json; charset=utf-8",
 ...
 function addProductToInvoice(product) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (unitPrice < salesPrice) {
                            ...
                            $("#prgBar").css("display", "none");
                            $(row).find("td:eq(6) input[id='tblTxtUnitPrice']").val(salesPrice);
                            // Move the code that depends on salesPrice here
                            reCalulateLineTotal(rowSNo);
                            return;
                        }
                        else {
                            reCalulateLineTotal(rowSNo);
        ...
        var wage = document.getElementById('<%=txtProductId.ClientID%>');
        wage.addEventListener("keydown", function (e) {

            if (e.code === "Enter" || e.code === "NumpadEnter") {  //checks whether the pressed key is "Enter"
                txtProductName_TextChanged(e.target);
            }
        });
       ...
       var txtPaymentExchangerate_ = document.getElementById('<%=txtPaymentExchangerate.ClientID%>');
        ...
        function txtProductName_TextChanged(ctl) {
            ...
            $("#prgBar").css("display","block");
            $.ajax({
                url: 'SalesInvoice2.aspx/getProductDetail',
                method: 'post',                 
                async: false,
                contentType: "application/json; charset=utf-8",
        ...
        function productSerialAdd() {
            ...
            if (validSerialNos.length > 0) {
                $("#prgBar").css("display","block");
                $.ajax({
                    url: 'SalesInvoice2.aspx/validateSerailNo',
                    method: 'post',
                    contentType: "application/json; charset=utf-8",
        ...
        function DeleteInvoice(transId,isApproved){
            $("#prgBar").css("display", "block");
            $.ajax({
                url: 'SalesInvoice2.aspx/IbtnDelete_Command',
                method: 'post',
                contentType: "application/json;",
                data: "{'transId':'" + transId + "','isApproved':'" + isApproved + "'}",
                dataType: 'json',
                success: function (data) {
                    debugger;
                    alert(data.d[0]);
        ...
        function PrintInvoice(Trans_Id) {
           // window.open('../Sales/SalesQuotationPrint.aspx?Id=' + Trans_Id + '');
            window.open('../Sales/SalesInvoicePrint.aspx?Id= '+ Trans_Id+'','window','width=1024, ');
        }
        ...
        function fillTblInvoice()
        {
          ...
          var ddlOption = $('#<%=ddlOption.ClientID%>').val();
            ...
            var table = $('#GvSalesInvoice').DataTable();
            var decimalCount = document.getElementById('<%= hdnDecimalCount.ClientID%>').value;
            ...
            //$("select[name='GvSalesInvoice_length']").on('change', function() {
            //    fillTblInvoice();
            //}); 
            pageSize = 1000;
            debugger;
            $.ajax({
                url: 'SalesInvoice2.aspx/FillGrid',
                method: 'post',
                contentType: "application/json;",
                data: "{'ddlLocation':'" + ddlLocation + "','ddlPosted':'" + ddlPosted + "','ddlFieldName':'" + ddlFieldName + "','ddlOption':'" + ddlOption + "','txtValue':'" + txtValue + "','PageSize':'"+pageSize+"'}",            
                dataType: 'json',
                beforeSend: function () {                    $("#prgBar").css("display", "block");                },                complete: function () {                    $("#prgBar").css("display", "none");                },
                success: function(data) {
                    ...
                    for (var i = 0; i < myArr.length; i++) {
                        ...
                        var htmlRow = "<tr>";
                        htmlRow = htmlRow + "<td><div style='position: relative;'><button class='btn btn-default dropdown-toggle' style='align:right' type='button' data-toggle='dropdown'><i class='fa fa-ellipsis-h' aria-hidden='true'></i></button>";
                        htmlRow = htmlRow + "<ul style='position: relative;' class='dropdown-menu'>";
                        //htmlRow = htmlRow + "<li><a href=''  onclick='ddlActionChange('Edit',"+myArr[i].Trans_Id+");return false;' ><i class='fa fa-pencil'></i>Edit</a></li>";
                        htmlRow = htmlRow + '<li><a href=""  onclick="ddlActionChange( \'Edit\', \'' + myArr[i].Trans_Id + '\');return false;" ><i class="fa fa-pencil"></i>Edit</a></li>';
                        htmlRow = htmlRow + '<li><a href=""  onclick="ddlActionChange( \'View\', \'' + myArr[i].Trans_Id + '\');return false;" ><i class="fa fa-eye"></i>View</a></li>';

                       // htmlRow = htmlRow + "<li><a href=''  onclick='EditInvoice(" + myArr[i].Trans_Id + ");return false;' ><i class='fa fa-eye'></i>View</a></li>";
                        htmlRow = htmlRow + "<li><a href=''  onclick='PrintInvoice(" + myArr[i].Trans_Id + ");return false;' ><i class='fa fa-print'></i>Print</a></li>";
                        //htmlRow = htmlRow + "<li><a href=''  onclick='DeleteInvoice(" + myArr[i].Trans_Id + "," + myArr[i].Field4 + ");return false;' ><i class='fa fa-trash'></i>Delete</a></li>";
                        // htmlRow = htmlRow + '<li><a href=""  onclick="DeleteInvoice(" + myArr[i].Trans_Id + "," + myArr[i].Field4 + ");return false;" ><i class="fa fa-trash"></i>Delete</a></li>';
                        htmlRow = htmlRow + '<li><a href="#" onclick="DeleteInvoice(\'' + myArr[i].Trans_Id + '\', \'' + myArr[i].Field4 + '\'); return false;"><i class="fa fa-trash"></i>Delete</a></li>';
                        htmlRow = htmlRow + "<li><a href='' onclick='getReportData(" + myArr[i].Trans_Id + ");return false;'><i class='fa fa-file'></i>Report System</a></li>";
                        ...
                        htmlRow = htmlRow + "<td>" + myArr[i].Invoice_No + "</td>";
                        htmlRow = htmlRow + "<td>" +formatDate(myArr[i].Invoice_Date) + "</td>";
                        htmlRow = htmlRow + "<td>" + myArr[i].Transtype + "</td>";
                        htmlRow = htmlRow + "<td>" + myArr[i].OrderList + "</td>";
                        htmlRow = htmlRow + "<td>" + myArr[i].EmployeeName + "</td>";
                        htmlRow = htmlRow + "<td>" + myArr[i].CustomerName + "</td>";
                        htmlRow = htmlRow + "<td>" + myArr[i].ref_order_number + "</td>";
                        htmlRow = htmlRow + "<td>" + myArr[i].Field4 + "</td>";
                        htmlRow = htmlRow + "<td>" + myArr[i].InvoiceCreatedBy + "</td>";
                        htmlRow = htmlRow + "<td>" + GetAmountWithDecimal(myArr[i].GrandTotal, decimalCount) + "</td>";
                        htmlRow = htmlRow + "<td>" + GetAmountWithDecimal(myArr[i].LocalGrandTotal, decimalCount) + "</td>";
                        htmlRow = htmlRow + "</tr>";
                        //$('#tblQutList > tbody:last-child').append(htmlRow);
                        table.row.add($(htmlRow)).draw();
                        TotalAmount+= myArr[i].LocalGrandTotal;
                    }
                    debugger;
                    $('#<%=lblTotalAmount_List.ClientID%>').text("Total Amount ="+TotalAmount+"");
                    $('#GvSalesInvoice').DataTable();
                    // Remove the class "sorting_1" from all elements
        ...
        function ddlPosted_SelectedIndexChanged() {
            ...
            function getDocumentNo()
            {
                ...
                $.ajax({
                    type: "POST",
                    async: false,
                    url: "SalesInvoice2.aspx/getDocumentNumber",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function(data) {
        ...
        function saveInvoice()
        {
            ...
            $("#btnSaveUsingAjax").prop("disabled", true);
            //check customer exist or not
            var customerId = setCustomerId();
            if (customerId == "") {
                alert("Please select customer name");
                $("#prgBar").css("display","none");
                $("#btnSaveUsingAjax").prop("disabled", false);
                return;
            }
            ...
            if (objSalesInvoice.discountPer == "") {
                objSalesInvoice.discountPer = "0";
            }
            if (objSalesInvoice.discountAmount == "") {
                objSalesInvoice.discountAmount = "0";
            }
            if('<%= hdnIsTaxEnabled.Value%>'=="true")
            {
            ...
            if($('#<%= txtInvoiceTo.ClientID %>').val()==""){
                alert('Please add invoice address');
                $("#btnSaveUsingAjax").prop("disabled", false);
                $("#prgBar").css("display","none");
                return;
            }
            ...
            $.ajax({
                url: 'SalesInvoice2.aspx/updateInvoice',
                method: 'post',
                contentType: "application/json;",
                ...
                success: function (data) {
                    var response = data.d;                  
                    alert(response[1]); 
                    //if(response[1]==="Account Detail not exist for this customer, Pleae first create Account")
                    //{
                    //    getUsbrousher();                       
                    //}
        ...
        function getUsbrousher(){
            debugger;
            var custm= $('#<%= txtCustomer.ClientID %>').val();
            if(custm!=""){
                $.ajax({
                    url: 'SalesInvoice2.aspx/getUsbrousher',
                    method: 'post',
                    contentType: "application/json;",
                    data: "{CustomerName:" +custm + "}",
                    dataType:'json',
                    async:false,
                    success: function (data) {
        ...
        function setDllActionOptions()
        {
            ...
            var ddlPosted_ = document.getElementById('<%= ddlPosted.ClientID%>');
               ...
               // $('#< %= ddlAction.ClientID %>').empty();
                ...
                function ddlActionChange(ctrl,transId)
                {
                    debugger;
           ...
           PageMethods.getInvoice
                           (transId,ctrl,"",function(data){
        ...
        function setPaymentTable(row) {
            ...
            htmlRow = htmlRow + "<td>" + row.foreignAmount + "</td>";
            htmlRow = htmlRow + "<td>" + row.exchangeRate + "</td>";
            htmlRow = htmlRow + "<td>" + row.localAmount + "</td>";
            htmlRow = htmlRow + "</tr>";
            $('#tblPayment > tbody:last-child').append(htmlRow);
        ...
        function GetGeoLocation() {
            if ($('#<%= txtShipingAddress.ClientID %>').val() == "") {
                ...
                $.ajax({
                    url: 'SalesInvoice2.aspx/GetGeoLocation',
                    method: 'post',
                    contentType: 'application/json',
