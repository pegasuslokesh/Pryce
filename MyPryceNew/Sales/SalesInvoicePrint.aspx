<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesInvoicePrint.aspx.cs"
    Inherits="Sales_SalesInvoicePrint" %>
            ...
            <table width="70%" cellpadding="0" cellspacing="0">
                <tr style="background-color: #90BDE9">
                    ...
                    <td style="padding-left: 5px" align="left">
                        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Sales Invoice %>"
                        ...
                        <table width="100%">
                            <tr>
                                <td align="left" colspan="6">
                                   <%-- <dx:ReportToolbar ID="rptToolBar" runat="server" ShowDefaultButtons="False" 
                                        Width="93%" AccessibilityCompliant="false">
                                        <Items>
                                      ...
                                      <dx:ASPxWebDocumentViewer ID="rptViewer" runat="server" Width="100%"></dx:ASPxWebDocumentViewer>
