...
public partial class Sales_SalesInquiryPrint : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("../EmailSystem/ContactMailReference.aspx?Page=SINQ&&Url=" + ViewState["Path"].ToString() + "&&Id=" + ViewState["Id"].ToString() + "&&ConId=" + ViewState["CustId"].ToString() + "&&ProductId=" + ViewState["ProductId"].ToString() + "&&PageRefType=SINQ&&PageRefId=" + ViewState["Id"].ToString());
