<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesQuotationPrint.aspx.cs"
    Inherits="Sales_SalesQuotationPrint" %>
            ...
            <table width="70%" cellpadding="0" cellspacing="0">
                <tr style="background-color: #90BDE9">
                    ...
                    <td style="padding-left: 5px" align="left">
                        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Sales Quotation %>"
                            ...
                            <tr>
                                <td align="left" colspan="6">
                                    <dx:ReportToolbar ID="rptToolBar" runat="server" ShowDefaultButtons="False" ReportViewer="<%# rptViewer %>"
                                        Width="92%" AccessibilityCompliant="True">
                                        <Items>
