<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinalSalaryStatement.aspx.cs" Inherits="HR_Report_FinalSalaryStatement" %>
...
<head id="Head1" runat="server">
    <title>Summary Salary Statement Print</title>
                        ...
                        <table width="70%" cellpadding="0" cellspacing="0">
                            <tr style="background-color: #90BDE9">
                                ...
                                <td style="padding-left: 5px" align="left">
                                    <asp:Label ID="lblHeader" runat="server" Text="Summary Salary Statement"
                                        CssClass="LableHeaderTitle"></asp:Label>
                                </td>
                                <td align="right" style="padding-right: 10px">
                                    <asp:Button ID="btnSend" runat="server" Text="Send" Visible="false" CssClass="buttonCommman" />
                                </td>
                            </tr>
