<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Projected_Salary_Transfer_Report.aspx.cs" Inherits="HR_Report_Hr_Employee_Pay_Slip" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Projected Salary Transfer Report%>"></asp:Label>
                </span>
            </a>
            ...
            <section class="content">
                <div class="box box-primary" style="text-align: center">
                    <div class="box-header with-border">
                        <h3 class="box-title">Projected Salary Transfer Report</h3>
                            ...
                            <div class="col-md-12" style="margin-top:15px; margin-bottom:15px;">
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <asp:DropDownList ID="Ddl_Post" AutoPostBack="true" OnSelectedIndexChanged="Ddl_Post_SelectedIndexChanged" CssClass="form-control" runat="server">
                                            <asp:ListItem Text="Before Post" Selected="True"></asp:ListItem>
                                            <asp:ListItem Text="After Post"></asp:ListItem>
                                        </asp:DropDownList>
                                        <div class="input-group-addon">                                            
                                            <asp:Label ID="Label1" Width="100%" runat="server" Text=": Filter By Post"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">                                    
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <asp:DropDownList ID="DDl_Filter" AutoPostBack="true" OnSelectedIndexChanged="DDl_Filter_SelectedIndexChanged" CssClass="form-control" runat="server">
                                            <%--<asp:ListItem Text="--By All--" Selected="True"></asp:ListItem>
                                            <asp:ListItem Text="By Device"></asp:ListItem>
                                            <asp:ListItem Text="By Manual"></asp:ListItem>--%>
                                        </asp:DropDownList>
                                        <div class="input-group-addon">                                            
                                            <asp:Label ID="Lbl_Filter" Width="100%" runat="server" Text=": Filter By Type"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                </div>
