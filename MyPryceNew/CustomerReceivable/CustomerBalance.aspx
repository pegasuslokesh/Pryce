<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="CustomerBalance.aspx.cs" Inherits="CustomerReceivable_CustomerBalance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Customer Balance%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Customer Balance %>"></asp:Label></li>
    </ol>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <asp:UpdatePanel ID="pnlGetData" runat="server">
                                    <ContentTemplate>
                                        <div class="col-md-12" style="text-align: center">
                                            ...
                                            <asp:Button ID="btnRepotwithSales" ValidationGroup="Save" runat="server" Text="<%$ Resources:Attendance,With Sales Person %>"
                                                CssClass="btn btn-primary" Visible="false" OnClick="btnRepotWithSales_Click" />
                                ...
                                <div class="col-md-12" runat="server" id="scrollArea" onscroll="SetDivPosition()" style="overflow: auto; max-height: 500px;">
                                    <br />
                                    <asp:HiddenField ID="hdnFollowupTableName" runat="server" Value="CustomerBalance" />
                                    <asp:HiddenField ID="hfScrollPosition" runat="server" Value="0" />
                                    <asp:UpdatePanel runat="server" ID="upInvoiceStatement">
                                        <ContentTemplate>
                                            <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GVAllCustomer" Width="100%" runat="server" ShowFooter="true" AutoGenerateColumns="false"
                                                AllowSorting="true" OnSorting="GVAllCustomer_Sorting">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance,Customer %>" SortExpression="Name">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkgvSupplier" runat="server" Text='<%# Eval("Name") %>' OnClick="lnkgvCustomer_Click" ToolTip="Contact Information"
                                                                Font-Bold="true" CommandArgument='<%#Eval("Customer_Id")%>' OnClientClick="SetSelectedRow(this)" />
                                                            <asp:Label ID="lblCustomerId" Visible="false" runat="server" Text='<%#Eval("Customer_Id")%>' />
                                                            <asp:Label ID="lblOtherAccountId" Visible="false" runat="server" Text='<%#Eval("OtherAccountId")%>' />
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance,Follow-Up%>">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btnFolloup" runat="server" ImageUrl="~/Images/follow-up.png" ToolTip="Follow-up"
                                                                CausesValidation="False" OnCommand="btnFolloup_Command" Width="20px" Height="20px" CommandArgument='<%# Eval("Customer_Id") %>' OnClientClick="SetSelectedRow(this)" />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" Width="3%" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Finance Person" SortExpression="Finance_Person">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblFinancePerson" runat="server" Text='<%# Eval("Finance_Person") %>' />
                                                            <asp:Label ID="lblFinancePersonEmail" Visible="false" runat="server" Text='<%# getFinancePersonEmail(Eval("Finance_Person").ToString()) %>' />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance, Opening Balance %>" SortExpression="Opening_Balance">
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:Label ID="lblOpeningTotal" runat="server" />
                                                        </FooterTemplate>
                                                        <FooterStyle HorizontalAlign="Right" />
                                                    ...
                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance, Balance%>" SortExpression="Closing_Balance">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkClosingBalance" runat="server" Text='<%#Eval("Closing_final") %>' OnClick="lnkClosingBalance_Click"
                                                                Font-Bold="true" CommandArgument='<%#Eval("OtherAccountId")%>' ToolTip="Customer Account Statement" OnClientClick="SetSelectedRow(this)" />

                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:Label ID="lblbalanceTotal" runat="server" />
                                                        </FooterTemplate>
                                                        <FooterStyle HorizontalAlign="Right" />
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance, Ageing Balance%>" SortExpression="AgeingBalance">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkInvoiceStatement" runat="server" Text='<%#Eval("AgeingBalance_final") %>' OnClick="lnkInvoiceStatement_Click"
                                                                Font-Bold="true" CommandArgument='<%# Eval("OtherAccountId").ToString() + "," + Eval("Currency_Id").ToString() %>' ToolTip="Customer Invoice Statement" OnClientClick="SetSelectedRow(this)" />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Credit Days" SortExpression="Credit_days">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCreditDays" runat="server" Text='<%#Eval("credit_days") %>' />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="left" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Over Dues" SortExpression="Start30">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkDueBalance" runat="server" Text='<%#Eval("Start30") %>' OnClick="lnkInvoiceStatement_Click"
                                                                Font-Bold="true" CommandArgument='<%# Eval("OtherAccountId").ToString() + "," + Eval("Currency_Id").ToString() %>' ToolTip="Customer Invoice Statement" OnClientClick="SetSelectedRow(this)" />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
    ...
    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="upInvoiceStatement">
        <ProgressTemplate>
            <div class="modal_Progress">
                <div class="center_Progress">
                    <img alt="" src="../Images/ajax-loader2.gif" style="vertical-align: middle; background-color: White; border-radius: 10px;" />
    ...
    <asp:UpdateProgress ID="UpdateProgressGetData" runat="server" AssociatedUpdatePanelID="pnlGetData">
        <ProgressTemplate>
            <div class="modal_Progress">
                <div class="center_Progress">
                    <img alt="" src="../Images/ajax-loader2.gif" style="vertical-align: middle; background-color: White; border-radius: 10px;" />
    ...
    <div class="modal fade" id="modelEmail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <asp:Label ID="lblEmailTitle" runat="server" Text="List of customer which selected to send email" Font-Bold="true"></asp:Label></h4>
                </div>
                <div class="modal-body">
                    <asp:UpdatePanel ID="updPnlSelectedEmail" runat="server">
                        <ContentTemplate>


                            <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvSelectedEmailList" Width="100%" runat="server" ShowFooter="true" AutoGenerateColumns="false">

                                <Columns>
                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance,Customer %>">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSelCustomerId" Visible="false" runat="server" Text='<%#Eval("customer_id")%>' />
                                            <asp:Label ID="lblSelCustomer" Visible="true" runat="server" Text='<%#Eval("customer_name")%>' />
                                            <asp:Label ID="lblOtherAccountId" Visible="false" runat="server" Text='<%#Eval("other_account_id")%>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance, Ageing Balance%>">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAgeBalance" runat="server" Text='<%#Eval("ageing_balance")%>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:TemplateField>
                                </Columns>
                            ...
                            <div class="modal-footer">
                                <button type="button" id="" class="btn btn-danger" data-dismiss="modal">
                                    Close</button>
                                <asp:Button ID="btnSendEmailFinal" Text="Send Email" CssClass="btn btn-danger" OnClick="btnSendEmailFinal_Click" runat="server" />
                                <cc1:ConfirmButtonExtender ID="confirm2" runat="server" ConfirmText="Are you sure you want to send an email of Account statement to the customer ?"
                                    TargetControlID="btnSendEmailFinal">
...
<asp:Content ID="Content5" ContentPlaceHolderID="AfterLoadScriptContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Modal_Email_Open() {
            $('#modelEmail').modal('show');
        }
        function Modal_Email_Close() {
        ...
        //$('#Followup').on('hidden.bs.modal', function () {
        //    setScrollAndRow();
        //});
        ...
        function setScrollAndRow() {
            try {
                ...
                //if (isNaN(rowIndex)) {
                var parent = document.getElementById('<%= GVAllCustomer.ClientID %>');
