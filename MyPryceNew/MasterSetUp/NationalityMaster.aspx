<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="NationalityMaster.aspx.cs" Inherits="MasterSetUp_NationalityMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Nationality Setup%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Nationality Setup%>"></asp:Label></li>
    </ol>
</asp:Content>
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:Label ID="lblNationalityName" runat="server" Text="<%$ Resources:Attendance,Nationality Name%>"></asp:Label>
                                                        <a style="color: Red">*</a>
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator3" ValidationGroup="Save"
                                                            Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtNationalityName" ErrorMessage="<%$ Resources:Attendance,Enter Nationality Name %>"></asp:RequiredFieldValidator>

                                                        <asp:TextBox ID="txtNationalityName" runat="server" AutoPostBack="true" OnTextChanged="txtNationalityName_TextChanged" BackColor="#eeeeee" CssClass="form-control" />
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:Label ID="lblNationalityNameL" runat="server" Text="<%$ Resources:Attendance,Nationality Name(Local)%>"></asp:Label>
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="col-lg-3">
                                                    <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="form-control">
                                                        <asp:ListItem Text="<%$ Resources:Attendance, Nationality Name %>" Value="Nationality" />
                                                        <asp:ListItem Text="<%$ Resources:Attendance, Nationality Name(Local) %>" Value="Nationality_L" />
                                                        <asp:ListItem Text="<%$ Resources:Attendance,Nationality Id %>" Value="Nationality_Id"></asp:ListItem>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="flow">
                                                    ...
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvNationality" PageSize="<%# PageControlCommon.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                                    ...
                                                                    <div class="dropdown" style="position: absolute;">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            ...
                                                                            <li <%= hdnCanEdit.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                                <asp:LinkButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Nationality_Id") %>' OnCommand="btnEdit_Command" CausesValidation="False" ToolTip="<%$ Resources:Attendance,Edit %>"><i class="fa fa-pencil"></i><%# Resources.Attendance.Edit%> </asp:LinkButton>
                                                                            </li>
                                                                            <li <%= hdnCanDelete.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                                <asp:LinkButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Nationality_ID") %>' OnCommand="IbtnDelete_Command" ToolTip="<%$ Resources:Attendance,Delete %>"><i class="fa fa-trash"></i><%# Resources.Attendance.Delete%></asp:LinkButton>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Nationality Id %>" SortExpression="Nationality_Id">
                                                                <ItemTemplate>

                                                                    <asp:Label ID="lblDesigId1" runat="server" Text='<%# Eval("Nationality_Id") %>'></asp:Label>


                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:BoundField DataField="Nationality" HeaderText="<%$ Resources:Attendance,Nationality Name %>"
                                                                SortExpression="Nationality" />
                                                            <asp:BoundField DataField="Nationality_L" HeaderText="<%$ Resources:Attendance,Nationality Name(Local) %>"
                                                                SortExpression="Nationality_L" />
                                ...
                                <div class="box box-warning box-solid">
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="flow">
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvNationalityBin" DataKeyNames="Nationality_Id" PageSize="<%# PageControlCommon.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Nationality Name %>" SortExpression="Nationality">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvNationalityName" runat="server" Text='<%# Eval("Nationality") %>'></asp:Label>
                                                                    <asp:Label ID="lblNationalityId" Visible="false" runat="server" Text='<%# Eval("Nationality_Id") %>'></asp:Label>


                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Nationality Name(Local) %>" SortExpression="Nationality_L">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvNationalityNameL" runat="server" Text='<%# Eval("Nationality_L") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
