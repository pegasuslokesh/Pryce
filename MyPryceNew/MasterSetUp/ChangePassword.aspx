<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="MasterSetUp_ChangePassword" %>
...
<head>
    ...
    <title>Pryce | Change Password</title>
                ...
                <form id="Login_Form" runat="server">
                    ...
                    <asp:UpdatePanel ID="Login_Update" runat="server">
                        <Triggers>
                            ...
                            <asp:PostBackTrigger ControlID="lnkDashboard" />
                        </Triggers>
                        <ContentTemplate>
                            ...
                            <br />
                             <div class="col-md-12" style="padding-top:10px;">
                                 <center>
                                      <asp:Button ID="lnkDashboard" runat="server" OnClick="lnkDashboard_Click" CssClass="btn btn-primary btn-block btn-flat" Text="Go To Dashboard" style="background-color: rgba(48, 46, 45, 1);    color: white;" />
