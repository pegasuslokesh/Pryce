<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="AddressCategory.aspx.cs" Inherits="MasterSetUp_AddressCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Address Category Setup%>"></asp:Label>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Address Category%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Lbl_name" runat="server" Text="<%$ Resources:Attendance,Address Name%>"></asp:Label>
                                                        <a style="color: Red">*</a>
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator3" ValidationGroup="Save"
                                                            Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtAddressName" ErrorMessage="<%$ Resources:Attendance,Enter Address Name %>"></asp:RequiredFieldValidator>

                                                        <asp:TextBox ID="txtAddressName" runat="server" AutoPostBack="true" OnTextChanged="txtAddressName_TextChanged" BackColor="#eeeeee" CssClass="form-control" />
                                                        <cc1:AutoCompleteExtender ID="txtAddressName_AutoCompleteExtender" runat="server"
                                                            DelimiterCharacters="" Enabled="True" ServiceMethod="GetCompletionList" ServicePath=""
                                                            CompletionInterval="100" MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtAddressName"
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:Attendance,Address Name(Local)%>"></asp:Label>
                                                        <asp:TextBox ID="txtAddressNameL" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <br />
                                                    </div>
                                                    <div class="col-md-12" style="text-align: center">

                                                        <asp:Button ID="btnCSave" runat="server" ValidationGroup="Save" Text="<%$ Resources:Attendance,Save %>" Visible="false" CssClass="btn btn-success" OnClick="btnCSave_Click" />
					...
					<asp:Label ID="lblTotalRecords" Font-Bold="true" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="col-lg-3">
                                                    <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="form-control">
                                                        <asp:ListItem Selected="True" Text="<%$ Resources:Attendance,Address Category Id%>" Value="Address_Category_ID"></asp:ListItem>
                                                        <asp:ListItem Text="<%$ Resources:Attendance,Address Name %>" Value="Address_Name"></asp:ListItem>
                                ...
                                <div class="box box-warning box-solid" <%= GvAddressCategory.Rows.Count>0?"style='display:block'":"style='display:none'"%>>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="flow">
                                                    ...
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvAddressCategory" PageSize="<%# PageControlCommon.GetPageSize() %>"
                                                        runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True" OnPageIndexChanging="GvAddressCategory_PageIndexChanging"
                                                        AllowSorting="True" OnSorting="GvAddressCategory_Sorting">
                                                        ...
                                                        <Columns>
                                                                    ...
                                                                    <div class="dropdown" style="position: absolute;">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            ...
                                                                            <li <%= hdnCanEdit.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                                <asp:LinkButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Address_Category_ID") %>'
                                                                            ...
                                                                            <li <%= hdnCanDelete.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                                <asp:LinkButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Address_Category_ID") %>'
                                                            ...
                                                            <asp:BoundField DataField="Address_Category_ID" HeaderText="<%$ Resources:Attendance,Address Category Id %>"
                                                                SortExpression="Address_Category_ID" />
                                                            <asp:BoundField DataField="Address_Name" HeaderText="<%$ Resources:Attendance,Address Name %>"
                                                                SortExpression="Address_Name" />
                                                            <asp:BoundField DataField="Address_Name_L" HeaderText="<%$ Resources:Attendance,Address Name(Local) %>"
                                                                SortExpression="Address_Name_L" />
                    ...
                    <div class="tab-pane" id="Bin">
					   ...
					   <asp:Label ID="lblTotalRecordsBin" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                            ...
                                            <div class="box-body">
                                                <div class="col-lg-3">
                                                    <asp:DropDownList ID="ddlFieldNameBin" runat="server" CssClass="form-control">
                                                        <asp:ListItem Text="<%$ Resources:Attendance, Address Category Id %>" Value="Address_Category_ID" />
                                ...
                                <div class="box box-warning box-solid" <%= GvAddressCategoryBin.Rows.Count>0?"style='display:block'":"style='display:none'"%> >
                                   
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="flow">
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvAddressCategoryBin" PageSize="<%# PageControlCommon.GetPageSize() %>"
                                                        runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True" OnPageIndexChanging="GvAddressCategoryBin_PageIndexChanging"
                                                        OnSorting="GvAddressCategoryBin_OnSorting" AllowSorting="true"
                                                        DataKeyNames="Address_Category_ID">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Address Category Id%>" SortExpression="Address_Category_ID">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvAddressCategoryId" runat="server" Text='<%# Eval("Address_Category_ID") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Address Name %>" SortExpression="Address_Name">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvAddressName" runat="server" Text='<%# Eval("Address_Name") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Address Name(Local) %>" SortExpression="Address_Name_L">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvAddressNameL" runat="server" Text='<%#Eval("Address_Name_L") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle />
                                                            </asp:TemplateField>
