<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="StateMaster.aspx.cs" Inherits="MasterSetUp_StateMaster" %>
...
<i class="far fa-flag"></i>&nbsp;&nbsp;
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,State Master%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>
            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:Attendance,Master Setup%>"></asp:Label></a></li>
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,State Master%>"></asp:Label></li>
    </ol>
</asp:Content>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                                ...
                                <div class="box box-warning box-solid">
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <asp:Label ID="lblStateNameLocal" runat="server" Text="<%$ Resources:Attendance,State Name Local%>"></asp:Label>
                                                <asp:TextBox runat="server" ID="txtStateNameLocal" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="flow">
                                                    ...
                                                    <dx:ASPxGridView ID="GvStateMaster" Width="100%" EnableViewState="false" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False" KeyFieldName="Trans_Id">
                                                        <Columns>


                                                            <dx:GridViewDataColumn VisibleIndex="3" Visible="false">
                                                                <DataItemTemplate>
                                                                    <a title="Edit" onclick="btnEditClick('<%# Eval("Trans_Id") %>');" style="cursor: pointer"><i class="fa fa-pencil" style="font-size: 15px"></i></a>
                                                                </DataItemTemplate>
                                                            ...
                                                            <dx:GridViewDataTextColumn FieldName="State_Name_Local" Settings-AutoFilterCondition="Contains" Caption="<%$ Resources:Attendance,State Name Local%>" VisibleIndex="13">
                                                            </dx:GridViewDataTextColumn>
					...
					<asp:Label ID="lblTotalRecordsBin" Font-Bold="true" runat="server" Text="<%$ Resources:Attendance,Total Records: 0 %>"></asp:Label>
                                            ...
                                            <div class="box-body">
                                                <div class="col-lg-3">
                                                    <asp:DropDownList ID="ddlFieldNameBin" runat="server" CssClass="form-control">
                                                        ...
                                                        <asp:ListItem Text="<%$ Resources:Attendance,State Name Local%>" Value="State_Name_Local"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-lg-2">
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <asp:LinkButton ID="imgBtnRestore" CausesValidation="False"  runat="server" OnClick="imgBtnRestore_Click" Visible="false" ToolTip="<%$ Resources:Attendance, Active %>" ><span class="far fa-lightbulb"  style="font-size:25px;"></span></asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                                </div>
                                ...
                                <div class="box box-warning box-solid" <%= gvStateMasterBin.Rows.Count>0?"style='display:block'":"style='display:none'"%>>
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="flow">
                                                    <asp:Label ID="lblSelectedRecord" runat="server" Visible="false"></asp:Label>
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" runat="server" ID="gvStateMasterBin" AutoGenerateColumns="false" Width="100%" AllowPaging="True" OnPageIndexChanging="gvStateMasterBin_PageIndexChanging" AllowSorting="True" OnSorting="gvStateMasterBin_Sorting">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,State Name Local%>" SortExpression="State_Name_Local">
                                                                <ItemTemplate>
                                                                    <asp:Label runat="server" ID="gvlblStateNameLocal" Text='<%# Eval("State_Name_Local") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
...
<asp:Content ID="Content5" ContentPlaceHolderID="AfterLoadScriptContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SaveResetBtnVisibleOrNot(id) {

            if (id == "ViewBtn") {
                document.getElementById('<%= btnSave.ClientID %>').Visible = "False";
                document.getElementById('<%= btnReset.ClientID %>').Visible = "False";
            }
            if (id == "EditBtn") {
                document.getElementById('<%= btnSave.ClientID %>').Visible = "True";
                document.getElementById('<%= btnReset.ClientID %>').Visible = "True";
            }

        }
        function btnEditClick(TransId) {
            PageMethods.GetAllStateByTrans_Id(TransId, onSuccessCallBack, onFailCallBack);
        }

        function onSuccessCallBack(result) {
            document.getElementById('<%= ddlCountry.ClientID %>').value = result["Country_Id"];
            document.getElementById('<%= txtStateName.ClientID %>').value = result["State_Name"];
            document.getElementById('<%= txtStateNameLocal.ClientID %>').value = result["State_Name_Local"];
        ...
        function btnCancelClick() {
            ...
            document.getElementById('<%= txtStateNameLocal.ClientID %>').value = "";
