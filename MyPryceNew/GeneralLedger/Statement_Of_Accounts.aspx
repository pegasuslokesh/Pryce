<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="Statement_Of_Accounts.aspx.cs" Inherits="GeneralLedger_Statement_Of_Accounts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Statement of Finance%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Statement of Finance%>"></asp:Label></li>
    </ol>
</asp:Content>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <asp:TextBox ID="txtAccountName" AutoPostBack="true" OnTextChanged="txtAccountName_textChangedCost" runat="server" CssClass="form-control" BackColor="#eeeeee" />
                                ...
                                <div class="col-md-12">
                                    <div id="pnlCostCenter" runat="server" visible="false" >
                                        <asp:Label ID="Label8" runat="server" Text="Child Cost Center Name :" />
                                        <asp:CheckBoxList ID="ChkChildList" RepeatDirection="Vertical" runat="server"
                                            Font-Names="Trebuchet MS"
                                            Font-Size="Small" RepeatLayout="Table" CssClass="checkboxlist" ForeColor="Gray" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <asp:Label ID="lblOpeningCreditBalance" Visible="false" runat="server"
                                        Text="<%$ Resources:Attendance,Opening Credit Balance %>" />
                                    <asp:Label ID="lblOpeningDebitBalance" Visible="false" runat="server"
                                        Text="<%$ Resources:Attendance,Opening Debit Balance %>" />

                                    <asp:Label ID="lblMid" runat="server" Text=":" Visible="false" />

                                    <asp:TextBox ID="txtOpenCreditBalance" Visible="false" ReadOnly="true"
                                        runat="server" CssClass="form-control" />
                                    <asp:TextBox ID="txtOpenDebitBalance" Visible="false" ReadOnly="true"
                                        runat="server" CssClass="form-control" />
                                ...
                                <div class="col-md-6">
                                    <asp:Label ID="lblCreditBalanceAmount" runat="server" Text="<%$ Resources:Attendance,Closing Balance%>" />
                                    <asp:TextBox ID="txtCreditBalanceAmount" ReadOnly="true" runat="server"
                                        CssClass="form-control" />
                                    <br />
                                </div>
                            </div>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance, Cost Center %>" Visible="false">
                                                                                    <ItemTemplate>
                                                                                      <%--  <asp:Label ID="lblgvCostCenter" runat="server" Text='<%#Eval("CostCenter_ID") %>' />--%>
                                                                                        <asp:Label ID="Label9" runat="server" Text='<%#Eval("CostCenter") %>' />
                                                                                    </ItemTemplate>
                                                                                    <ItemStyle  HorizontalAlign="Center" />
                                                                                </asp:TemplateField>
