<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="ProfitAndLoss.aspx.cs" Inherits="GeneralLedger_ProfitAndLoss" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Profit & Loss%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Profit And Loss%>"></asp:Label></li>
    </ol>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="Update_New" runat="server">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div id="div_from_date" runat="server" visible="false" class="col-md-6">
                                    <asp:Label ID="lblFromDate" Visible="false" runat="server"
        ...
        Display="Dynamic" SetFocusOnError="true" controltovalidate="txtFromDate" errormessage="<%$ Resources:Attendance,Enter From Date%>"></asp:RequiredFieldValidator>
                                    ...
                                    <asp:TextBox ID="txtFromDate" Visible="false" runat="server" CssClass="form-control" />
        ...
        Display="Dynamic" SetFocusOnError="true" controltovalidate="txtToDate" errormessage="<%$ Resources:Attendance,Enter To Date%>"></asp:RequiredFieldValidator>
                                ...
                                <div id="td" runat="server" visible="false" class="col-md-6">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="gvIncome" Width="100%" runat="server" ShowFooter="true" AutoGenerateColumns="false"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance, INCOME %>">
                                                                                <ItemTemplate>
