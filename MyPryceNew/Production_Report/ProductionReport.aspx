<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductionReport.aspx.cs" Inherits="Production_Report_ProductionReport" %>
            ...
            <table width="70%" cellpadding="0" cellspacing="0">
                <tr style="background-color: #90BDE9">
                    ...
                    <td style="padding-left: 5px" align="left">
                        <asp:Label ID="lblHeader" runat="server" Text="Production Report"
                            CssClass="LableHeaderTitle"></asp:Label>
                    </td>
                    <td align="right" style="padding-right: 10px">
                        <asp:Button ID="btnSend" runat="server" Text="Send"  CssClass="buttonCommman" Visible="false"  OnClick="btnSend_Click" />
                    </td>
                </tr>
