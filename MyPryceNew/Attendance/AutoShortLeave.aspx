<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="AutoShortLeave.aspx.cs" Inherits="Attendance_AutoShortLeave" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    ...
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Auto Short Leave%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn" style="margin-top: 5px;">
                                            <asp:Button ID="btnfilterdepartment" runat="server" CssClass="btn btn-info" OnClick="btnfilterdepartment_Click" Text="<%$ Resources:Attendance,Location%>" />
                                ...
                                <div class="col-md-6" style="text-align: center;">
                                    ...
                                    <asp:Button ID="btnGo" runat="server" CssClass="btn btn-primary" OnClick="btnGo_Click"
                                        Text="<%$ Resources:Attendance,Generate Short Leave%>" />
                                    ...
                                    <cc1:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" TargetControlID="btnDelete"
                                        ConfirmText="<%$ Resources:Attendance,Are you sure you want to delete selected record?%>">
                                    </cc1:ConfirmButtonExtender>


                                    <asp:Button ID="btnServiceShort" runat="server" CssClass="btn btn-primary" OnClick="btnServiceShort_Click"
                                        Text="Generate Pending Short Leave" />
                                </div>
                                <div class="col-md-12" runat="server" style="overflow: auto; max-height: 300px;">
                                    <br />
                                    <asp:GridView ID="gvOverTime" runat="server" Width="100%" AutoGenerateColumns="False">
                                        <Columns>

                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkSelect" runat="server" Enabled='<%# (Eval("Is_Confirmed").ToString().Trim()=="" || Eval("Is_Confirmed").ToString().Trim()=="Canceled") ? true : false %>' />
                                                </ItemTemplate>
                                                <HeaderTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Partial In%>">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblfromTime" runat="server" Text='<%# Eval("From_Time") %>' />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Partial Out%>">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbltoTime" runat="server" Text='<%# Eval("To_Time") %>' />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Is Confirmed">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblisconfirmed" runat="server" Text='<%# Eval("Is_Confirmed") %>' />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
