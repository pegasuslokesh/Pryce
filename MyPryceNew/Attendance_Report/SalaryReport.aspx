<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="SalaryReport.aspx.cs" Inherits="Attendance_Report_SalaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Salary Summary Report %>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Salary Summary Report%>"></asp:Label></li>
    </ol>
</asp:Content>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                <asp:Panel ID="pnlSearchdpl" runat="server">
                                                    ...
                                                    <asp:Button ID="btnLogProc" runat="server" CssClass="btn btn-info" 
