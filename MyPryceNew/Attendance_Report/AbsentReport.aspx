<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AbsentReport.aspx.cs" Inherits="Attendance_Report_AbsentReport" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Absent Report %>"></asp:Label>
                </span>
            </a>
                ...
                <div class="box box-primary" style="text-align:center">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div style="overflow: auto">
                                    <dx:ReportViewer ID="rptViewer" OnCacheReportDocument="DocumentViewer1_CacheReportDocument" OnRestoreReportDocumentFromCache="DocumentViewer1_RestoreReportDocumentFromCache" Width="100%" runat="server">
                                    </dx:ReportViewer>
                                </div>
                            </div>
                        </div>
