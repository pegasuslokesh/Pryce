<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="AccessGroupSummaryDetail.aspx.cs" Inherits="Attendance_Report_AccessGroupSummaryDetail" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Access Group Summary %>"></asp:Label>
                </span>
            </a>
