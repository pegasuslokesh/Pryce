<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogReport.aspx.cs" Inherits="Attendance_Report_LogReportNew" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Log Report %>"></asp:Label>
                </span>
            </a>
            ...
            <section class="content">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title" style="text-align:center">Log Report</h3>
