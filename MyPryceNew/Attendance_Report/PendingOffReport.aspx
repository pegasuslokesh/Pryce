<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PendingOffReport.aspx.cs" Inherits="Attendance_Report_PendingHolidayReport" %>
        ...
        <header class="main-header">
            <a class="logo">
                <span class="logo-lg">
                    ...
                    <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="TSC Pending Off Report"></asp:Label>
                </span>
            </a>
