<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeReport.aspx.cs" Inherits="Attendance_Report_EmployeeReportNew" %>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style="padding-left: 5px">
                                                    <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Employee Information Report %>"
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <td width="50px" align='<%= PageControlCommon.ChangeTDForDefaultLeft()%>'>
                                                                <asp:Label ID="lblFinger" CssClass="labelComman" runat="server" Text="<%$ Resources:Attendance,Finger %>"></asp:Label>
                                                            </td>
                                                            <td align='<%= PageControlCommon.ChangeTDForDefaultLeft()%>' width="1px">:
                                                            </td>
                                                            <td width="50px" align='<%= PageControlCommon.ChangeTDForDefaultLeft()%>'>
                                                                <asp:DropDownList runat="server" CssClass="dropdownsearch" ID="ddlFingerReport" AutoPostBack="True" OnSelectedIndexChanged="ddlReportTrOrFal_SelectedIndexChanged">
                                                            ...
                                                            <td width="50px" align='<%= PageControlCommon.ChangeTDForDefaultLeft()%>'>
                                                                <asp:Label ID="Label1" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Face %>"></asp:Label>
                                                            </td>
                                                            <td align='<%= PageControlCommon.ChangeTDForDefaultLeft()%>' width="1px">:
                                                            </td>
                                                            <td width="50px" align='<%= PageControlCommon.ChangeTDForDefaultLeft()%>'>
                                                                <asp:DropDownList runat="server" CssClass="dropdownsearch" ID="ddlFaceReport" AutoPostBack="True" OnSelectedIndexChanged="ddlFaceReportTrOrFal_SelectedIndexChanged">
                                                                    <asp:ListItem Selected="True" Text="Both" Value="0"></asp:ListItem>
                                                                    <asp:ListItem Text="True" Value="1"></asp:ListItem>
                                                                    <asp:ListItem Text="False" Value="2"></asp:ListItem>
                                                                </asp:DropDownList>
