<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalarySummaryReport.aspx.cs" Inherits="Attendance_Report_SalarySummaryReport" %>
                ...
                <header class="main-header">
                    <a class="logo">
                        <span class="logo-lg">
                            ...
                            <asp:Label ID="Lbl_Page_Name" Style="margin-left: 10px;" runat="server" Text="<%$ Resources:Attendance,Adjustment Report %>"></asp:Label>
                        </span>
                    </a>
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div style="overflow: auto">
                                            <dx:ReportViewer ID="ReportViewer1" OnCacheReportDocument="DocumentViewer1_CacheReportDocument" OnRestoreReportDocumentFromCache="DocumentViewer1_RestoreReportDocumentFromCache" Width="100%" runat="server">
                                            </dx:ReportViewer>
                                        </div>
                                    </div>
                                </div>
