<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="SalesInquiry.aspx.cs" Inherits="Sales_Report_SalesInquiry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Sales Inquiry Report%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Sales Inquiry Report%>"></asp:Label></li>
    </ol>
</asp:Content>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-md-12" style="text-align:center">
                                    ...
                                    <asp:RadioButton style="margin-left:20px; margin-right:20px;" AutoPostBack="true" ID="rbtnFollowupReport"
                                        runat="server" GroupName="a" Text="Follow Up Report"
                                        OnCheckedChanged="rbtnheader_CheckedChanged" />
                                    <br />
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:Attendance,Inquiry No.%>"></asp:Label>
                                    <asp:TextBox ID="txtInquiryNo" BackColor="#eeeeee" runat="server" CssClass="form-control"
                                ...
                                <div class="col-md-6">
                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Attendance,Customer Name %>"></asp:Label>
                                ...
                                <div class="col-md-6">
                                    <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Attendance,Tender No %>"></asp:Label>
                                    <asp:TextBox ID="txtTenderNo" runat="server" CssClass="form-control"></asp:TextBox>
                                    <br />
                                </div>
                                <div class="col-md-6">
                                    <asp:Label ID="Label7" runat="server" Text="<%$ Resources:Attendance,Status %>"></asp:Label>
                                ...
                                <div id="trProduct" class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <asp:CheckBox ID="chkMonthlyReport" runat="server" Text="Monthly Report" />
                                    <br />
                                </div>
                                <div ID="panelFollowupReport" runat="server" Visible="false" class="col-md-12">
                                    <div class="col-md-12">
                                        <br />
                                        <br />
                                    </div>
