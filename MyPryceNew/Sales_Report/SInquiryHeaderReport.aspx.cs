...
{
    SalesInquiryHeader objReport = null;
    SalesInquiryHeaderByCustomer objReportByCustomer = null;
    SalesInquiryHeaderBySalesPerson objReportBySalesPerson = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        objReport = new SalesInquiryHeader(Session["DBConnection"].ToString());
        objReportByCustomer = new SalesInquiryHeaderByCustomer(Session["DBConnection"].ToString());
        objReportBySalesPerson = new SalesInquiryHeaderBySalesPerson(Session["DBConnection"].ToString());
    ...
    void GetReport()
    {
        ...
        if (Session["ReportType"].ToString() == "0")
        {
            ...
            objReport.DataMember = "sp_Inv_SalesInquiryHeader_SelectRow";
        ...
        if (Session["ReportType"].ToString() == "1")
        {
            ...
            objReportByCustomer.DataMember = "sp_Inv_SalesInquiryHeader_SelectRow";
        ...
        if (Session["ReportType"].ToString() == "2")
        {
            ...
            objReportBySalesPerson.DataMember = "sp_Inv_SalesInquiryHeader_SelectRow";
