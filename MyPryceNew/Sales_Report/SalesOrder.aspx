<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="SalesOrder.aspx.cs" Inherits="Sales_Report_SalesOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Sales Order Report %>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Sales Order Report%>"></asp:Label></li>
    </ol>
</asp:Content>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-md-12" style="text-align: center">
                                    ...
                                    <asp:RadioButton GroupName="a" style="margin-left:20px; margin-right:20px;" AutoPostBack="true" ID="RbtnDetail"
                                ...
                                <div class="col-md-6">
                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Attendance,Order Type %>"></asp:Label>
                                    <asp:DropDownList ID="ddlOrderType" runat="server" CssClass="form-control">
                                        <asp:ListItem Text="--Select--"></asp:ListItem>
                                        <asp:ListItem Text="Direct" Value="D"></asp:ListItem>
                                        <asp:ListItem Text="By SalesQuotation" Value="Q"></asp:ListItem>
                                    </asp:DropDownList>
                                    <br />
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <asp:TextBox ID="txtOrderNo" BackColor="#eeeeee" runat="server"
                                        CssClass="form-control" AutoPostBack="True" OnTextChanged="txtOrderNo_TextChanged"></asp:TextBox>
                                ...
                                <div class="col-md-6">
                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:Attendance,Quotation No.%>"></asp:Label>
