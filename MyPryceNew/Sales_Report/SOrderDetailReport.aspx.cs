...
{
    SalesOrderDetailByOrderDate objReport = null;
    SalesOrderDetailByOrderNo objReportByOrderNo = null;
    SalesOrderDetailByCustomer objReportByCustomer = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        objReport = new SalesOrderDetailByOrderDate(Session["DBConnection"].ToString());
        objReportByOrderNo = new SalesOrderDetailByOrderNo(Session["DBConnection"].ToString());
        objReportByCustomer = new SalesOrderDetailByCustomer(Session["DBConnection"].ToString());
    ...
    void GetReport()
    {
        ...
        {
            objReportByOrderNo.setcompanyAddress(CompanyAddress);
            objReportByOrderNo.setcompanyname(CompanyName);
            objReportByOrderNo.setBrandName(BrandName);
            objReportByOrderNo.setLocationName(LocationName);
            objReportByOrderNo.settitle(Session["ReportHeader"].ToString());
            objReportByOrderNo.SetImage(Imageurl);
            objReportByOrderNo.setArabic();
            if (Session["Parameter"] == null)
            {
                objReportByOrderNo.SetDateCriteria("");
            }
            else
            {
                objReportByOrderNo.SetDateCriteria(Session["Parameter"].ToString());
            }
            objReportByOrderNo.setUserName(Session["UserId"].ToString());

            objReportByOrderNo.DataSource = Dt;
            objReportByOrderNo.DataMember = "sp_Inv_SalesOrderDetail_SelectRow_Report";
            rptViewer.Report = objReportByOrderNo;
            objReportByOrderNo.ExportToPdf(Server.MapPath("~/Temp/" + Session["ReportHeader"].ToString() + ".pdf"));
        }
        if (Session["ReportType"].ToString() == "2")
        {
            ...
            objReportByCustomer.DataMember = "sp_Inv_SalesOrderDetail_SelectRow_Report";
