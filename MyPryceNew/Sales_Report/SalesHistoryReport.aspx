<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesHistoryReport.aspx.cs" Inherits="Sales_Report_SalesHistoryReport" %>
...
<head id="Head1" runat="server">
    <title>Sales Manipulation History</title>
            ...
            <table width="70%" cellpadding="0" cellspacing="0">
                <tr style="background-color: #90BDE9">
                    ...
                    <td style="padding-left: 5px" align="left">
                        <asp:Label ID="lblHeader" runat="server" Text="Sales Manipulation History Report"
