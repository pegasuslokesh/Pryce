...
/// </summary>
public class GoodReceivePrint : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public GoodReceivePrint(string strConString)
    {
        InitializeComponent();
    ...
    {
        string resourceFileName = "GoodReceivePrint.resx";
