...
/// </summary>
public class PurchaseRequestPrint : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public PurchaseRequestPrint(string strConString)
    {
        InitializeComponent();
    ...
    {
        string resourceFileName = "PurchaseRequestPrint.resx";
        ...
        this.xrLabel8.LocationFloat = new DevExpress.Utils.PointFloat(496.5699F, 140.2917F);
