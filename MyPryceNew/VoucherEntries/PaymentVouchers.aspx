<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="PaymentVouchers.aspx.cs" Inherits="VoucherEntries_PaymentVouchers" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Cash Or Bank Payment Voucher%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Payment Voucher%>"></asp:Label></li>
    </ol>
</asp:Content>
                                                    ...
                                                    <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvVoucher" PageSize='<%# int.Parse(Session["GridSize"].ToString()) %>' runat="server"
                                                        ...
                                                        <Columns>
                                                                    ...
                                                                    <div class="dropdown" style="position: absolute;">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            ...
                                                                            <li <%= hdnCanUpload.Value=="true"?"style='display:block'":"style='display:none'" %>>
                                                                                <asp:LinkButton ID="IbtnFileUpload" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Trans_Id") %>' CommandName='<%# Eval("Voucher_No") %>'
                                                                                    OnCommand="IbtnFileUpload_Command" ToolTip="File Upload"><i class="fa fa-upload"></i>File Upload</asp:LinkButton>
                                                                            </li>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance, Status %>" SortExpression="Field3">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblStatus" runat="server" Text='<%# CheckStatus(Eval("Field3").ToString()) %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance, Created By %>">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvCreatedBy" runat="server" Text='<%#Eval("CreatedByName") %>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance, Modified By %>">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgvModifiedBy" runat="server" Text='<%#Eval("ModifiedByName")%>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                        </Columns>
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="box box-primary">
                                                                    ...
                                                                    <div class="box-body">
                                                                        <div class="form-group">
                                                                            <div class="col-md-12">
                                                                                <asp:Label ID="lblPaymentTo" runat="server" Text="<%$ Resources:Attendance,Payment To A/C%>" />
                                                                                <a style="color: Red">*</a>
                                                                                <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator1" ValidationGroup="Add"
                                                                                    Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtPaymentTo" ErrorMessage="<%$ Resources:Attendance,Enter Payment To A/C %>"></asp:RequiredFieldValidator>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <asp:Label ID="lblPaidAmount" runat="server" Text="<%$ Resources:Attendance,Paid Amount%>" />
                                                                                <asp:TextBox ID="txtPaidAmount" runat="server" CssClass="form-control" AutoPostBack="True"
                                                                                    OnTextChanged="txtPaidAmount_TextChanged" />
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:Label ID="lblTotalPaidAmount" runat="server" Text="<%$ Resources:Attendance, Total Paid Amount%>" />
                                                        <asp:TextBox ID="txtTotalPaidAmount" runat="server" CssClass="form-control" ReadOnly="true" />
                                                        <br />
                                                    </div>
                                                    <div class="col-md-12">
                                                        <asp:Label ID="lblCashBank" runat="server" Text="<%$ Resources:Attendance,From Cash/Bank%>" />
                                                        <a style="color: Red">*</a>
                                                        <asp:RequiredFieldValidator EnableClientScript="true" Style="float: right;" runat="server" ID="RequiredFieldValidator2" ValidationGroup="Save"
                                                            Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtCashBank" ErrorMessage="<%$ Resources:Attendance,Enter From Cash/Bank %>"></asp:RequiredFieldValidator>
                                                        ...
                                                        <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" DelimiterCharacters=""
                                                            Enabled="True" ServiceMethod="GetCompletionListPaymentAccountName" ServicePath="" CompletionInterval="100"
