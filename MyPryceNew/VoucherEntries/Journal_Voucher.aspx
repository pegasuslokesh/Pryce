<%@ Page Title="" Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="Journal_Voucher.aspx.cs" Inherits="VoucherEntries_Journal_Voucher" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <h1>
        ...
        <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Journal Voucher%>"></asp:Label>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">
            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Attendance,Journal Voucher%>"></asp:Label></li>
    </ol>
</asp:Content>
                                            ...
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <div id="divChequeDetail" style="display: none">
                                                        ...
                                                        <div id="trCheque2" runat="server" class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <asp:TextBox ID="txtAccountName" runat="server" CssClass="form-control" BackColor="#eeeeee"
                                                                                    AutoPostBack="true" OnTextChanged="txtAccountName_textChnaged" />
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <asp:Label ID="lblForeginCurrency" runat="server" Text="<%$ Resources:Attendance,Currency %>" />
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <asp:Label ID="lblPaidForeignamount" runat="server" Text="Foreign Amount" />
                                                                                <asp:TextBox ID="txtPaidForeignamount" runat="server" CssClass="form-control" OnTextChanged="txtPaidForeignamount_OnTextChanged"
                                                                                    AutoPostBack="true" />
                                                                            ...
                                                                            <div class="col-md-12" style="overflow: auto; max-height: 500px;">
                                                                                <asp:GridView CssClass="table-striped table-bordered table table-hover" ID="GvDetail" runat="server" Width="100%" ShowFooter="true"
                                                                            ...
                                                                            <asp:HiddenField ID="hdnRefType" runat="server" Value='<%#Eval("Ref_Type") %>' />--%>
                                                                                ...
                                                                                <asp:HiddenField ID="hdnOtherAccountNo" runat="server" />
                                                                                <br />
                                                                            </div>
...
<asp:Content ID="Content5" ContentPlaceHolderID="AfterLoadScriptContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function PayModeChanged(strPayMode) {
            if (strPayMode == 'Cash') {
                $("#divChequeDetail").hide();
            }
            else {
                $("#divChequeDetail").show();
            }
        }
