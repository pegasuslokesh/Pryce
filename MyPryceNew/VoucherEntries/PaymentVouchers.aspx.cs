...
public partial class VoucherEntries_PaymentVouchers : System.Web.UI.Page
{
    ...
    private const string strPageName = "PaymentVoucher";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            Common.clsPagePermission clsPagePermission = cmn.getPagePermission("../VoucherEntries/PaymentVouchers.aspx", HttpContext.Current.Session["CompId"].ToString(), HttpContext.Current.Session["UserId"].ToString(), HttpContext.Current.Session["Application_Id"].ToString());
    ...
    protected void txtPaymentTo_textChnaged(object sender, EventArgs e)
    {
        if (((TextBox)sender).Text != "")
        {
            ...
            {
                //for Customer, Supplier, Employee and Vehicle Account
    ...
    [System.Web.Services.WebMethodAttribute(), System.Web.Script.Services.ScriptMethodAttribute()]
    public static string[] GetCompletionListPaymentAccountName(string prefixText, int count, string contextKey)
    {
        string sql = string.Empty;
        DataAccessClass daclass = new DataAccessClass(HttpContext.Current.Session["DBConnection"].ToString());
        DataTable dtCOA = new DataTable();
    ...
    public static string[] GetCompletionListEmployee(string prefixText, int count, string contextKey)
    {
        ...
        DataTable dt = ObjEmployeeMaster.GetEmployeeAccount(HttpContext.Current.Session["CompId"].ToString());
        dt = new DataView(dt, "Emp_Name like '%" + prefixText.ToString() + "%'", "Emp_Name Asc", DataViewRowState.CurrentRows).ToTable();
        string[] txt = new string[dt.Rows.Count];
        if (dt.Rows.Count > 0)
        {
            for (int i = 0; i < dt.Rows.Count; i++)
    ...
    {
        if (strEmployeeId.ToUpper() == "SUPERADMIN")
        {
    ...
    private void Set_Notification()
    {
        ...
        string URL = HttpContext.Current.Request.Url.AbsoluteUri.Substring(currentUrl.IndexOf("/voucherentries"));
        ...
        string Tempname = GetEmployeeName(Session["EmpId"].ToString());
        string Message = string.Empty;
        Message = GetEmployeeCode(Session["UserId"].ToString()) + " request for Payment Voucher number " + txtVoucherNo.Text + ". on " + System.DateTime.Now.ToString();
        if (Hdn_Edit_ID.Value == "")
            Save_Notification = Obj_Notifiacation.InsertNotificationMaster_Trans(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, Session["EmpId"].ToString(), Session["EmpId"].ToString(), Session["PriorityEmpId"].ToString(), Message, Dt_Request_Type.Rows[0]["notification_type_id"].ToString(), Request_URL, "Set_Approval_Transaction", Session["cur_trans_id"].ToString(), "False", Session["Emp_Img"].ToString(), "", "", "", "", Session["UserId"].ToString(), System.DateTime.Now.ToString(), Session["UserId"].ToString(), System.DateTime.Now.ToString(), Session["Ref_ID"].ToString(), "1");
        else
            Save_Notification = Obj_Notifiacation.UpdateNotificationMaster_Trans(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, Session["EmpId"].ToString(), Session["EmpId"].ToString(), Session["PriorityEmpId"].ToString(), Message, Dt_Request_Type.Rows[0]["notification_type_id"].ToString(), Request_URL, "Set_Approval_Transaction", Session["cur_trans_id"].ToString(), "False", Session["Emp_Img"].ToString(), "", "", "", "", Session["UserId"].ToString(), System.DateTime.Now.ToString(), Session["UserId"].ToString(), System.DateTime.Now.ToString(), Hdn_Edit_ID.Value, "15");
    }
    ...
    protected void btnVoucherSave_Click(object sender, EventArgs e)
    {
        if (txtCashBank.Text == "")
        {
            DisplayMessage("Enter From Cash/Bank");
            txtCashBank.Focus();
            return;
        }
        ...
        if (strLocationIdCash != string.Empty)
        {
        ...
        EmpPermission = objsys.Get_Approval_Parameter_By_Name("Payment Approval").Rows[0]["Approval_Level"].ToString();
        ...
        if (PaymentApproval)
        {
            ...
            dtApproval = objApproalEmp.getApprovalChainByObjectid(Session["CompId"].ToString(), Session["BrandId"].ToString(), Session["LocId"].ToString(), "293", Session["EmpId"].ToString());
        ...
        try
        {
            ...
            if (hdnVoucherId.Value != "0" && hdnVoucherId.Value != "")
            {
                ...
                foreach (GridViewRow gvr in GvDetail.Rows)
                {
                    ...
                    {
                        objVoucherDetail.InsertVoucherDetail(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, hdnVoucherId.Value, ((Label)gvr.FindControl("lblSNo")).Text, ((HiddenField)gvr.FindControl("hdngvAccountNo")).Value, ((HiddenField)gvr.FindControl("hdngvOtherAccountNo")).Value, hdnRef_Id.Value, hdnRef_Type.Value, strChequeIssueDate, strChequeClearDate, txtChequeNo.Text, ((Label)gvr.FindControl("lblgvDebitAmount")).Text, "0.00", ((Label)gvr.FindControl("lblgvNarration")).Text, CostID, Session["EmpId"].ToString(), ((HiddenField)gvr.FindControl("hdngvCurrencyId")).Value, ((Label)gvr.FindControl("lblgvExchangeRate")).Text, ((Label)gvr.FindControl("lblgvForeignAmount")).Text, CompanyCurrDebit, "0.00", "", strReconcile, "", "", "", "True", DateTime.Now.ToString(), "True", Session["UserId"].ToString(), DateTime.Now.ToString(), Session["UserId"].ToString(), DateTime.Now.ToString(), ref trns);
                    }
                    else
                    {
                        objVoucherDetail.InsertVoucherDetail(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, hdnVoucherId.Value, ((Label)gvr.FindControl("lblSNo")).Text, ((HiddenField)gvr.FindControl("hdngvAccountNo")).Value, ((HiddenField)gvr.FindControl("hdngvOtherAccountNo")).Value, hdnRef_Id.Value, hdnRef_Type.Value, strChequeIssueDate, strChequeClearDate, txtChequeNo.Text, ((Label)gvr.FindControl("lblgvDebitAmount")).Text, "0.00", ((Label)gvr.FindControl("lblgvNarration")).Text, CostID, Session["EmpId"].ToString(), ((HiddenField)gvr.FindControl("hdngvCurrencyId")).Value, ((Label)gvr.FindControl("lblgvExchangeRate")).Text, ((Label)gvr.FindControl("lblgvForeignAmount")).Text, CompanyCurrDebit, "0.00", "", "", "", "", "", "True", DateTime.Now.ToString(), "True", Session["UserId"].ToString(), DateTime.Now.ToString(), Session["UserId"].ToString(), DateTime.Now.ToString(), ref trns);
                    }
                ...
                {
                    objVoucherDetail.InsertVoucherDetail(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, hdnVoucherId.Value, "1", txtCashBank.Text.Split('/')[1].ToString(), "0", hdnRef_Id.Value, hdnRef_Type.Value, strChequeIssueDate, strChequeClearDate, txtChequeNo.Text, "0.00", SumDebitTotal.ToString(), txtReference.Text, "", Session["EmpId"].ToString(), ddlLocalCurrency.SelectedValue, "0.00", "0.00", "0.00", CompanyCurrCredit, "", strReconcile, "", "", "", "True", DateTime.Now.ToString(), "True", Session["UserId"].ToString(), DateTime.Now.ToString(), Session["UserId"].ToString(), DateTime.Now.ToString(), ref trns);
                }
                else
                {
                    objVoucherDetail.InsertVoucherDetail(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, hdnVoucherId.Value, "1", txtCashBank.Text.Split('/')[1].ToString(), "0", hdnRef_Id.Value, hdnRef_Type.Value, strChequeIssueDate, strChequeClearDate, txtChequeNo.Text, "0.00", SumDebitTotal.ToString(), txtReference.Text, "", Session["EmpId"].ToString(), ddlLocalCurrency.SelectedValue, "0.00", "0.00", "0.00", CompanyCurrCredit, "", "", "", "", "", "True", DateTime.Now.ToString(), "True", Session["UserId"].ToString(), DateTime.Now.ToString(), Session["UserId"].ToString(), DateTime.Now.ToString(), ref trns);
                }
                ...
                if (PaymentApproval)
                {
                    ...
                    if (dtApproval.Rows.Count > 0)
                    {
                        for (int j = 0; j < dtApproval.Rows.Count; j++)
                        {
                            ...
                            // Session["Ref_ID"] = hdnVoucherId.Value;
                            //Set_Notification();
                        }
                    }
                }
            ...
            else
            {
                ...
                if (dtMaxId.Rows.Count > 0)
                {
                    ...
                    foreach (GridViewRow gvr in GvDetail.Rows)
                    {
                        ...
                        if (strAccountId.Split(',').Contains(((HiddenField)gvr.FindControl("hdngvAccountNo")).Value))
                        {
                            objVoucherDetail.InsertVoucherDetail(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, strMaxId, ((Label)gvr.FindControl("lblSNo")).Text, ((HiddenField)gvr.FindControl("hdngvAccountNo")).Value, ((HiddenField)gvr.FindControl("hdngvOtherAccountNo")).Value, "0", ddlVoucherType.SelectedValue, strChequeIssueDate, strChequeClearDate, txtChequeNo.Text, ((Label)gvr.FindControl("lblgvDebitAmount")).Text, "0.00", ((Label)gvr.FindControl("lblgvNarration")).Text, CostID, Session["EmpId"].ToString(), ((HiddenField)gvr.FindControl("hdngvCurrencyId")).Value, ((Label)gvr.FindControl("lblgvExchangeRate")).Text, ((Label)gvr.FindControl("lblgvForeignAmount")).Text, CompanyCurrDebit, "0.00", "", "False", "", "", "", "True", DateTime.Now.ToString(), "True", Session["UserId"].ToString(), DateTime.Now.ToString(), Session["UserId"].ToString(), DateTime.Now.ToString(), ref trns);
                        }
                        else
                        {
                            objVoucherDetail.InsertVoucherDetail(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, strMaxId, ((Label)gvr.FindControl("lblSNo")).Text, ((HiddenField)gvr.FindControl("hdngvAccountNo")).Value, ((HiddenField)gvr.FindControl("hdngvOtherAccountNo")).Value, "0", ddlVoucherType.SelectedValue, strChequeIssueDate, strChequeClearDate, txtChequeNo.Text, ((Label)gvr.FindControl("lblgvDebitAmount")).Text, "0.00", ((Label)gvr.FindControl("lblgvNarration")).Text, CostID, Session["EmpId"].ToString(), ((HiddenField)gvr.FindControl("hdngvCurrencyId")).Value, ((Label)gvr.FindControl("lblgvExchangeRate")).Text, ((Label)gvr.FindControl("lblgvForeignAmount")).Text, CompanyCurrDebit, "0.00", "", "", "", "", "", "True", DateTime.Now.ToString(), "True", Session["UserId"].ToString(), DateTime.Now.ToString(), Session["UserId"].ToString(), DateTime.Now.ToString(), ref trns);
                    ...
                    if (strAccountId.Split(',').Contains(txtCashBank.Text.Split('/')[1].ToString()))
                    {
                        objVoucherDetail.InsertVoucherDetail(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, strMaxId, "1", txtCashBank.Text.Split('/')[1].ToString(), "0", "0", ddlVoucherType.SelectedValue, strChequeIssueDate, strChequeClearDate, txtChequeNo.Text, "0.00", SumDebitTotal.ToString(), txtReference.Text, "", Session["EmpId"].ToString(), ddlLocalCurrency.SelectedValue, "0.00", "0.00", "0.00", CompanyCurrCredit, "", "False", "", "", "", "True", DateTime.Now.ToString(), "True", Session["UserId"].ToString(), DateTime.Now.ToString(), Session["UserId"].ToString(), DateTime.Now.ToString(), ref trns);
                    }
                    else
                    {
                        objVoucherDetail.InsertVoucherDetail(Session["CompId"].ToString(), Session["BrandId"].ToString(), strLocationId, strMaxId, "1", txtCashBank.Text.Split('/')[1].ToString(), "0", "0", ddlVoucherType.SelectedValue, strChequeIssueDate, strChequeClearDate, txtChequeNo.Text, "0.00", SumDebitTotal.ToString(), txtReference.Text, "", Session["EmpId"].ToString(), ddlLocalCurrency.SelectedValue, "0.00", "0.00", "0.00", CompanyCurrCredit, "", "", "", "", "", "True", DateTime.Now.ToString(), "True", Session["UserId"].ToString(), DateTime.Now.ToString(), Session["UserId"].ToString(), DateTime.Now.ToString(), ref trns);
    ...
    public void Reset()
    {
        ...
        //txtVoucherNo.Text = objDocNo.GetDocumentNo(true, "0", false, "160", "304", "0");
        //ViewState["DocNo"] = objDocNo.GetDocumentNo(true, "0", false, "160", "304", "0");
    ...
    {
        string strCurrency = hdnLocId.Value;
        ...
        txtTotalPaidAmount.Text = TotalDebit.ToString();
        txtTotalPaidAmount.Text = objsys.GetCurencyConversionForInv(strCurrency, txtTotalPaidAmount.Text);
    ...
    public DataTable FillProductDataTabel()
    {
        ...
        if (GvDetail.Rows.Count > 0)
        {
            for (int i = 0; i < GvDetail.Rows.Count + 1; i++)
            {
                ...
                else
                {
                    ...
                    dt.Rows[i]["Debit_Amount"] = txtPaidAmount.Text;
        ...
        else
        {
            ...
            dt.Rows[0]["Debit_Amount"] = txtPaidAmount.Text;
            if (txtReference.Text.Length == 0)
            {
                txtReference.Text = txtDetailNarration.Text;
            }
    ...
    protected void btnbindrpt_Click(object sender, EventArgs e)
    {
        ...
        if (ddlOption.SelectedIndex != 0)
        {
            ...
            {
                Label lblgvVoucherAmount = (Label)gvr.FindControl("lblgvExchangerate");

                lblgvVoucherAmount.Text = objsys.GetCurencyConversionForInv(strCurrency, lblgvVoucherAmount.Text);
            }
            Session["dtFilter_Pay_Voucher"] = view.ToTable();
    ...
    protected void GvVoucher_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        DataTable dt = (DataTable)Session["dtFilter_Pay_Voucher"];
        //Common Function add By Lokesh on 23-05-2015
    ...
    protected void GvVoucher_Sorting(object sender, GridViewSortEventArgs e)
    {
        ...
        Session["dtFilter_Pay_Voucher"] = dt;
    ...
    protected void btnEdit_Command(object sender, CommandEventArgs e)
    {
        ...
        if (sender is ImageButton)
        {
            ...
            if (btnId.ID == "btnEdit")
            {
                ...
                {
                    DisplayMessage("Cant Edit Approved Data");
                    return;
                }
            }
        ...
        if (dtVoucherEdit.Rows.Count > 0)
        {
            if (strbtnStatus == "Edit")
            {
                ...
                DataTable dtApprovalcheck = new DataView(dtVoucherEdit, "Field3='Approved' and Param_Value='True'", "", DataViewRowState.CurrentRows).ToTable();
            ...
            //Add Child Concept   
            string strCurrency = hdnCurrencyId.Value;
            dtDetail = new DataView(dtDetail, "Debit_Amount<>0", "", DataViewRowState.CurrentRows).ToTable();
    ...
    private void FillGrid()
    {
        ...
        {
            dtBrand = new DataView(dtBrand, "Voucher_Type='PV'", "Voucher_Date DESC", DataViewRowState.CurrentRows).ToTable();
            Session["dtVoucher"] = dtBrand;
            Session["dtFilter_Pay_Voucher"] = dtBrand;
            //Common Function add By Lokesh on 23-05-2015
    ...
    protected void ImgDateSearch_Click(object sender, EventArgs e)
    {
        ...
        DataTable dtDate = (DataTable)Session["dtFilter_Pay_Voucher"];
        if (dtDate.Rows.Count > 0)
        {
            ...
            if (dtDate.Rows.Count > 0)
            {
                ...
                Session["dtFilter_Pay_Voucher"] = dtDate;
                //AllPageCode();
            }
            else
            {
    ...
    protected void updateControlsValue(bool isForeignToLocal = false)
    {
        ...
        if (isForeignToLocal == false)
        {
            ...
            double.TryParse(txtPaidAmount.Text, out trns_amount);
            //trns_amount = debit;
            txtForeignamount.Text = GetCurrency(ddlLocalCurrency.SelectedValue, ((1 / exchange_rate) * trns_amount).ToString());
        ...
        else
        {
            ...
            txtPaidAmount.Text = GetCurrency(ddlLocalCurrency.SelectedValue, (exchange_rate * foreign).ToString());
            txtPaidAmount.Text = txtPaidAmount.Text.Trim().Split('/')[0].ToString();
        }
    ...
    {
        FUpload1.setID(e.CommandArgument.ToString(), Session["CompId"].ToString() + "/" + Session["BrandId"].ToString() + "/" + hdnLocId.Value + "/Payment Voucher", "VoucherEntries", "Payment Voucher", e.CommandName.ToString(), e.CommandName.ToString());
        ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "Modal_Open_FileUpload()", true);
    }
    public string CheckStatus(string data)
    {
        string status = "";
        if (data == "")
        {
    ...
    protected void ddlLocationList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ViewState["DocNo"] = objDocNo.GetDocumentNo(true, Session["CompId"].ToString(), hdnLocId.Value, false, "160", "304", "0", Session["BrandId"].ToString(), Session["DepartmentId"].ToString(), Session["EmpId"].ToString(), Session["TimeZoneId"].ToString());
