...
/// <summary>
/// Summary description for SM_GetPass_Detail
/// </summary>
public class SM_GetPass_Detail
{
    DataAccessClass daClass = null;
    public SM_GetPass_Detail(string strConString)
	{
        //
    ...
    public int InsertRecord(string CompanyId, string BrandId, string LocationId, string Header_Id, string Job_No, string Item_Id, string Problem, string Status, string RMA_Send_date, string RMA_Received_Date, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string strIsActive, string strCreatedBy, string strCreatedDate,ref SqlTransaction trns)
    {
        ...
        paramList[5] = new PassDataToSql("@Item_Id", Item_Id, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[6] = new PassDataToSql("@Problem", Problem, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[7] = new PassDataToSql("@Status", Status, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[8] = new PassDataToSql("@RMA_Send_date", RMA_Send_date, PassDataToSql.ParaTypeList.Date, PassDataToSql.ParaDirectonList.Input);
        paramList[9] = new PassDataToSql("@RMA_Received_Date", RMA_Received_Date, PassDataToSql.ParaTypeList.Date, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_SM_GetPass_Detail_Insert", paramList,ref trns);
    ...
    public int DeleteRecord_By_HeaderId(string CompanyId, string BrandId, string LocationId, string Header_Id,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_SM_GetPass_Detail_DeleteRow", paramList,ref trns);
    ...
    public DataTable GetAllRecord_By_HeaderId(string CompanyId, string BrandId, string LocationId, string Header_Id)
    {
        ...
        using (DataTable dtInfo = daClass.Reuturn_Datatable_Search("sp_SM_GetPass_Detail_SelectRow", paramList))
        {
            return dtInfo;
        }
