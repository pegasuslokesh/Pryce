...
public class RoleDataPermission
{
    ...
    public RoleDataPermission(string strConString)
    {
        //
    ...
    public int InsertRoleDataPermission(string RoleId, string CompanyId, string RecordType, string RecordId,string strLocationId, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
