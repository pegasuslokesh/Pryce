...
/// <summary>
/// Summary description for DesignationMaster
/// </summary>
public class DesignationMaster
{
	 DataAccessClass daClass = null;
    public DesignationMaster(string strConString)
    {
        daClass = new DataAccessClass(strConString);
    }
    public int InsertDesignationMaster(string EDesignationName, string LDesignationName,string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
        ...
        paramList[1] = new PassDataToSql("@Designation", EDesignationName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Designation_L", LDesignationName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Set_DesignationMaster_Insert", paramList);
        return Convert.ToInt32(paramList[0].ParaValue);
    }

    public int UpdateDesignationMaster(string DesignationId, string EDesignationName, string LDesignationName, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string ModifiedBy, string ModifiedDate)
    {

        PassDataToSql[] paramList = new PassDataToSql[14];
        paramList[0] = new PassDataToSql("@Designation_Id", DesignationId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Set_DesignationMaster_Update", paramList);
        return Convert.ToInt32(paramList[13].ParaValue);
    }

    public int DeleteDesignationMaster(string DesignationId, string IsActive, string ModifiedBy, string ModifiedDate)
    {
        ...
        daClass.execute_Sp("sp_Set_DesignationMaster_RowStatus", paramList);
        return Convert.ToInt32(paramList[4].ParaValue);
    }
    public DataTable GetDesignationMasterById(string DesignationId)
    {

        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[3];
        paramList[0] = new PassDataToSql("@Designation_Id", DesignationId, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Designation", "", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@optype", "4", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Set_DesignationMaster_SelectRow", paramList);

        return dtInfo;
    }
    public DataTable GetDesignationMaster()
    {

        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[3];
        
        paramList[0] = new PassDataToSql("@Designation_Id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Designation", "", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetDesignationMasterInactive()
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[3];
        paramList[0] = new PassDataToSql("@Designation_Id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    //use equal operation in database
    public DataTable GetDesignationMasterByDesignationName(string strDesignationName)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[3];
        
        paramList[0] = new PassDataToSql("@Designation_Id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Designation", strDesignationName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    //Use like operation in database 
    public DataTable GetDesignationDataByName(string strDesignationName)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[3];
    ...
    public DataTable GetDesignationDataPreText(string strDesignationName)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[3];
        paramList[0] = new PassDataToSql("@Designation_Id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
