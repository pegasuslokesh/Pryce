...
/// <summary>
/// Summary description for Set_EmployeeResources
/// </summary>
public class Set_EmployeeResources
{
    DataAccessClass daClass = null;
    public Set_EmployeeResources(string strConString)
    {
        //
    ...
    public int InsertRecord(string CompanyId, string BrandId, string LocationId, string strEmpId, string Product_Id, string Serial_No, string Qty,string Unit_Id,string Is_Returnable,string Trn_Date,string Issued_By,string Trn_Type,string Penalty_Amount, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string strIsActive, string strCreatedBy, string strCreatedDate, string strModifiedBy, string strModifiedDate, ref SqlTransaction trns)
    {
        ...
        paramList[4] = new PassDataToSql("@Product_Id", Product_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[5] = new PassDataToSql("@Serial_No", Serial_No, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[20] = new PassDataToSql("@Unit_Id", Unit_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[21] = new PassDataToSql("@Is_Returnable", Is_Returnable, PassDataToSql.ParaTypeList.Bit, PassDataToSql.ParaDirectonList.Input);
        paramList[22] = new PassDataToSql("@Trn_Date", Trn_Date, PassDataToSql.ParaTypeList.Date, PassDataToSql.ParaDirectonList.Input);
        paramList[23] = new PassDataToSql("@Issued_By", Issued_By, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[24] = new PassDataToSql("@Trn_Type", Trn_Type, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[25] = new PassDataToSql("@Penalty_Amount", Penalty_Amount, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        daClass.execute_Sp("sp_Set_EmployeeResources_Insert", paramList, ref trns);
    ...
    public int UpdateRecord(string CompanyId, string BrandId, string LocationId,string strTransId, string strEmpId, string Product_Id, string Serial_No, string Qty, string Unit_Id, string Is_Returnable, string Trn_Date, string Issued_By, string Trn_Type, string Penalty_Amount, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string strIsActive, string strModifiedBy, string strModifiedDate, ref SqlTransaction trns)
    {
        ...
        paramList[18] = new PassDataToSql("@Unit_Id", Unit_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[19] = new PassDataToSql("@Is_Returnable", Is_Returnable, PassDataToSql.ParaTypeList.Bit, PassDataToSql.ParaDirectonList.Input);
        paramList[20] = new PassDataToSql("@Trn_Date", Trn_Date, PassDataToSql.ParaTypeList.Date, PassDataToSql.ParaDirectonList.Input);
        paramList[21] = new PassDataToSql("@Issued_By", Issued_By, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[22] = new PassDataToSql("@Trn_Type", Trn_Type, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[23] = new PassDataToSql("@Penalty_Amount", Penalty_Amount, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[24] = new PassDataToSql("@Trans_Id", strTransId , PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        daClass.execute_Sp("sp_Set_EmployeeResources_Update", paramList, ref trns);
    ...
    public int DeleteRecord(string CompanyId, string Trans_Id, string strIsActive, string strModifiedBy, string strModifiedDate)
    {
        ...
        daClass.execute_Sp("sp_Set_EmployeeResources_RowStatus", paramList);
    ...
    public DataTable GetTrueAllRecord(string CompanyId, string strBrandId, string strLocationId)
    {
        ...
        paramList[5] = new PassDataToSql("@Product_id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[6] = new PassDataToSql("@Unit_Id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[7] = new PassDataToSql("@optype", "1", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);

        dtInfo = daClass.Reuturn_Datatable_Search("sp_Set_EmployeeResources_SelectRow", paramList);
        return dtInfo;
    }
