...
/// <summary>
/// Summary description for Set_Group_Employee
/// </summary>
public class Set_Group_Employee
{
    DataAccessClass daClass = null;
	public Set_Group_Employee(string strConString)
	{
        //
    ...
    public int InsertGroup_Employee(string CompanyId,string EmpId,string GroupId ,string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
        ...
        daClass.execute_Sp("sp_Set_Group_Employee_Insert", paramList);
        return Convert.ToInt32(paramList[15].ParaValue);
    }

   
    public int DeleteGroup_Employee(string CompanyId, string GroupId, string IsActive, string ModifiedBy, string ModifiedDate)
    {
        ...
        daClass.execute_Sp("sp_Set_Group_Employee_RowStatus", paramList);
        return Convert.ToInt32(paramList[5].ParaValue);
    }



    public int DeleteGroup_EmployeeByEmpId(string Empid, string GroupId, string IsActive, string ModifiedBy, string ModifiedDate)
    {
        ...
        paramList[4] = new PassDataToSql("@ModifiedDate", ModifiedDate, PassDataToSql.ParaTypeList.DateTime, PassDataToSql.ParaDirectonList.Input);
        paramList[5] = new PassDataToSql("@ReferenceID", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Output);
        daClass.execute_Sp("sp_Set_Group_Employee_DeleteEmployee", paramList);
        return Convert.ToInt32(paramList[5].ParaValue);
    }
    public DataTable GetGroup_EmployeeById(string CompanyId)
    {
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Set_Group_Employee_SelectRow", paramList);

        return dtInfo;
    }
    public DataTable GetGroup_EmployeeById(string CompanyId, ref SqlTransaction trns)
    {
        ...
        paramList[1] = new PassDataToSql("@Group_Id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@optype", "1", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Set_Group_Employee_SelectRow", paramList,ref trns);

        return dtInfo;
    }
    public DataTable GetGroup_Employee(string GroupId, string CompanyId)
    {
