...
public class LeaveMaster
{
    ...
    public LeaveMaster(string strConString)
	{
        //
    ...
    public DataTable GetLeaveMasterById(string CompanyId, string LeaveId,ref SqlTransaction trns)
    {
        ...
        paramList[2] = new PassDataToSql("@Leave_Name", "", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[3] = new PassDataToSql("@optype", "4", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Att_LeaveMaster_SelectRow", paramList,ref trns);
    ...
    public DataTable GetLeaveMasterByLeaveName(string CompanyId, string strLeaveName,ref SqlTransaction trns)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[4];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
