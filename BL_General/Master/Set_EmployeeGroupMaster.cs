...
/// <summary>
/// Summary description for Set_EmployeeGroup_Master
/// </summary>
public class Set_EmployeeGroup_Master
{
    DataAccessClass daClass = null;
	public Set_EmployeeGroup_Master(string strConString)
	{
        //
    ...
    public int InsertEmployeeGroup_Master(string CompanyId,string BrandId,string locationId ,string EGroupName, string LGroupName,string ParentId,string RoleId, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
        ...
        paramList[1] = new PassDataToSql("@Group_Name", EGroupName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Group_Name_L", LGroupName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[16] = new PassDataToSql("@Parent_Id", ParentId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[17] = new PassDataToSql("@Role_Id", RoleId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[18] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Set_EmployeeGroup_Master_Insert", paramList);
        return Convert.ToInt32(paramList[15].ParaValue);
    }

    public int UpdateEmployeeGroup_Master(string CompanyId,string BrandId,string locationId , string GroupId, string ParentId,string RoleId, string EGroupName, string LGroupName, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string ModifiedBy, string ModifiedDate)
    {
        ...
        paramList[14] = new PassDataToSql("@Group_Id", GroupId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[15] = new PassDataToSql("@Parent_Id", ParentId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[16] = new PassDataToSql("@Role_Id", RoleId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[17] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);

        paramList[18] = new PassDataToSql("@Location_Id", locationId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
     
        daClass.execute_Sp("sp_Set_EmployeeGroup_Master_Update", paramList);
        return Convert.ToInt32(paramList[13].ParaValue);
    }

    public int DeleteEmployeeGroup_Master(string CompanyId, string GroupId, string IsActive, string ModifiedBy, string ModifiedDate)
    {
        ...
        daClass.execute_Sp("sp_Set_EmployeeGroup_Master_RowStatus", paramList);
        return Convert.ToInt32(paramList[5].ParaValue);
    }
    public DataTable GetEmployeeGroup_MasterById(string CompanyId, string GroupId)
    {

        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[4];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Group_Id", GroupId, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Set_EmployeeGroup_Master_SelectRow", paramList);

        return dtInfo;
    }
    public DataTable GetEmployeeGroup_Master(string CompanyId)
    {

        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[4];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Group_Id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Group_Name", "", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetEmployeeGroup_MasterInactive(string CompanyId)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[4];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetEmployeeGroup_MasterByGroupName(string CompanyId, string strGroupName)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[4];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Group_Id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Group_Name", strGroupName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[3] = new PassDataToSql("@optype", "5", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Set_EmployeeGroup_Master_SelectRow", paramList);

        return dtInfo;
    }
    public DataTable GetEmployeeGroup_Master(string CompanyId,string brandId,string LocationId)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[4] = new PassDataToSql("@brandId", brandId, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
