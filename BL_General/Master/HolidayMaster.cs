...
/// <summary>
/// Summary description for HolidayMaster
/// </summary>
public class HolidayMaster
{

    DataAccessClass daClass = null;
    public HolidayMaster(string strConString)
    {
        //
    ...
    public int InsertHolidayMaster(string CompanyId, string EHolidayName, string LHolidayName, string Brand_Id, string From_Date, string To_Date, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,string strLocId)
    {
        ...
        paramList[1] = new PassDataToSql("@Holiday_Name", EHolidayName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Holiday_Name_L", LHolidayName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[5] = new PassDataToSql("@Field1", strLocId, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[18] = new PassDataToSql("@To_Date", To_Date, PassDataToSql.ParaTypeList.Date, PassDataToSql.ParaDirectonList.Input);

        daClass.execute_Sp("sp_Set_HolidayMaster_Insert", paramList);
        return Convert.ToInt32(paramList[17].ParaValue);
    }

    public int UpdateHolidayMaster(string HolidayId, string CompanyId, string EHolidayName, string LHolidayName, string Brand_Id, string From_Date, string To_Date, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string ModifiedBy, string ModifiedDate,string strLocId)
    {
        ...
        paramList[16] = new PassDataToSql("@Holiday_Id", HolidayId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[17] = new PassDataToSql("@To_Date", To_Date, PassDataToSql.ParaTypeList.DateTime, PassDataToSql.ParaDirectonList.Input);

        daClass.execute_Sp("sp_Set_HolidayMaster_Update", paramList);
        return Convert.ToInt32(paramList[15].ParaValue);
    }

    public int DeleteHolidayMaster(string CompanyId, string HolidayId, string IsActive, string ModifiedBy, string ModifiedDate)
    {
        ...
        daClass.execute_Sp("sp_Set_HolidayMaster_RowStatus", paramList);
        return Convert.ToInt32(paramList[5].ParaValue);
    }
    public DataTable GetHolidayMasterById(string CompanyId, string HolidayId,string strBrandId, string strLocId)
    {
        ...
        paramList[2] = new PassDataToSql("@Holiday_Name", "", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Set_HolidayMaster_SelectRow", paramList);

        return dtInfo;
    }
    public DataTable GetHolidayMaster(string CompanyId,string strBrandId, string strLocId)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetHolidayMasterByCompanyOnly(string CompanyId)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[4] = new PassDataToSql("@Brand_Id", "", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[5] = new PassDataToSql("@Location_Id", "", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Set_HolidayMaster_SelectRow", paramList);
        return dtInfo;
    }
    public DataTable GetHolidayMasterInactive(string CompanyId,string strBrandId, string strLocId)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetHolidayMasterInactiveByCompanyOnly(string CompanyId)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetHolidayMasterByHolidayName(string CompanyId, string strHolidayName, string strBrandId, string strLocId)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Holiday_Id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Holiday_Name", strHolidayName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
