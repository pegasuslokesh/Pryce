...
public class Set_Pay_Employee_Allow_Deduc
{
    ...
    public Set_Pay_Employee_Allow_Deduc(string strConString)
    {
        //
    ...
    public int InsertPayEmpAllowDeduc(string strCompanyId, string strEmp_Id, string strType, string strRef_Id, string strCalculation_Method, string strValue_Type, string strValue, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string strIsActive, string strCreatedBy, string strCreatedDate, string strModifiedBy, string strModifiedDate,ref SqlTransaction trns)
    {
        PassDataToSql[] paramList = new PassDataToSql[20];
        paramList[0] = new PassDataToSql("@Company_Id", strCompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Emp_Id", strEmp_Id, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Pay_Employee_Allow_Deduction_Insert", paramList,ref trns);
        return Convert.ToInt32(paramList[19].ParaValue);
    }
    ...
    public DataTable GetPayAllowDeducByEmpId(string CompanyId, string Emp_Id)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetPayAllowDeducByEmpId(string CompanyId, string Emp_Id,ref SqlTransaction trns)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Pay_Employee_Allow_Deduction_SelectRow", paramList,ref trns);
        return dtInfo;
    }
    public DataTable GetPayAllowDeducAll(string CompanyId)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
