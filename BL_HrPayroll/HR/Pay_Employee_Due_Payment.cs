...
public class Pay_Employee_Due_Payment
{
    ...
    public Pay_Employee_Due_Payment(string strConString)
    {
        da = new DataAccessClass(strConString);
    }

    public int Insert_In_Employee_Due_Payment(string CompanyId, string EmployeeId, string month, string year, string type,string Amount,string date, string description,string Is_conclude, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
    ...
    public DataTable GetRecord_Emp_Due_paymentType1(string Empid, string Month, string Year,string strCompanyId)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[5];
        param[0] = new PassDataToSql("@Trans_Id",strCompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetRecord_Emp_Due_paymentType1(string Empid, string Month, string Year,ref SqlTransaction trns, string strCompanyId)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[5];
        param[0] = new PassDataToSql("@Trans_Id", strCompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        Dt = da.Reuturn_Datatable_Search("sp_Pay_Employee_Due_Payment_Temp_Select_Row", param,ref trns);
        return Dt;

    }
    public DataTable GetRecord_Emp_Due_paymentByType2(string Empid, string Month, string Year, string strCompanyId)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[5];
        param[0] = new PassDataToSql("@Trans_Id", strCompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetRecord_Emp_Due_paymentByType2(string Empid, string Month, string Year,ref SqlTransaction trns, string strCompanyId)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[5];
        param[0] = new PassDataToSql("@Trans_Id", strCompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable DeleteEmp_Due_paymentByEmpId_MonthandYear(string Companyid,string Empid, string Month, string Year, string Field1, string Field2,string OpType)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[7];
       
        param[0] = new PassDataToSql("@Emp_Id", Empid, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        param[5] = new PassDataToSql("@Optype",OpType, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        param[6] = new PassDataToSql("@CompanyId", Companyid, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);

        Dt = da.Reuturn_Datatable_Search("sp_Pay_Employee_Due_Payment_Temp_Delete", param);
        return Dt;
    }

    public DataTable DeleteEmp_Due_paymentByEmpId_MonthandYear(string Companyid, string Empid, string Month, string Year, string Field1, string Field2, string OpType,ref SqlTransaction trns)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[7];
        ...
        Dt = da.Reuturn_Datatable_Search("sp_Pay_Employee_Due_Payment_Temp_Delete", param,ref trns);
        return Dt;
    }

    public DataTable GetAllRecordEmpDue_paymentByEmpId(string Empid, string Month, string Year, string strCompanyId)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[5];
        param[0] = new PassDataToSql("@Trans_Id", strCompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        param[2] = new PassDataToSql("@Month", Month, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        param[3] = new PassDataToSql("@year", Year, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        param[4] = new PassDataToSql("@Type", "6", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetAllRecord_ByEmpId(string Empid, string strCompanyId)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[5];
        param[0] = new PassDataToSql("@Trans_Id",strCompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetAllRecord_ByEmpId(string Empid,ref SqlTransaction trns, string strCompanyId)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[5];
        param[0] = new PassDataToSql("@Trans_Id", strCompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
