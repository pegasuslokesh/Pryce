...
public class Pay_Employee_Attendance
{
    ...
    public Pay_Employee_Attendance(string strConString)
    {
        //
    ...
    public DataTable GetRecord_Emp_Attendance(string strEmp_Id, string strmonth, string stryear,string strCompanyId)
    {
    ...
    public DataTable GetPendingLogPostEmployeeList(string strEmp_Id, string strmonth, string stryear)
    {
        DataTable dtInfo1 = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[3];
        paramList[0] = new PassDataToSql("@Emp_Id", strEmp_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        dtInfo1 = da.Reuturn_Datatable_Search("sp_Get_PayEmployeeLogPostPending", paramList);
        return dtInfo1;
    }
    public DataTable GetRecord_Emp_Attendance(string strEmp_Id, string strmonth, string stryear,ref SqlTransaction trns,string strCompanyId)
    {
        DataTable dtInfo1 = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[5];
        paramList[0] = new PassDataToSql("@Trans_Id", strCompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[3] = new PassDataToSql("@year", stryear, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[4] = new PassDataToSql("@optype", "1", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo1 = da.Reuturn_Datatable_Search("sp_Pay_Employee_Attendance_Select_Row", paramList,ref trns);
        return dtInfo1;
    }
    public int DeletePayEmployeeAttendance(string empid, string month, string year, ref SqlTransaction trns)
    {
        ...
        da.execute_Sp("sp_Pay_Employee_Attendance_Delete", paramList, ref trns);
    ...
    public int InsertPayEmployeeAttendance(string CompanyId, string Emp_Id, string Month, string Year, string Total_Days, string Days_In_WorkMin, string Worked_Days, string Week_Off_Days, string Holiday_Days, string Leave_Days, string Absent_Days, string Assigned_Worked_Min, string Basic_Salary, string Basic_Min_Salary, string Normal_OT_Salary, string Week_Off_OT_Salary, string Holiday_OT_Salary, string Absent_Penalty, string Late_Penalty_Min, string Early_Penalty_Min, string Partial_Penalty_Min, string Total_Worked_Min, string Holiday_OT_Min, string Week_Off_OT_Min, string Normal_OT_Min, string Late_Min, string Early_Min, string Partial_Min, string Basic_Work_Salary, string Normal_OT_Work_Salary, string WeekOff_OT_Work_Salary, string Holiday_OT_Work_Salary, string Week_Off_Days_Salary, string Holiday_Days_Salary, string Leave_Days_Salary, string Absent_Day_Penalty, string Late_Min_Penalty, string Early_Min_Penalty, string Parital_Violation_Penalty, string Posted_Date, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string Field8, string Field9, string Field10, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
        ...
        paramList[19] = new PassDataToSql("@Early_Penalty_Min", Early_Min_Penalty, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[36] = new PassDataToSql("@Early_Min_Penalty", Early_Penalty_Min, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[51] = new PassDataToSql("@CreatedDate", CreatedDate, PassDataToSql.ParaTypeList.DateTime, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[53] = new PassDataToSql("@ModifiedDate", ModifiedDate, PassDataToSql.ParaTypeList.DateTime, PassDataToSql.ParaDirectonList.Input);
    ...
    public int InsertPayEmployeeAttendance(string CompanyId, string Emp_Id, string Month, string Year, string Total_Days, string Days_In_WorkMin, string Worked_Days, string Week_Off_Days, string Holiday_Days, string Leave_Days, string Absent_Days, string Assigned_Worked_Min, string Basic_Salary, string Basic_Min_Salary, string Normal_OT_Salary, string Week_Off_OT_Salary, string Holiday_OT_Salary, string Absent_Penalty, string Late_Penalty_Min, string Early_Penalty_Min, string Partial_Penalty_Min, string Total_Worked_Min, string Holiday_OT_Min, string Week_Off_OT_Min, string Normal_OT_Min, string Late_Min, string Early_Min, string Partial_Min, string Basic_Work_Salary, string Normal_OT_Work_Salary, string WeekOff_OT_Work_Salary, string Holiday_OT_Work_Salary, string Week_Off_Days_Salary, string Holiday_Days_Salary, string Leave_Days_Salary, string Absent_Day_Penalty, string Late_Min_Penalty, string Early_Min_Penalty, string Parital_Violation_Penalty, string Posted_Date, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string Field8, string Field9, string Field10, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate, ref SqlTransaction trns)
    {
        //Update On 10-03-2015
        PassDataToSql[] paramList = new PassDataToSql[56];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        da.execute_Sp("sp_Pay_Employee_Attendance_Insert", paramList, ref trns);
        return Convert.ToInt32(paramList[54].ParaValue);
    }
}
