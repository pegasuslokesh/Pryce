...
public class Pay_Employee_claim
{
    ...
    public Pay_Employee_claim(string strConString)
    {
        da = new DataAccessClass(strConString);
    }

    public DataTable GetRecord_From_PayEmployeeClaimByClaimId(string ClaimId)
    {
        ...
        param[8] = new PassDataToSql("@optype", "5", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetRecord_From_PayEmployeeClaimByClaimId(string ClaimId,ref SqlTransaction trns)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[9];
        param[0] = new PassDataToSql("@Company_Id", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        Dt = da.Reuturn_Datatable_Search("Sp_Pay_Employee_Claim_SelectRow", param,ref trns);
        return Dt;
    ...
    public int Insert_In_Pay_Employee_Claim(string CompanyId, string EmployeeId, string ClaimName, string ClaimDiscription, string ValueType, string Value, string ClaimReqDate, string ClaimApproved, string ClaimAppDate, string ClaimMonth, string ClaimYear, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,ref SqlTransaction trns)
    {
        PassDataToSql[] param = new PassDataToSql[25];
        param[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        da.execute_Sp("Sp_Pay_Employee_Claim_Insert", param,ref trns);
        return Convert.ToInt32(param[24].ParaValue);
    ...
    // 
    public DataTable GetRecord_From_PayEmployeeClaimLoanPending(string Empid)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[1];
        param[0] = new PassDataToSql("@EmpId", Empid, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        Dt = da.Reuturn_Datatable_Search("Get_PayEmployeeClaimLoanPending", param);
        return Dt;

    }

    public DataTable GetRecord_From_PayEmployeeClaim_usingClaimId_And_EmployeeId(string CompanyId, string Empid, string ClaimId, string Month, string Year, string ClaimApproved, string Field1, string Field2)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[9];
        param[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public int UpdateRecord_In_Pay_Employee_ClaimAmount(string CompanyId, string Claimid, string EmpId, string ActualValue, string UpdateValue, string Month, string Year, string ModifiedBy, string Modifieddate)
    {

        PassDataToSql[] param = new PassDataToSql[10];
        param[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        param[1] = new PassDataToSql("@Claim_Id", Claimid, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        param[2] = new PassDataToSql("@Actual_Value", ActualValue, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
        param[3] = new PassDataToSql("@Update_Value", UpdateValue, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
        param[4] = new PassDataToSql("@Claim_Month", Month, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        param[5] = new PassDataToSql("@Claim_Year", Year, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        da.execute_Sp("sp_Pay_Employee_Claim_Update_Amount", param);
        return Convert.ToInt32(param[8].ParaValue);
    }


    public int UpdateRecord_In_Pay_Employee_ClaimAmount(string CompanyId, string Claimid, string EmpId, string ActualValue, string UpdateValue, string Month, string Year, string ModifiedBy, string Modifieddate,ref SqlTransaction trns)
    {
        ...
        da.execute_Sp("sp_Pay_Employee_Claim_Update_Amount", param,ref trns);
        return Convert.ToInt32(param[8].ParaValue);
    }
    ...
    public int UpdateRecord_In_Pay_Employee_Claim(string CompanyId, string Claimid, string Claimname, string ClaimDiscription, string value_type, string value, string Month, string Year, string ClaimApproved, string ModifiedBy, string Modifieddate,ref SqlTransaction trns)
    {
        ...
        da.execute_Sp("sp_Pay_Employee_Claim_Update", param,ref trns);
        return Convert.ToInt32(param[12].ParaValue);
    }
    public static DataTable GetClaimName(string prefixText, string comp,string strConString)
    {
    ...
    public DataTable GetRecord_From_PayEmployeeClaim_By_EmpId_MonthandYear(string CompanyId, string Empid, string ClaimId, string strclaimapproved, string Month, string Year, string Field1, string Field2)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[9];
        param[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetRecord_From_PayEmployeeClaim_By_EmpId_MonthandYear(string CompanyId, string Empid, string ClaimId, string strclaimapproved, string Month, string Year, string Field1, string Field2,ref SqlTransaction trns)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[9];
        param[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable Get_PayEmployeeClaim_By_EmpId_LeaveSalary(string CompanyId, string Empid)
    {
        DataTable Dt = new DataTable();
        PassDataToSql[] param = new PassDataToSql[9];
        param[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        param[6] = new PassDataToSql("@Field1", "", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        param[7] = new PassDataToSql("@Field2", "", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        param[8] = new PassDataToSql("@optype", "6", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
