...
/// <summary>
/// Summary description for Inv_ProductionRequestDetail
/// </summary>
public class Inv_ProductionRequestDetail
{
    DataAccessClass daClass = null;
	public Inv_ProductionRequestDetail(string strConString)
	{
        //
    ...
    public int InsertRecord(string Company_Id, string brandId, string Locationid, string Request_No, string Serial_No, string ProductId, string UnitId, string Quantity, string UnitPrice, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate, ref SqlTransaction trns)
    {
        ...
        paramList[3] = new PassDataToSql("@Request_No", Request_No, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[7] = new PassDataToSql("@Quantity", Quantity, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[8] = new PassDataToSql("@UnitPrice", UnitPrice, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_ProductionRequestDetail_Insert", paramList,ref trns);
        return Convert.ToInt32(paramList[21].ParaValue);
    }

    public void DeleteRecord_By_RequestNo(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strPI_No, ref SqlTransaction trns)
    {
        ...
        paramList[3] = new PassDataToSql("@Request_No", strPI_No, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        daClass.execute_Sp("sp_Inv_ProductionRequestDetail_DeleteRowByRequestNo", paramList,ref trns);
    }
    ...
    public DataTable GetAllTrueRecord(string strCompany_Id, string strBrand_Id, string strLocation_Id)
    {
        ...
        paramList[4] = new PassDataToSql("@Request_No","0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[5] = new PassDataToSql("@optype", "1", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_ProductionRequestDetail_SelectRow", paramList);
    ...
    public DataTable GetRecord_By_RequestNo(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strRequestNo)
    {
        ...
        paramList[2] = new PassDataToSql("@Location_Id", strLocation_Id, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[3] = new PassDataToSql("@Trans_Id", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[4] = new PassDataToSql("@Request_No", strRequestNo, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
