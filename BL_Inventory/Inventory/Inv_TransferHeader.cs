...
public class Inv_TransferHeader
{
    ...
    Common cm = null;
    public Inv_TransferHeader(string strConString)
    {
        //
    ...
    public int InsertTransferHeader(string CompanyId, string brandId, string FromLocationid, string TransferDate, string RequestNo, string ToLocatonID, string Remark, string Post, string OutDate, string InDate, string VoucherNo, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate, ref SqlTransaction trns)
    {
        ...
        paramList[20] = new PassDataToSql("@VoucherNo", VoucherNo, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_TransferHeader_Insert", paramList,ref trns);
    ...
    public int UpdateTransferHeader(string Trans_Id, string CompanyId, string brandId, string FromLocationid, string TransferDate, string RequestNo, string ToLocatonID, string Remark, string Post, string OutDate, string InDate, string VoucherNo, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate, ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_TransferHeader_Update", paramList,ref trns);
    ...
    public DataTable GetTransferHeader(string Company_Id, ref SqlTransaction trns)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[5];
        paramList[0] = new PassDataToSql("@Company_Id", Company_Id, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[3] = new PassDataToSql("@TransId", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[4] = new PassDataToSql("@optype", "1", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_TransferHeader_SelectRow", paramList,ref trns);
    ...
    public DataTable GetTransferHeaderByVoucherNo(string Company_Id, string BrandId, string LocationId, string VoucherNo)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[5];
        paramList[0] = new PassDataToSql("@Company_Id", Company_Id, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Location_Id", LocationId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[3] = new PassDataToSql("@TransId", VoucherNo , PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetTransferHeaderForTransferIn(string Company_Id, string BrandId, string LocationId, string TransId, ref SqlTransaction trns)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[5];
        paramList[0] = new PassDataToSql("@Company_Id", Company_Id, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    {
        cm.UpdateCodeForDocumentNo("Inv_TransferHeader", "VoucherNo", "Trans_Id", Id, Code,ref trns);
    ...
    public DataTable GetTransferHeaderForTransferIn(string Company_Id, string BrandId, string LocationId, ref SqlTransaction trns)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[5];
        paramList[0] = new PassDataToSql("@Company_Id", Company_Id, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    //16-02-2016
    //by jitendra upadhyay
    public int UpdateTransferHeaderForTransferIn(string CompanyId, string BrandId, string LocationId, string TransId, string INDate, string Post, string Modifiedby, string ModifiedDate, ref SqlTransaction trns)
    {
        PassDataToSql[] paramList = new PassDataToSql[9];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_TransferHeaderIn_Update", paramList,ref trns);
        return Convert.ToInt32(paramList[7].ParaValue);

    }

    public string getAutoId(ref SqlTransaction trns)
    {
        string I = daClass.get_SingleValue("SELECT IDENT_CURRENT('Inv_TransferHeader')",ref trns);
    ...
    public DataTable GetTransferHeaderByVoucherNumber(string Company_Id, string BrandId, string LocationId, string VoucherNo)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[5];
        paramList[0] = new PassDataToSql("@Company_Id", Company_Id, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Location_Id", LocationId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[3] = new PassDataToSql("@VoucherNo", VoucherNo, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[4] = new PassDataToSql("@optype", "1", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_TransferHeader_SelectRowBYVoucherNO", paramList);
