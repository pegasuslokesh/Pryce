...
public class Inv_TransferRequestDetail
{
    ...
    public Inv_TransferRequestDetail(string strConString)
    {
        //
    ...
    public int InsertTransferRequestDetail(string CompanyId, string brandId, string Locationid, string SerialNO, string ProductId, string TransferRequestId, string UnitId, string unitcost, string ReqQty, string RecievedQuantity, string AvailableQuantity, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
        ...
        paramList[7] = new PassDataToSql("@UnitCost", unitcost, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);

        paramList[8] = new PassDataToSql("@Quantity", ReqQty, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[22] = new PassDataToSql("@ReceivedQty", RecievedQuantity, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
        paramList[23] = new PassDataToSql("@AvailableQuantity", AvailableQuantity, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
    ...
    public int InsertTransferRequestDetail(string CompanyId, string brandId, string Locationid, string SerialNO, string ProductId, string TransferRequestId, string UnitId, string unitcost, string ReqQty, string RecievedQuantity, string AvailableQuantity, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate, ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_TransferRequestDetail_Insert", paramList, ref trns);
        return Convert.ToInt32(paramList[21].ParaValue);
    }
    ...
    public void DeleteTransferRequestDetailBYReqID(string CompanyId, string brand_ID, string Location_Id, string ReqId, ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_TransferRequestDetail_DeleteRowByReqId", paramList,ref trns);

    }
    public void DeleteTransferRequestDetailBYReqIDandTrans_ID(string CompanyId, string brand_ID, string Location_Id, string ReqId, string Trans_Id)
    {
        ...
        daClass.execute_Sp("sp_Inv_TransferRequestDetail_DeleteRowByReqIdandTrans_Id", paramList);
    ...
    public DataTable GetTransferRequestDetail(string CompanyId, string BrandId, string LocationId, string RequestId, string TransId)
    {
        ...
        paramList[6] = new PassDataToSql("@Finance_year_Id","0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        using (dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_TransferRequestDetail_SelectRow", paramList))

            return dtInfo;
    }

    public DataTable GetTransferRequestDetailbyRequestId(string CompanyId, string BrandId, string LocationId, string RequestId,string strFinanceYear)
    {
        ...
        paramList[6] = new PassDataToSql("@Finance_year_Id", strFinanceYear, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        using (dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_TransferRequestDetail_SelectRow", paramList))
    ...
    public int UpdateTransferRequestDetailForTransferIn(string CompanyId, string BrandId, string LocationId, string TransId, string ReceivedQty, string ProductId, string Modifiedby, string ModifiedDate, ref SqlTransaction trns)
    {
        PassDataToSql[] paramList = new PassDataToSql[9];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_TransferRequestDetailIn_Update", paramList, ref trns);
        return Convert.ToInt32(paramList[8].ParaValue);
