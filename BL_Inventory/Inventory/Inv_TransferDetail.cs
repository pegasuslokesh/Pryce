...
public class Inv_TransferDetail
{
	...
	public Inv_TransferDetail(string strConString)
	{
        //
    ...
    public int InsertTransferDetail(string CompanyId, string brandId, string FromLocationID, string Transfer_Id, string SerialNO, string ProductId, string UnitCost, string UnitId, string ReqQty, string OutQty, string RecQty, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,string strFinanceyearId, ref SqlTransaction trns)
    {
        ...
        paramList[24] = new PassDataToSql("@Finance_year_Id",strFinanceyearId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        daClass.execute_Sp("sp_Inv_TransferDetail_Insert", paramList,ref trns);
    ...
    public void DeleteTransferDetailbyHeaderTransId(string CompanyId, string brand_ID, string Location_Id, string TransferId, ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_TransferDetail_DeleteRowByHeaderTransId", paramList,ref trns);

    }


    public DataTable GetTransferDetailbyTransferId(string CompanyId, string BrandId, string LocationId, string TransferId, string strFinancialYearId)
    {
        ...
        paramList[5] = new PassDataToSql("@Finance_Year_Id", strFinancialYearId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public int UpdateTransferDetailForTransferIn(string CompanyId, string BrandId, string LocationId, string TransId, string InQty, string Modifiedby, string ModifiedDate, ref SqlTransaction trns)
    {
        PassDataToSql[] paramList = new PassDataToSql[8];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_TransferDetailIn_Update", paramList,ref trns);
        return Convert.ToInt32(paramList[7].ParaValue);
