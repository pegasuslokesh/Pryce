...
public class BillOfMaterial
{
    ...
    public BillOfMaterial(string strConString)
    {
        //
    ...
    public int Insert_BOM(string CompanyId, string ModelId, string TDate, string TransType, string SubProductID, string ModelNo, string OptionID, string OptionDescription, string ShortDescription, string OptionCategoryID, string UnitPrice, string Quantity, string PDefault, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_BOM_Insert", ParamList,ref trns);
        return Convert.ToInt32(ParamList[25].ParaValue.ToString());

    }
    public int Update_BOM(string TransId, string CompanyId, string ModelId, string TDate, string TransType, string SubProductID, string ModelNo, string OptionID, string OptionDescription, string ShortDescription, string OptionCategoryID, string UnitPrice, string Quantity, string PDefault, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string ModifiedBy, string ModifiedDate,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_BOM_Update", ParamList,ref trns);
    ...
    public DataTable BOM_All(string CompanyId)
    {
        ...
        ParamList[1] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ParamList[2] = new PassDataToSql("@ModelId", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable BOM_All(string CompanyId,ref SqlTransaction trns)
    {
        PassDataToSql[] ParamList = new PassDataToSql[4];
        ParamList[0] = new PassDataToSql("@TransId", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ParamList[1] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ParamList[2] = new PassDataToSql("@ModelId", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ParamList[3] = new PassDataToSql("@Optype", "1", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        DataTable dt = daClass.Reuturn_Datatable_Search("sp_Inv_BOM_SelectRow", ParamList,ref trns);
        return dt;
    ...
    public DataTable BOM_ByModelId(string CompanyId, string ModelId)
    {
        PassDataToSql[] ParamList = new PassDataToSql[4];
        ParamList[0] = new PassDataToSql("@TransId", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ParamList[1] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
