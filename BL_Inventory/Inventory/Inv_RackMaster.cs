...
public class Inv_RackMaster
{
    ...
    public Inv_RackMaster(string strConString)
    {
        daClass = new DataAccessClass(strConString);
    }
    public int InsertRackMaster(string CompanyId, string BrandId,string LocationId,string ParentRackId,string RackName,string RackName_L, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string strIsActive, string strCreatedBy, string strCreatedDate, string strModifiedBy, string strModifiedDate,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_RackMaster_Insert", paramList,ref trns);
        return Convert.ToInt32(paramList[18].ParaValue);
    }
    public int UpdateRackMaster(string CompanyId, string BrandId, string LocationId, string RackId, string ParentRackId, string RackName, string RackName_L, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string strIsActive, string strModifiedBy, string strModifiedDate, ref SqlTransaction trns)
    {
    ...
    public DataTable GetRackMasterByRackName(string CompanyId, string BrandId, string LocationId, string RackName,ref SqlTransaction trns)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_RackMaster_SelectRow", paramList,ref trns);
        return dtInfo;
    ...
    public DataTable GetDistinctRackName(string strCompanyId, string StrBrandId,string strLocationId,string strPrefixText)
    {
        ...
        dtInfo = new DataView(dtInfo, "Rack_Name Like '%" + strPrefixText + "%'", "Rack_Name asc", DataViewRowState.CurrentRows).ToTable();
