...
public class Inv_ProductSuppliers
{
    ...
    public Inv_ProductSuppliers(string strConString)
    {
        //
    ...
    public int InsertProductSuppliers(string CompanyId, string BrandId, string ProductId, string SupplierId, string ProductSupplierCode, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_Product_Suppliers_Insert", paramList,ref trns);
        return Convert.ToInt32(paramList[17].ParaValue);
    }

    public int DeleteProductSuppliers(string CompanyId, string BrandId, string ProductId,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_Product_Suppliers_DeleteRow", paramList,ref trns);
    ...
    public DataTable GetProductSuppliersByProductId(string CompanyId, string BrandId, string ProductId)
    {
        ...
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Product_Id", ProductId, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[3] = new PassDataToSql("@Supplier_Id","0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetProductSuppliersBySupplierId(string CompanyId, string BrandId, string SupplierId)
    {
        ...
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Product_Id","0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[3] = new PassDataToSql("@Supplier_Id", SupplierId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
