...
/// </summary>
public class Inv_Product_RelProduct
{
    DataAccessClass daClass = null;
    public Inv_Product_RelProduct(string strConString)
    {
        //
    ...
    public int InsertRelatedProduct(string CompanyId, string BrandId, string ProductId, string SubProductId, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,ref SqlTransaction trns)
    {
        ...
        paramList[3] = new PassDataToSql("@SubProduct_Id", SubProductId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[16] = new PassDataToSql("@ReferanceId", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Output);

        daClass.execute_Sp("sp_Inv_Product_RelProduct_Insert", paramList,ref trns);
        return Convert.ToInt32(paramList[16].ParaValue);
    }
    public int DeleteRelatedProduct(string CompanyId, string BrandId, string ProductId,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_Product_RelProduct_DeleteRow", paramList,ref trns);
        return Convert.ToInt32(paramList[3].ParaValue);
    }
    public DataTable GetRelatedProductByProductId(string CompanyId, string BrandId, string ProductId)
    {
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_Product_RelProduct_SelectRow", paramList);
