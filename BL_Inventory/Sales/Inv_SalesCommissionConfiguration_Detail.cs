...
/// <summary>
/// Summary description for Inv_SalesCommissionConfiguration_Detail
/// </summary>
public class Inv_SalesCommissionConfiguration_Detail
{
    DataAccessClass daClass = null;
    Common cm = null;
    public Inv_SalesCommissionConfiguration_Detail(string strConString)
    {
        //
    ...
    public int InsertRecord(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strRefId, string strCategoryId,string strSales_Quota, string strCommissionPercentage, string strIsAllow, string strNotes,  string strField1, string strField2, string strField3, string strField4, string strField5, string strField6, string strField7, string strIsActive, string strCreatedBy, string strCreatedDate, string strModifiedBy, string strModifiedDate, ref SqlTransaction trns)
    {
        ...
        paramList[3] = new PassDataToSql("@Ref_Id", strRefId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[4] = new PassDataToSql("@Category_Id", strCategoryId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[5] = new PassDataToSql("@Commission_Percentage", strCommissionPercentage, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
        paramList[6] = new PassDataToSql("Sales_Quota", strSales_Quota, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
        paramList[7] = new PassDataToSql("@Is_Allow", strIsAllow, PassDataToSql.ParaTypeList.Bit, PassDataToSql.ParaDirectonList.Input);
        paramList[8] = new PassDataToSql("@Notes", strNotes, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_SalesCommissionConfiguration_Detail_Insert", paramList, ref trns);
        return Convert.ToInt32(paramList[21].ParaValue);
    }


    public int DeleteRecord_By_RefferencId(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strRefId, ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Inv_SalesCommissionConfiguration_Detail_DeleteRow", paramList, ref trns);
        return Convert.ToInt32(paramList[4].ParaValue);
    }

    public DataTable GetRecord_By_RefferencId(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strRefId)
    {
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_SalesCommissionConfiguration_Detail_SelectRow", paramList);
        return dtInfo;
    }
