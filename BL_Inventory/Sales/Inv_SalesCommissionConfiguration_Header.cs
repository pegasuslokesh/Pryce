...
/// <summary>
/// Summary description for Inv_SalesCommissionConfiguration_Header
/// </summary>
public class Inv_SalesCommissionConfiguration_Header
{
    DataAccessClass daClass = null;
    Common cm = null;
    public Inv_SalesCommissionConfiguration_Header(string strConString)
    {
        //
    ...
    public int InsertRecord(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strDepId, string strEmpId, string strParameterLevel, string strField1, string strField2, string strField3, string strField4, string strField5, string strField6, string strField7, string strIsActive, string strCreatedBy, string strCreatedDate, string strModifiedBy, string strModifiedDate, ref SqlTransaction trns)
    {
        ...
        paramList[3] = new PassDataToSql("@Department_Id", strDepId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[4] = new PassDataToSql("@Employee_Id", strEmpId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[5] = new PassDataToSql("@Parameter_Level", strParameterLevel, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[12] = new PassDataToSql("@Field7", strField7, PassDataToSql.ParaTypeList.DateTime, PassDataToSql.ParaDirectonList.Input);
    ...
    public int UpdateRecord(string strCompany_Id, string strBrand_Id, string strLocation_Id,string strTransId, string strDepId, string strEmpId, string strParameterLevel, string strField1, string strField2, string strField3, string strField4, string strField5, string strField6, string strField7, string strIsActive, string strModifiedBy, string strModifiedDate, ref SqlTransaction trns)
    {
        ...
        paramList[4] = new PassDataToSql("@Department_Id", strDepId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[5] = new PassDataToSql("@Employee_Id", strEmpId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[6] = new PassDataToSql("@Parameter_Level", strParameterLevel, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_SalesCommissionConfiguration_Header_Update", paramList, ref trns);
    ...
    public int DeleteRecord(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strTrans_Id, string IsActive, string ModifiedBy, string ModifiedDate)
    {
        ...
        daClass.execute_Sp("sp_Inv_SalesCommissionConfiguration_Header_DeleteRow", paramList);
    ...
    public DataTable GetAllRecord(string strCompany_Id, string strBrand_Id, string strLocation_Id, ref SqlTransaction trns)
    {
        ...
        paramList[5] = new PassDataToSql("@Employee_Id", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);

        dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_SalesCommissionConfiguration_Header_SelectRow", paramList, ref trns);
        return dtInfo;
    }
    ...
    public DataTable GetRecord_By_TransId(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strTransId)
    {
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_SalesCommissionConfiguration_Header_SelectRow", paramList);
        return dtInfo;
    }
    public DataTable GetRecord_By_BySalesPerson(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strSalesPerson)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", strCompany_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[5] = new PassDataToSql("@Employee_Id", strSalesPerson, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
