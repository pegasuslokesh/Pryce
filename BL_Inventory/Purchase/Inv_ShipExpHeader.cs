...
public class Inv_ShipExpHeader
{
    ...
    public Inv_ShipExpHeader(string strConString)
    {
        //
    ...
    public void ShipExpHeader_Insert(string CompanyId, string BrandId, string LocationId, string InvoiceId, string Currency_Id, string ExchangeRate, string CostingRate, string BillAmount, string TotalExpenses, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModfiedDate,ref SqlTransaction trns)
    {
        PassDataToSql[] paramList = new PassDataToSql[21];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_ShipExpHeader_Insert", paramList,ref trns);
    }
    ...
    public void ShipExpHeader_Delete(string CompanyId, string BrandId, string LocationId, string InvoiceId,string Ref_type)
    {
        ...
        paramList[2] = new PassDataToSql("@Location_Id", LocationId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[3] = new PassDataToSql("@InvoiceNo", InvoiceId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[4] = new PassDataToSql("@Field1", Ref_type, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[5] = new PassDataToSql("@optype", "2", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);

        daClass.execute_Sp("sp_Inv_ShipExpHeader_DeleteRow", paramList);
    }
    //created for rollback Trsnaction
    //15-02-2016
    //by jitendra upadhyay
    ...
    public void ShipExpHeader_Delete(string CompanyId, string BrandId, string LocationId, string InvoiceId, string Ref_type, ref SqlTransaction trns)
    {
        PassDataToSql[] paramList = new PassDataToSql[6];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_ShipExpHeader_DeleteRow", paramList,ref trns);
    }
