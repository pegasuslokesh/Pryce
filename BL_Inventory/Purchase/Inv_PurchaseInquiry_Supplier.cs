...
public class Inv_PurchaseInquiry_Supplier
{
    ...
    public Inv_PurchaseInquiry_Supplier(string strConString)
    {
        //
    ...
    public int InsertPurchaseInquirySupplier(string strCompany_Id, string strBrand_Id,string strLocation_Id, string strPI_No, string strSupplier_Id, string strGroup_Id, string strField1, string strField2, string strField3, string strField4, string strField5, string strField6, string strField7, string strIsActive, string strCreatedBy, string strCreatedDate, string strModifiedBy, string strModifiedDate)
    {
        ...
        paramList[18] = new PassDataToSql("@Location_Id", strLocation_Id, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetAllPISupplier(string strCompany_Id, string strBrand_Id,string strLocation_Id)
    {
        ...
        paramList[6] = new PassDataToSql("@Location_Id", strLocation_Id, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);

        using (dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_PurchaseInquiry_Supplier_SelectRow", paramList))
            return dtInfo;
    }
    public DataTable GetAllPISupplierWithTransId(string strCompany_Id, string strBrand_Id,string strLocation_Id, string strTrans_Id)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", strCompany_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetAllPISupplierWithPI_No(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strPI_No)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", strCompany_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetAllPISupplierWithPI_NoandAmount(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strPI_No)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", strCompany_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetAllPISupplierWithSupplierId(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strSupplier_Id)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", strCompany_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetAllSupplierByGroupId(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strGroupId)
    {
        DataTable dtInfo = new DataTable();
        ...
        using (dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_PurchaseInquiryGetSupplier", paramList))
            return dtInfo;
    }
