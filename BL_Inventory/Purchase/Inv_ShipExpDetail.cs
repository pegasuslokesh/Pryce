...
public class Inv_ShipExpDetail
{
    ...
    public Inv_ShipExpDetail(string strConString)
    {
        //
    ...
    public void ShipExpDetail_Insert(string CompanyId, string BrandId, string LocationId, string InvoiceId, string ExpensesId, string AccountNo, string ExpensesCharges, string ExpCurrencyID, string ExpExchangeRate, string FCExpAmount, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModfiedDate,ref SqlTransaction trns)
    {
        PassDataToSql[] paramList = new PassDataToSql[22];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_ShipExpDetail_Insert", paramList,ref trns);
    ...
    public void ShipExpDetail_Delete(string CompanyId, string BrandId, string LocationId, string InvoiceId, string ExpensesId, string Ref_Type)
    {
        ...
        paramList[3] = new PassDataToSql("@InvoiceNo", InvoiceId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[4] = new PassDataToSql("@Expense_Id", ExpensesId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[5] = new PassDataToSql("@Field1", Ref_Type, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public void ShipExpDetail_Delete(string CompanyId, string BrandId, string LocationId, string InvoiceId, string Ref_Type)
    {
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public void ShipExpDetail_Delete(string CompanyId, string BrandId, string LocationId, string InvoiceId, string Ref_Type, ref SqlTransaction trns)
    {
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        daClass.execute_Sp("sp_Inv_ShipExpDetail_DeleteRow", paramList,ref trns);

    }
    public DataTable Get_ShipExpDetailByInvoiceId(string CompanyId, string BrandId, string LocationId, string InvoiceId, string Ref_Type)
    {
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    //15-02-2016
    //by jitendra upadhyay
    public DataTable Get_ShipExpDetailByInvoiceId(string CompanyId, string BrandId, string LocationId, string InvoiceId, string Ref_Type,ref SqlTransaction trns)
    {
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Brand_Id", BrandId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        DataTable dt = daClass.Reuturn_Datatable_Search("sp_Inv_ShipExpDetail_SelectRow", paramList,ref trns);
        return dt;
    }
