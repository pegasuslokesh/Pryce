...
public class Document_Master
{
    ...
    public Document_Master(string strConString)
    {
    ...
    public DataTable GetDocumentMaster_By_DocumentName(string CompanyId,string DocumentName)
    {
        DataTable dt = new DataTable();
        PassDataToSql[] paramlist = new PassDataToSql[4];
        ...
        paramlist[2] = new PassDataToSql("@Document_Name", DocumentName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
