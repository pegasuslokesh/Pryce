...
public class Arc_Directory_Master
{
    ...
    Arc_Directory_Privileges ObjDir =null ;
    public Arc_Directory_Master(string strConString)
    {
        da = new DataAccessClass(strConString);
        ObjDir = new Arc_Directory_Privileges(strConString);
    }
    public int InsertDirectorymaster(string CompanyId, string DirectoryName,  string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,string strloginEmpId)
    {
        ...
        if (strloginEmpId != "0")
        {
            ...
            ObjDir.InsertRecord(param[14].ParaValue, strloginEmpId);
        }
    ...
    public int InsertDirectorymaster(string CompanyId, string DirectoryName, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,ref SqlTransaction trns, string strloginEmpId)
    {
        PassDataToSql[] param = new PassDataToSql[15];
        param[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        ...
        da.execute_Sp("Sp_Arc_Directory_Creation_Insert", param,ref trns);
        ...
        if (strloginEmpId != "0")
        {
            ...
            ObjDir.InsertRecord(param[14].ParaValue, strloginEmpId, ref trns);
        }
    ...
    public DataTable getDirectoryMasterByCompanyid(string CompanyId)
    {
        DataTable dt = new DataTable();
        PassDataToSql[] paramlist = new PassDataToSql[4];
    ...
    public DataTable getDirectoryMasterByCompanyid(string CompanyId,ref SqlTransaction trns)
    {
        DataTable dt = new DataTable();
        PassDataToSql[] paramlist = new PassDataToSql[4];
        ...
        dt = da.Reuturn_Datatable_Search("Sp_Arc_Directory_Creation_SelectRow", paramlist,ref trns);
        return dt;
    ...
    public DataTable GetDirectoryMaster_By_DirectoryName(string CompanyId, string DirectoryName)
    {
        DataTable dt = new DataTable();
        PassDataToSql[] paramlist = new PassDataToSql[4];
        ...
        paramlist[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramlist[1] = new PassDataToSql("@id","0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramlist[2] = new PassDataToSql("@Directory_Name",DirectoryName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramlist[3] = new PassDataToSql("@Optype", "5", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);

        dt = da.Reuturn_Datatable_Search("Sp_Arc_Directory_Creation_SelectRow", paramlist);
        return dt;
    }
    public DataTable GetDirectoryMaster_By_DirectoryName(string CompanyId, string DirectoryName,ref SqlTransaction trns)
    {
        DataTable dt = new DataTable();
        PassDataToSql[] paramlist = new PassDataToSql[4];
