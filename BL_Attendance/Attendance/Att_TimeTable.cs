...
public class Att_TimeTable
{
	...
	public Att_TimeTable(string strConString)
	{
        //
    ...
    public int InsertTimeTableMaster(string CompanyId, string ETimeTableName, string LTimeTableName, string Brand_Id, DateTime OnDuty_Time, DateTime OffDuty_Time, string Late_Min, string Early_Min, string Beginning_In, string Beginning_Out, string Ending_In, string Ending_Out, string Work_Minute, string Break_Min,string Is_Default ,string Field1, string Field2, string Field3, string Field4, string Location_id, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
        ...
        paramList[12] = new PassDataToSql("@Field5", Location_id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public int UpdateTimeTableMaster(string TimeTableId, string CompanyId, string ETimeTableName, string LTimeTableName, string Brand_Id, string OnDuty_Time, string OffDuty_Time, string Late_Min, string Early_Min, string Beginning_In, string Beginning_Out, string Ending_In, string Ending_Out, string Work_Minute,string Break_Min,string Is_Default, string Field1, string Field2, string Field3, string Field4, string Location_id, string Field6, string Field7, string IsActive, string ModifiedBy, string ModifiedDate)
    {
    ...
    public DataTable GetTimeTableMasterById(string CompanyId, string TimeTableId,ref SqlTransaction trns)
    {
        ...
        paramList[3] = new PassDataToSql("@optype", "4", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[4] = new PassDataToSql("@location_id", "", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Att_TimeTable_SelectRow", paramList,ref trns);
    ...
    public DataTable GetTimeTableMaster(string CompanyId,string location_id)
    {
    ...
    public DataTable GetTimeTableMasterByTimeTableName(string CompanyId, string strTimeTableName,ref SqlTransaction trns)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[5];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
