...
public class Att_PartialLeave_Request
{
    ...
    public Att_PartialLeave_Request(string strConString)
    {
        //
    ...
    public int InsertPartialLeaveRequest(string CompanyId, string Emp_Id, string Partial_Leave_Type, string Request_Date_Time, string Partial_Leave_Date, string From_Time, string To_Time, string Is_Confirmed, string Description, string Approved_Date_Time, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,string FileName,string FileUrl)
    {
        ...
        paramList[4] = new PassDataToSql("@Partial_Leave_Date", Partial_Leave_Date, PassDataToSql.ParaTypeList.DateTime, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[22] = new PassDataToSql("@FileName", FileName, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[23] = new PassDataToSql("@FileUrl", FileUrl, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public int InsertPartialLeaveRequest(string CompanyId, string Emp_Id, string Partial_Leave_Type, string Request_Date_Time, string Partial_Leave_Date, string From_Time, string To_Time, string Is_Confirmed, string Description, string Approved_Date_Time, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Att_PartialLeave_Request_Insert", paramList,ref trns);
    ...
    public int PartialLeaveApproveReject(string Trans_Id, string Is_Confirmed, string IsActive, string ModifiedBy, string ModifiedDate,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Att_PartialLeave_Request_ApprovedReject", paramList,ref trns);
        return Convert.ToInt32(paramList[4].ParaValue);
    }
    ...
    public DataTable GetPartialLeaveRequestByTransId(string CompanyId, string TransId,ref SqlTransaction trns)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[2];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Trans_Id", TransId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Att_PartialLeave_Request_SelectRowByTransId", paramList,ref trns);
    ...
    public DataTable GetPartialLeaveRequestbyEmpId(string CompanyId,string strEmpId)
    {
    ...
    public DataTable GetPartialLeaveType_EmpId(string CompanyId, string EmpId, string Date)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[3];
        paramList[0] = new PassDataToSql("@Comp_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Emp_Id", EmpId, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Date", Date, PassDataToSql.ParaTypeList.DateTime, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("GetPartialLeaveType_EmpId", paramList);
        return dtInfo;
    }

    public DataTable GetPartialLeaveType_EmpId(string CompanyId, string EmpId, string Date,ref SqlTransaction trns)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[3];
        paramList[0] = new PassDataToSql("@Comp_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Emp_Id", EmpId, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@Date", Date, PassDataToSql.ParaTypeList.DateTime, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("GetPartialLeaveType_EmpId", paramList,ref trns);
        return dtInfo;
    }
    public string UpdateImagePath(string TransId, string FileName, string FilePath)
    {
        int a = daClass.execute_Command("Update Att_PartialLeave_Request Set FileName='" + FileName + "',FileURL='" + FilePath + "' where Trans_Id='" + TransId + "'", "");
        return (a.ToString());
    }
}
