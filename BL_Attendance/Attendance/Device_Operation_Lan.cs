...
public class Device_Operation_Lan
{
    ...
    public bool SynchTime(string IPAddress, int port)
    {
        ...
        int idwYear = Convert.ToInt32(Common.getCountryTimeFormatStatic(DateTime.Now.ToUniversalTime().ToString()).Year);
        int idwMonth = Convert.ToInt32(Common.getCountryTimeFormatStatic(DateTime.Now.ToUniversalTime().ToString()).Month);
        int idwDay = Convert.ToInt32(Common.getCountryTimeFormatStatic(DateTime.Now.ToUniversalTime().ToString()).Day);
        int idwHour = Convert.ToInt32(Common.getCountryTimeFormatStatic(DateTime.Now.ToUniversalTime().ToString()).Hour);
        int idwMinute = Convert.ToInt32(Common.getCountryTimeFormatStatic(DateTime.Now.ToUniversalTime().ToString()).Month);
        int idwSecond = Convert.ToInt32(Common.getCountryTimeFormatStatic(DateTime.Now.ToUniversalTime().ToString()).Second);
