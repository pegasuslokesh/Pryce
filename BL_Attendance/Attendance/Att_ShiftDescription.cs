...
public class Att_ShiftDescription
{
	...
	public Att_ShiftDescription(string strConString)
	{
        //
    ...
    public int InsertShiftDescription(string ShiftId, string CycleType, string CycleDay, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_Att_ShiftDescription_Insert", paramList,ref trns);
        return Convert.ToInt32(paramList[15].ParaValue);
    }
    ...
    public int InsertShift_TimeTable(string @Ref_Id, string TimeTable_Id, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate,ref SqlTransaction trns)
    {
        ...
        daClass.execute_Sp("sp_att_shift_timetable_Insert", paramList, ref trns);
        return Convert.ToInt32(paramList[14].ParaValue);
    }
    ...
    public DataTable GetShiftDescriptionByShiftId(string ShiftId,ref SqlTransaction trns)
    {
        ...
        paramList[1] = new PassDataToSql("@optype", "2", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Att_ShiftDescription_SelectRow", paramList,ref trns);
