...
/// <summary>
/// Summary description for And_Device_Group
/// </summary>
public class And_Device_Group
{
    DataAccessClass daClass = null;
    public And_Device_Group(string strConString)
	{
        //
    ...
    public int InsertDeviceGroupMaster(string CompanyId,string DeviceId,string GroupId , string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
        ...
        daClass.execute_Sp("sp_And_Device_Group_Insert", paramList);
        return Convert.ToInt32(paramList[15].ParaValue);
    }
    public int DeleteDeviceGroupMaster(string CompanyId, string DeviceId)
    {
        ...
        daClass.execute_Sp("sp_And_Device_Group_Delete", paramList);
        return Convert.ToInt32(paramList[2].ParaValue);
    }
    public DataTable GetDeviceGroupByDeviceId(string CompanyId, string DeviceId)
    {
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_And_Device_Group_SelectRow", paramList);

        return dtInfo;
    }
    public DataTable GetDeviceGroupByGroupId(string CompanyId, string GroupId)
    {

        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[4];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Device_Id", "0", PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetDeviceGroupMaster(string CompanyId)
    {
